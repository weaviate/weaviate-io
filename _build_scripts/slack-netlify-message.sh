...
MESSAGE="{'text': 'Hey $AUTHOR_NAME - your :docusaurus: :weaviate-logo: website build (<https://github.com/weaviate/weaviate-io/tree/$branch_name|$branch_name>) is ready on Netlify:\n $NETLIFY_URL \n> $commit_message' }"

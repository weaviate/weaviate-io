...
### <i class="fa-solid fa-chalkboard"></i> Weaviate instance details

Make sure to have your Weaviate instance details at hand. You should have your Weaviate instance URL and the API key from the [previous section](../101_start_wcs/10_create_wcs.mdx).

...
Chunking is also important for optimizing retrieval augmented generation, or RAG. (If you need a refresher on what RAG is, you can review [this module](../../950_zero_to_mvp/104_queries_2/30_generative.mdx).)

...
You can connect to the with a read-only Weaviate API key.

Confirm that you can run the following code. Copy the code to a file called `connect.py` and run it in your python environment.

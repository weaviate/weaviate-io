...
But for now, you should know that machine learning (ML) models are key to this whole process. Similar models allow clever text generation from the prompts that power vector searches. Instead of generating new text, these models capture the "meaning" of pieces of text or other media. We will cover this in more detail later on.

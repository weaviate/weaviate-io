...
This section includes queries using the OpenAI inference endpoint. If you don't already have an OpenAI account, we recommend getting an account with a **free API key** The free key should be sufficient for these exercises.
:::
...
<ReactPlayer url='https://youtu.be/8aHIAM3665c' controls='true'/>
<br/>

Now that you've set up your own Weaviate instance and installed a client, let's get hands-on with Weaviate.

### <i class="fa-solid fa-arrow-right-from-bracket"></i>&nbsp;&nbsp; Client instantiation
...
### <i class="fa-solid fa-arrow-right-from-bracket"></i>&nbsp;&nbsp; Try it out!
...
### <i class="fa-solid fa-arrow-right-from-bracket"></i>&nbsp;&nbsp; Accessing the REST API
...
#### <i class="fa-solid fa-arrow-right-from-bracket-simple"></i> Example 1: REST vs client requests

import ClientRESTObjectGet from './_snippets/academy.clients.rest.object.get.mdx';

<ClientRESTObjectGet />

#### <i class="fa-solid fa-arrow-right-from-bracket-simple"></i> Example 2: GraphQL vs client requests
...
### <i class="fa-solid fa-arrow-right-from-bracket"></i>&nbsp;&nbsp; Connect to our demo instance
...
### <i class="fa-solid fa-arrow-right-from-bracket"></i>&nbsp;&nbsp; Vector searches
...
### <i class="fa-solid fa-arrow-right-from-bracket"></i>&nbsp;&nbsp; Question answering
...
### <i class="fa-solid fa-arrow-right-from-bracket"></i>&nbsp;&nbsp; Generative search

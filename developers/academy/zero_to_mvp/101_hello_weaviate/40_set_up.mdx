...
<ReactPlayer url='https://youtu.be/PgHCLcqfe10' controls='true'/>
<br/>

## <i class="fa-solid fa-square-chevron-right"></i>&nbsp;&nbsp;Options for running Weaviate

Weaviate Cloud Services (WCS) can run Weaviate for you as a managed service. You can also manage your own Weavaite instances using Docker, Kubernetes, or Embedded Weaviate.
...
The Weaviate instances in WCS are pre-configured for your convenience. They include a number of Weaviate modules by default. They also have built-in support for user authentication.
...
### <i class="fa-solid fa-arrow-right-from-bracket"></i>&nbsp;&nbsp; Sign in to WCS
...
### <i class="fa-solid fa-arrow-right-from-bracket"></i>&nbsp;&nbsp; Create a Weaviate Cluster

To create a new Weaviate Cluster, click the "Create cluster" button.

[comment]: # (The UI has changed slightly, we should update or drop this image)
...
[comment]: # (The image shows 'no for authentication. We should update or delete)
[comment]: # (Your selections should look like this:)

[comment]: # (<img src={WCSoptions} width="100%" alt="Instance configuration"/>)
...
### <i class="fa-solid fa-arrow-right-from-bracket"></i>&nbsp;&nbsp;Installation

...
<ReactPlayer url='https://youtu.be/zC0CpBiLC3g' controls='true'/>
<br/>
...
This is a difficult query to write. Even worse, you would probably have to add the names of the specific animals to the query as well.
...
If we run *this* query, you might expect to see a random set of responses about European countries.

...
Weaviate can extract knowledge from the text.
...
Given this query, Weaviate doesn't just identify the most relevant data object. Weaviate also answers the question based on the textual information in the Wikipedia article.
...
You can vary the prompt to build all kinds of output.

### <i class="fa-solid fa-chalkboard"></i>&nbsp;&nbsp;What next?

Tools like Q&A and generative search really start to bring your information to life. In the next sections, we'll get you set up to use Weaviate. You will run your own queries before we wrap up this unit.

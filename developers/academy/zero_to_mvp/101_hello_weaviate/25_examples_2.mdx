...
<ReactPlayer url='https://youtu.be/ezMZKEFteUA' controls='true' width="100%"/>
<br/>
...
Tools like Q&A and generative search really start to bring your information to life. In the next sections, you will set up Weaviate and run your own queries.

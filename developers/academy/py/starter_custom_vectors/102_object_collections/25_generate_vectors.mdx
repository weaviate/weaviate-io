...
import PyCode from '!!raw-loader!./_snippets/25_generate_embeddings.py';
...
The embeddings are then saved to a file so that we can use when adding the movies to Weaviate. We use the model name as a suffix for clarity.

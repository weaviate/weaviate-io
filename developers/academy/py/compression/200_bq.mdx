...
[Binary quantization](/developers/weaviate/concepts/vector-quantization#binary-quantization) (BQ), is a technique used to compress vectors. In Weaviate, it can be used to reduce the size of the in-memory [HNSW index](/developers/weaviate/concepts/indexing/hnsw-indexes) or the disk-based [flat index](/developers/weaviate/concepts/indexing/flat-indexes).

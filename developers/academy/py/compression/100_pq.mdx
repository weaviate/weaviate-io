...
If you are using an earlier version of Weaviate, or have asynchronous indexing disabled, you will need to use a different configuration. Please refer to the [PQ configuration documentation](/developers/weaviate/configuration/compression/pq-compression.md#manually-configure-pq) for more information.
:::
...
Please refer to the [PQ configuration documentation](/developers/weaviate/configuration/compression/pq-compression.md#pq-parameters) for more information on the available settings.

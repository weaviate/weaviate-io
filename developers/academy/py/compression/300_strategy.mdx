...
But do note that you will likely not be able to switch on compression later, as it requires a reindexing of the data. (With an exception of PQ, which [may be enabled later](../../../weaviate/configuration/compression/pq-compression.md#3-enable-pq-and-create-the-codebook) unless your dataset is too large.)

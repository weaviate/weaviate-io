...
This example finds entries in "MovieNVDemo" with the highest keyword search scores for the term "history", and prints out the title and release year of the top 5 matches.

...
[Weaviate Cloud Services (WCS)](https://console.weaviate.cloud/) is a managed service that runs Weaviate for you. You can also manage your own Weaviate instances using Docker, Kubernetes, or Embedded Weaviate.
...
[Weaviate Cloud Services (WCS)](https://console.weaviate.cloud/), is a managed SaaS service that requires no maintenance at your end.

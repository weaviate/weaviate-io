...
description: Learn to set up Weaviate for quick and efficient data search.
sidebar_position: 40
---

import registerImg from '../../../../wcs/img/register.png';
import WCDcreate from '../../../../wcs/img/wcs-create.png';
import WCDcreationProgress from '../../../../wcs/img/wcs-creation-progress.png';
...
### <i class="fa-solid fa-chalkboard"></i> WCD (Recommended)
...
## <i class="fa-solid fa-square-chevron-right"></i>  Get started with WCD

### <i class="fa-solid fa-code"></i>  Sign in to WCD

1. To access WCD, go to the [Weaviate Cloud Console](https://console.weaviate.cloud)

1. If you don't have a WCD account, click on the "Register" button to create a new account.
...
1. Provide a *cluster name*. The sandbox URL is based on the cluster-name. WCD adds a suffix to ensure uniqueness.

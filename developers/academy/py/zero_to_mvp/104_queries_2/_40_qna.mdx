...
If you are using WCD, a `qna` module is enabled by default ([see the documentation](/developers/wcs#configuration)). Otherwise, you must configure your Weaviate instance to make sure that a `qna-xxx` module is enabled.

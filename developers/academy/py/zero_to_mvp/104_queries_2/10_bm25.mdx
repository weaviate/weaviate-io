...
description: BM25 Search in Weaviate Queries
---
...
In an earlier unit, we briefly discussed [the inverted index](../103_schema_and_imports/10_data_structure.mdx#inverted-indexes), and that it stores a "tokenized" index of data.

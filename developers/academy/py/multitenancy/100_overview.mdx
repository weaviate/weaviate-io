...
But as you will have guessed, there are also differences. We'll cover these in the next sections, starting with how to configure a multi-tenant collection.

...
Let's discuss the key configuration options available in multi-tenancy collections.
...
You can `create` tenants by providing a list of tenant names:
...
## <i class="fa-solid fa-chalkboard"></i> Interacting with tenant data

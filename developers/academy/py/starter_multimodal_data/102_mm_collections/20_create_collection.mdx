...
It is possible to specify one or more of text and image properties to be used for vectorization. In this example, we keep it simple and specify that the `poster` property is the source (image) data to be used for vectorization.

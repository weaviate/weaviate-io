...
import WeaviateTypescriptImgUrl from '/developers/academy/js/standalone/client-server/_img/fullstack.png';

This approach involves having a single tool to build both your server application and client application. In modern web development terms, such a tool is called a fullstack web frameworks. For this example, we will be using [Next.js](https://nextjs.org/)

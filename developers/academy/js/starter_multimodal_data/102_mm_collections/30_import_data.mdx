...
> We use `MAX_ITEMS` to limit the number of objects we import to our collection. Trail keys for the Cohere Embed 3 model [restrict](https://docs.cohere.com/v2/docs/rate-limits) you to 5 images per minute. 

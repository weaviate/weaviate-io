---
title: 10 Set up Javascript/TypeScript for Weaviate
sidebar_position: 10
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';
import TypeScriptCodeExample from '!!raw-loader!./_snippets/10_setup_typescript.ts';
...
## <i class="fa-solid fa-square-chevron-right"></i> Install Javascript/TypeScript

### <i class="fa-solid fa-code"></i> Is Javascript installed?
...
Congratulations, you are now set up to use Weaviate with  and the Weaviate Python client library!

...
Keep in mind that this runs multiple containers on the same host device for learning. In a production environment, you would typically have a managed Kubernetes cluster with multiple physical or virtual nodes.
:::
...
If you would like, you can access Weaviate as described before, and work with it. We include [further resources on the next page](./90_next_steps) for you to explore.

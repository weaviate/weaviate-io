...
Both REST and GraphQL APIs can be accessed using client libraries. As a result, each requests in the set of tabs are the same:

#### <i class="fa-solid fa-code-simple"></i> HTTP vs client requests

import ClientRESTObjectGet from './_snippets/academy.clients.rest.object.get.mdx';

<ClientRESTObjectGet />

#### <i class="fa-solid fa-code-simple"></i> GraphQL vs client requests

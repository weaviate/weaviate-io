---
title: Hands-on 2 - More than search
sidebar_position: 50
---
...
Now you have already seen how Weaviate makes it easy to not only retrieve information, but build on top of it. Let's take some time to try a few simple demos ourselves.

### <i class="fa-solid fa-code"></i>&nbsp;&nbsp;Question answering

Go to `INSERT URL`.

Modify the highlighted line of the query below to ask questions about `topics`, to see if Weaviate can answer the question from its stored information.

:::note Try it yourself
Go to `INSERT URL` and see if Weaviate can answer your question.
...
Modify the highlighted line of the query below to ask Weaviate to do something with the information about the `TOPIC`. 

:::note Try it yourself
Go to `INSERT URL` and manipulate this information to generate this text.

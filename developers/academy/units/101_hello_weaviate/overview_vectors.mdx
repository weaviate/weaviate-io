...
We've come this far without discussing what vectors are, exactly.

Although it sounds quite technical, in this context a vector is just a series of numbers - like [1, 0] or [0.513, 0.155, 0.983, 0.001, 0.932]. The reason for using vectors is that they capture meaning as a series of numbers.

In fact, many people have used vectors already without realizing - for example if they have tried photo editing, or MS Paint.

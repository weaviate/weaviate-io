...
A vector database can catalog, store and retrieve information based on similarity. This is different to traditional databases and retrieval strategies, for example those that rely on SQL.

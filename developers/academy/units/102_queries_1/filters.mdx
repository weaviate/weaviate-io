...
In fact, arguments in Weaviate are extremely powerful and wide-ranging. Take a look at just some of the available operators.
...
As this is too many to cover in this section, we will explore a few more of the most commonly used arguments.

:::caution Arguments are case-sensitive!
We remind you that although GraphQL is agnostic about some of its formatting, letter casing of the argument is not one of them.
:::

...
:::caution GraphQL is case-sensitive!
We remind you that although GraphQL is agnostic about some of its formatting, letter casing is not one of them. Care must be taken to use the right case!
:::

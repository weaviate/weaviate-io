...
![](https://weaviate.io/assets/images/pulling-back-the-curtains-text2vec-d28fe2ad487a17046fe5dc5fc8d85424.png)
...
![](https://media.istockphoto.com/id/1177204050/vector/flat-isometric-servers-computer-hardware-network-vector-icon.jpg?s=612x612&w=is&k=20&c=inGNylOUbN6nOC6Eq2qvABwbuNohpLFHvqb0WJnWgWg=)

Weaviate's efficient storage and retrieval of data is made possible through its use of three key components: the object store, object index, and vector index.

### Object store

In Weaviate, each object is stored as a JSON document and organized into collections referred to as "Classes".
...
## High-level overview of vector search

![](https://weaviate.io/assets/images/hero-a483b9830f359fa00af19ca4896cad10.png)
...
## Vector representations in Weaviate

![](https://weaviate.io/assets/images/hero-94bc05f994216b3d19985a226e6b5a2e.png)

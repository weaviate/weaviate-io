...
In mathematics and sciences, the word "vector" can be used refer to many things. A vector in this context of data science is a set of numbers. To be precise, a vector is **an one-dimensional array of numbers**.

If you see the word "tensor", or "array" they generally refer to similar things.

A vector is typically shown as its constituent numbers wrapped in square brackets. So, an object such as `[1, 5, 5]` is a vector, as are `[0.591, 0.132, 0, 0.105]` and `[0, 0, 0, 0, 0, 0]`. 

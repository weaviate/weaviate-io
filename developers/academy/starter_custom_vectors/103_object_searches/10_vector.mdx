...
import PyCode from '!!raw-loader!./_snippets/10_vector.py';
...
This example finds entries in "Movie" whose text best matches the input vector and prints out the title and release year of the top 5 matches.

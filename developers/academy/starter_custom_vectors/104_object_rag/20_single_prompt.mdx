...
import PyCode from '!!raw-loader!./_snippets/rag.py';
...
This example finds entries in "Movie" based on their similarity to the query "dystopian future". Then, instructs the large language model to translate the title of each movie into French.

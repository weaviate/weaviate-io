...
This example finds entries in "Movie" whose text best matches the query "dystopian future". Then, instructs the large language model to find commonalities between them.

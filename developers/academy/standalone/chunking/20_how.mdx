...
import PythonCodeExample from '!!raw-loader!./_snippets/20_chunking_examples.py';
...
<small>*Available through the [Creative Commons Attribution-Non Commercial-Share Alike 3.0 license](https://creativecommons.org/licenses/by-nc-sa/3.0/).</small>
...
One thing that might stand out immediately is that both of our very simple marker-based chunker ends up producing the heading as one chunk, which may not be desirable. In reality, you may have a mixed strategy where very short chunks like this may be appended to the next chunk, assuming that it is likely to be something like a title, or a section heading.


## <i class="fa-solid fa-square-chevron-right"></i>&nbsp;&nbsp;Combination
...
## <i class="fa-solid fa-square-chevron-right"></i>&nbsp;&nbsp;Tips

- Append the document title to chunks from the middle of the document to prevent context loss

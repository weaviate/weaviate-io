...
2. **Inference volume**: How many requests do you expect to process daily/monthly? For many, this may preclude the up-front costs for local models.
...
We will get into these in more detail in later course. But here are some key parameters to look out for.
...
Just reviewing these parameters will take you a long way towards identifying models that will suit you needs.

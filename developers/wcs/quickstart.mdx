...
This example code downloads a sample data set and uploads it to your WCS instance. The example assumes your collection [has a schema](#define-a-collection) already.

...
The WCS console start page has tools to help you manage your WCS account. When you create a cluster, the WCS console displays a tile on this page with cluster details. There are no clusters when you log in to a new account.

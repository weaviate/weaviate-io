...
When you log into the Weaviate Cloud web console, the Dashboard tab lists your clusters. There are no clusters when you log in to a new account. Weaviate Cloud provides **short-term Sandbox** clusters and **permanent Serverless clusters**.

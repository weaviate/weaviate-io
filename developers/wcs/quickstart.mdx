...
1. Log in to the WCD console.

## Create a Weaviate Cluster

When you log into the WCD web console, the Dashboard tab lists your clusters. There are no clusters when you log in to a new account. WCD has short-term, sandbox clusters and permanent, managed clusters.
...
Managed clusters require billing details. WCD prompts you to add billing details if you have not already added them.

...
:::tip Authentication
If you have enabled authentication in your sandbox for added security, this step will require that you pass on the authentication credentials. The [authentication guide](./guides/authentication.mdx) explains how.
:::

...
Click <kbd>Create</kbd>. This will take ~2 minutes and you'll see a check mark ✔️ when finished.
...
Instance creation should take a minute or two, and you will see a check mark ✔️ when it's done, indicating that the instance is ready.

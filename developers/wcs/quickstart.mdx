...
To create a cluster, click the 'Create cluster' button, then follow the steps to create a [sandbox cluster](#sandbox-clusters) or a [managed cluster](#managed-clusters).
...
1. Give your cluster a name. WCS adds a random suffix to sandbox clusters to ensure uniqueness.

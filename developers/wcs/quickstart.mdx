...
- In order to perform Retrieval Augmented Generation (RAG) in the last step, you will need a [Cohere](https://dashboard.cohere.com/) account. You can use a free Cohere trial API key. If you have another preferred [model provider](/developers/weaviate/model-providers), you can use that instead of Cohere.
...
Clusters with Weaviate versions `v1.30` and newer don't have API keys initially by default, you will need to create a new one.
...
:::info What models are being used?ž
...
export const cardsData = [
  {
    ...
    link: '/developers/wcs/manage-clusters/create',
  },
  {
    title: (
      <span>
  ...
  },
  {
    ...
    description:
      'Connect with other developers and contribute to our forum and Slack discussions.',
    link: '/community',
  },
];

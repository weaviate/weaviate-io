...
To open the query app, connect to your WCS [WCS Dashboard](https://console.weaviate.cloud). In the left-hand menu, click the stacked circle icon.

![WCS query app location](img/wcs-query-console-location.jpg)

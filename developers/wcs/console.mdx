...
The WCS GraphQL query console is a browser-based GraphQL IDE that allows you to interactively query your Weaviate instance, whether it is a WCS instance or not.
...
You can find the GraphQL query console by navigating to your [WCS Dashboard](https://console.weaviate.cloud), logging in and clicking on the button highlighted below:

<img src={WCSConsoleButton} width="100%" alt="WCS console button"/>

This will open the Query console, where you can build a GraphQL query, using context-aware query and variables completion.

...
For more information about the available model options visit the [Choose a model](/developers/wcs/embeddings/configuration) page.
...
export const cardsData = [
  {
    ...
    link: '/developers/wcs/embeddings/configuration',
  },
  {
    title: (
      <span>

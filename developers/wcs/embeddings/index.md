...
:::info
Weaviate Embeddings is only available for use with Weaviate Cloud instances.
:::
...
- **[Single authentication](/developers/wcs/manage-clusters/connect)**: Your Weaviate Cloud credentials are used for authorization.

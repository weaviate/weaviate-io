...
<center><img src={WCDColl} width="100%" alt="How to add an API inference key to a WCD console query"/></center>

The header can pass multiple keys.

<center><img src={WCDColl} width="80%" alt="How to add multiple API inference keys to a WCD console query"/></center>

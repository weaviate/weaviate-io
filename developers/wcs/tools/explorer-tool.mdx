...
<div class="row">
    <div class="card">
        ...
        <div class="card__body">
            <p>Objects in the selected collection is shown (item <span class="callout">6</span>) as a list of objects. Each object is listed with its unique ID and its properties (item <span class="callout">7</span>), including the property name and value.</p>
        </div>
    </div>
</div>
<br/>

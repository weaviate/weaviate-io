...
Because configuring the open-source instance of Weaviate can be challenging for many, WCS instances of Weaviate come pre-configured. This is designed ot reduce the work and time required for you to get up and running.

:::info <i class="fa-solid fa-screwdriver-wrench"></i> What does the pre-configuration look like?

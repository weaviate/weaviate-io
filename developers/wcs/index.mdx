...
WCS instances come pre-configured in order to reduce the work and time required for you to get up and running.
...
:::note Is Weaviate in WCS the same as the open-source version?
...
The following pages should help you to get started with WCS:

- WCS [pricing page](/pricing)
- Weaviate [Quickstart tutorial for WCS](./user/quickstart.mdx)
- User guides for:
    - [Creating a WCS instance](./user/creation.mdx)
    - [Authentication](./user/authentication.mdx)
    - [WCS Console](./user/authentication.mdx)

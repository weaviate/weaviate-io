...
Documentation for the Weaviate library [can be found here](/developers/weaviate/index.md).
:::
...
WCS, or Weaviate Cloud Services, is our SaaS (software-as-a-service) solution, providing managed Weaviate instances on the cloud.

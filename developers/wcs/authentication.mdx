...
## Connect via the GraphQL console

The built in [GraphQL console](/developers/wcs/platform/console) connects to clusters in your organization without any additional authentication.

If you use GraphQL console to connect to a Weaviate instance that is not part of your organization, you have to provide an API key. 

To pass the API key, add it to the `Headers` at the bottom of the GraphQL console. 

...
> If you created a sandbox on our legacy system at `console.weaviate.io`, it will be visible in the [old console](https://console.weaviate.io/) but not on the new WCS site, [https://console.weaviate.cloud](https://console.weaviate.cloud)).

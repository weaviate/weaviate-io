...
If you would like to preserve your sandbox data, you can retrieve your data with our [cursor API](/developers/weaviate/api/rest/objects#exhaustive-retrieval-after), or [contact us to upgrade](/pricing#register) to a production SaaS instance.

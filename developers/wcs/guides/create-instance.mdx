...
- We offer WCS instances at different service level access (SLA) tiers. Please review their [details and pricing here](/pricing) and select one that suits you best.
...
Please see our [authentication](./authentication.mdx) page for instructions and tips on how to authenticate with a WCS instance.

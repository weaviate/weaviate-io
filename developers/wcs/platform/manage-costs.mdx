...
Quantization is an effective way to compress the vector embeddings. Weaviate provides three quantization algorithms that work with HNSW indexes:
...
Inverted indexes are very important for searching and filtering. They don't use expensive resources the same way as vector indexes, however you can configure inverted indexes to make better use of resources.
...
Turning off these indexes saves disk space. It also improves import times since Weaviate has to do less work.

...
Weaviate has an [asynchronous indexing](/developers/weaviate/config-refs/schema/vector-index#asynchronous-indexing) feature that  effectively speeds up the import process. Consider enabling asynchronous indexing to improve imports.
##### HERE
# # # # #  # # NEXT

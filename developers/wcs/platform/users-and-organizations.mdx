...
To switch between organizations, select an organization name in the organization pulldown menu in the Weaviate Cloud console.
...
A Weaviate Cloud user can be a member of more than one organization. Once a user creates an account in Weaviate Cloud, you can add that user to your organization.

To add a user, follow these steps:

1. Ask the user for Weaviate Cloud account details.

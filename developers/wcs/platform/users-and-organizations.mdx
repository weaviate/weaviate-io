  ...
  <div class="col col--6">
    <div class="card">
      <div class="card__image">
        <img src={OrganizationSettings} alt="Edit an organization in Weaviate Cloud" />
      </div>
...
<div class="row">
  <div class="col col--6">
    <ol>
      <li>
        Open the <a href="#manage-organizations">Organization settings</a>{' '}
        page.
      </li>
      <li>
...
2. Open the [Organization settings](#manage-organizations) page.
...
1. Open the [Organization settings](#manage-organizations) page.

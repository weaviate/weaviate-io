...
The billing rate is a minimum charge per month.
...
Older accounts may receive invoices from [Exact](https://www.exact.com/) or [Mollie](https://www.mollie.com/). The Exact and Mollie services are deprecated. Accounts that still use these services are being updated to use Stripe.

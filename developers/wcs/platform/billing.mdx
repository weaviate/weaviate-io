...
1.  vectorDimensionsSum = objects x dimensions with compression disabled
2. vectorSegmentsSum = objects x dimensions with compression enabled
3. queryDimensionsTotal = (old style plan)

...
1. Use your browser to connect to the Weaviate Cloud console.
1. Click on your account profile. Select Account settings.
3. Click the 'Manage Two-Factor Authentication' button.
1. Enter your password to re-authenticate to Weaviate Cloud.
1. Open your authenticator application and scan the QR code.
1. Enter the code from your application in Weaviate Cloud.

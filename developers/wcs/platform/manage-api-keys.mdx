...
WCS restarts the cluster when you add a new API key. If you have a stand-alone cluster, you is a short downtime while the cluster restarts. There is no downtime if you have a high availability cluster.
...
WCD restarts the cluster when you delete an API key. If you have a stand-alone cluster, you is a short downtime while the cluster restarts. There is no downtime if you have a high availability cluster.

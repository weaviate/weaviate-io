...
<!-- TODO[g-despot]: Update this when 1.29 is available for my cluster-->
...
![WCD Upgrade notification message](../img/wcs-upgrade-banner.jpg)

Click to expand the notification. The notification displays a list of clusters that can be upgraded.

![WCD Upgrade notification details](../img/wcs-upgrade-notification-details.jpg)

### Details panel

To check if you are running the latest version of Weaviate, follow these steps.

1. Connect to the Weaviate Cloud console, and find your cluster in the Dashboard tab.
...
## Upgrade the server version
 ...
 1. Select the target upgrade version.
 1. Click confirm.

![WCD Upgrade confirmation](../img/wcs-upgrade-confirmation.jpg)

During the upgrade, the console displays a status indicator.

![WCD update status indicator](../img/wcs-upgrade-status-indicator.jpg)

The indicator goes away and Weaviate Cloud sends a confirmation email when the cluster is ready.

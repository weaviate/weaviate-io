...
The Weaviate client libraries use API keys to authenticate to Weaviate Cloud instances. The Weaviate server authenticates every request:
...
- If you use the **REST API** directly, add your API key to the request header.

For authentication details, see [Account management: Authentication](/developers/wcs/platform/manage-api-keys).

<details>
  <summary>For Weaviate clusters before v1.30</summary>

By default, both **Serverless** and **Sandbox** clusters have two types of keys:

...
The built in [Query app](/developers/wcs/tools/query-tool) connects directly to clusters in your WCD organization without any additional authentication.
...
<div class="row">
  <div class="col col--6">
    <p>
      To connect the Query tool to a Weaviate instance that is not part of your WCD organization, provide an API key for the remote instance. <br/><br/>Add the API key to the connection <code>Headers</code> at the bottom of the Query tool tab.
    </p>
  </div>
  <div class="col col--6">
    <div class="card">

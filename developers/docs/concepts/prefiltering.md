...
The cutoff value can be configured as [part of the `vectorIndexConfig` settings in the schema](/developers/docs/configuration/vector-index-type.md#how-to-configure-hnsw) for each class separately.

...
See the [Backups page](/developers/docs/configuration/backups.md) for a general introduction, configuration, and tech background of Backups.

## API

### Create Backup

Once the modules are enabled and the [configuration](/developers/docs/configuration/backups.md#configuration) is provided, you can start a
...
While you are waiting for a backup to complete, [Weaviate stays fully usable](/developers/docs/configuration/backups.md#read--write-requests-while-a-backup-is-running).
...
Discover more about [Backups Configuration](/developers/docs/configuration/backups.md#configuration), inlcuding Backups to [S3](/developers/docs/configuration/backups.md#s3-aws-or-s3-compatible) or [GCS](/developers/docs/configuration/backups.md#gcs-google-cloud-storage), [Technical Considerations of Backups](/developers/docs/configuration/backups.md#technical-considerations), as well as [additional use cases](/developers/docs/configuration/backups.md#other-use-cases).

...
* Note: Cannot use multiple `'near'` arguments, or a `'near'` argument along with an [`'ask'`](/developers/docs/modules/reader-generator-modules/qna-transformers.md) filter
...
* Note: You cannot use multiple `near<Media>` arguments, or a `near<Media>` argument along with an [`ask`](/developers/docs/modules/reader-generator-modules/qna-transformers.md) argument.
...
Enabled by the modules: [text2vec-openai](/developers/docs/modules/retriever-vectorizer-modules/text2vec-openai.md), [text2vec-transformers](/developers/docs/modules/retriever-vectorizer-modules/text2vec-transformers.md), [text2vec-contextionary](/developers/docs/modules/retriever-vectorizer-modules/text2vec-contextionary.md).
...
Enabled by the module: [Question Answering](/developers/docs/modules/reader-generator-modules/qna-transformers.md).

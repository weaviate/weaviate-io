...
* No breaking changes
* New Features:
  * Image Module [`img2vec-neural`](/developers/docs/modules/retriever-vectorizer-modules/img2vec-neural.md)
...
* No breaking changes
* New feature: [Question Answering (Q&A) Module](/developers/docs/modules/reader-generator-modules/qna-transformers.md)
...
* No breaking changes
* New feature: Introduction of the [Transformer Module](/developers/docs/modules/reader-generator-modules/qna-transformers.md)
...
For client library specific changes, take a look at the change logs of the specific client ([Go](/developers/docs/client-libraries/go.md#v20x), [Python](/developers/docs/client-libraries/python.md#20x), [JavaScript](/developers/docs/client-libraries/javascript.md#v200) and the [CLI](/developers/docs/client-libraries/cli.md#200)).
...
1. **Per-class configuration**
    ...
    * The `vectorIndexType` allows the choosing the vector index (defaults to [HNSW](/developers/docs/concepts/vector-index-plugins.md#hnsw))
    * The `vectorIndexConfig` is an arbitrary object passed to the index for config (defaults can be found [here](/developers/docs/configuration/vector-index-type.md#how-to-configure-hnsw) )

...
A: You can find this in the [architecture section](/developers/docs/concepts/resources.md#an-example-calculation) of the docs.
...
A: Not yet (but soon), you can currently use the [available contextionaries](/developers/docs/quickstart/installation.md) in a variety of languages and use the transfer learning feature to add custom concepts if needed. Sign up to our [newsletter](http://weaviate-newsletter.semi.technology/) or [Slack channel](https://join.slack.com/t/weaviate/shared_invite/zt-goaoifjr-o8FuVz9b1HLzhlUfyfddhw) to keep updated about the release of custom contextionary training
...
[Yes!](/developers/docs/modules/other-modules/custom-modules.md)
...
1. If your search quality varies a lot depending on the query-time `ef` values, you should also consider choosing stronger build parameters. The [ANN benchmarks section](/developers/docs/benchmarks/ann.md#results) present a combination of many different parameter combination for various datasets.

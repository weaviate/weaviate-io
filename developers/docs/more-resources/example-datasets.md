...
[multi2vec-clip](/developers/docs/modules/retriever-vectorizer-modules/multi2vec-clip.md)
...
the [Weaviate JS Client](/developers/docs/client-libraries/javascript.md)
...
It includes a [schema](/developers/docs/tutorials/how-to-create-a-schema.md) with classes for `Article`, `Publication`, `Category` and `Author`. 

...
- [S3](/developers/docs/configuration/backups.md#s3-aws-or-s3-compatible)
- [GCS](/developers/docs/configuration/backups.md#gcs-google-cloud-storage)
...
As of Weaviate `v1.16`, the only supported internal backup provider is the [filesystem](/developers/docs/configuration/backups.md#filesystem) provider.

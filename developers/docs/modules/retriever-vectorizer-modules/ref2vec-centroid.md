...
This module can be used with the existing [nearVector](/developers/docs/api/graphql/vector-search-parameters.md#nearvector) and [`nearObject`](/developers/docs/api/graphql/vector-search-parameters.md#nearobject) filters. It does not add any additional GraphQL extensions like `nearText`.

...
* Using this module will enable GraphQL vector search parameters in Weaviate. They can be found [here](/developers/docs/api/graphql/vector-search-parameters.md#neartext).

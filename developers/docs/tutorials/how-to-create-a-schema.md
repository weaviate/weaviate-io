...
- Learn about Concepts, Classes, Properties and dataTypes in the [API reference guide](/developers/docs/api/index.md).
...
If you begin to import data without having defined a schema, it will trigger the [auto-schema feature](/developers/docs/configuration/schema-configuration.md#auto-schema) and Weaviate will create a schema for you.

...
You can also use the Docker compose [configurator](/developers/docs/quickstart/installation.md#docker-compose). Make sure to select `Enabled` for the Enterprise Usage Collector option.

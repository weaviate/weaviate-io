...
**Vector quantization** reduces the memory footprint of the [vector index](/developers/weaviate/concepts/indexing/vector-indexes) by compressing the vector embeddings, and thus reduces deployment costs and improves the speed of the vector similarity search process.

...
As you're probably guessing, we have a separate quickstart tutorial for [working with a schema](/developers/weaviate/quickstart/schema.md).
...
1. You can configure module behavior, ANN index settings, reverse index types, etc. In the schema as well (more about this in the schema [quickstart tutorial](/developers/weaviate/quickstart/schema.md)).

...
* Starting with `v1.25.0`, Weaviate adopts the [Raft consensus algorithm](https://raft.github.io/) to ensure strong consistency for schema changes. This brings an additional benefit in that concurrent schema changes are now supported. If you are a Kubernetes user, please see the [`1.25 migration guide`](/developers/weaviate/more-resources/migration/weaviate-1-25.md) as this change requires you to delete your existing StatefulSet.

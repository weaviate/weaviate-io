...
Because you will be getting embeddings based on your own API key, you will be dealing with the rate limits applied to your account. If you have a low rate limit set, Weaviate will output the error message generated by the OpenAI API.

##### Request a higher or removal of your rate limit

...
* `vectorCacheMaxObjects` is the Weaviate cache. By default it is set to one trillion (1e12). We recommend setting this to a number _greater_ than your total object amount.

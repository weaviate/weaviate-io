...
![Write consistency QUORUM](/img/docs/replication/replication-rf3-c-QUORUM.png "Read consistency QUORUM"){:style="max-width: 75%; display: block; margin: 0 auto"}
...
![CAP Theorem](/img/docs/replication/repliction-cap.png "CAP Theorem"){:style="max-width: 60%; display: block; margin: 0 auto"}
...
![Replication vs Sharding](/img/docs/replication/replication-replication-vs-sharding.png "Replication vs Sharding"){:style="max-width: 60%; display: block; margin: 0 auto"}

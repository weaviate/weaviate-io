...
<table class="rbac-table">
  ...
  <tbody>
    ...
    <tr>
      <td>
        <Link to="/developers/weaviate/configuration/rbac/manage-roles#user-management-permissions">
    ...
    <tr>
      <td>
        <Link to="/developers/weaviate/configuration/rbac/manage-roles#replications-permissions">

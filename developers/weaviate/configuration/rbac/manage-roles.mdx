...
import RoleGoCode from '!!raw-loader!/_includes/code/go/howto.configure.rbac.roles.go';
...
Visit the [Manage users](https://www.google.com/search?q=./manage-users.mdx) page to learn more about assigning roles to users as well as creating, updating and deleting users.

## Further resources

- [RBAC: Overview](https://www.google.com/search?q=./index.mdx)
- [RBAC: Configuration](https://www.google.com/search?q=./configuration.md)

...
intro: Quick start tutorial of Weaviate running with the text2vec-contextionary module with a demo dataset. This page also shows how contextual classification can be done.
...
Download the Docker Compose file (note, the Dockerfile has GPUs (i.e., CUDA) disabled, this impacts import and query time significantly. If you have a GPU available ([that is reachable with Docker](https://docs.docker.com/compose/gpu-support/)) simply set `ENABLE_CUDA` to `1` in the [dockerfile](https://github.com/semi-technologies/DEMO-datasets/blob/08577004cb35b850f85eddaef772831921f9d674/newspublications/docker-compose.yml#L26))

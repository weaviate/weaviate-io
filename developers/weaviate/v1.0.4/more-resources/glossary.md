...
| **Weaviate Cloud Service (WCS)** | A managed services that hosts Weaviate clusters on the SeMI Network |
| **Vector index** | A data storage mechanism based where data is stored as vectors (long arrays of numbers, also seen as coordinates in a high dimensional space), allowing for context-based search |

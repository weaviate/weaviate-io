...
*Note: this video was recorded with Weaviate version 0.22.x and Python client version 1.2.0, while this page describes Weaviate version 1.0.0, with Python client version 2.0.0. There are significant changes in the API.*

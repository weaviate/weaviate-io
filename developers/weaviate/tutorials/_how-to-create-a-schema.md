...
If you begin to import data without having defined a schema, it will trigger the [auto-schema feature](/developers/weaviate/config-refs/schema.mdx#auto-schema) and Weaviate will create a schema for you.

...
For the collection `Brands`, we are going to use the [`auto-schema`](../config-refs/schema/index.md#auto-schema) option which creates properties automatically based on the imported data.

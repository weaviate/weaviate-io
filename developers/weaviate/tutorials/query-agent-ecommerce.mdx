...
import PyCode from '!!raw-loader!/developers/weaviate/tutorials/_includes/query-agents-ecommerce.py';

In this tutorial, we will be building a simple e-commerce assistant agent with the **[Weaviate Query Agent](../../agents/query.md)**. This agent will have access to multiple Weaviate collections, and will be capable of answering complex queries about brands and clothing items, accessing information from each collection.
...
2. **Uses an appropriate foundation model** (e.g. large language model) to analyze the task and determine the exact queries to perform.
3. **Sends the queries to Weaviate**. Weaviate vectorizes the queries as needed using the specified vectorizer integration (we will use Weaviate Embeddings).
4. **Receives the results from Weaviate** and uses appropriate foundation models to generate the final response to the user prompt/query.
...
If you want to use another vectorizer, check out the list of supported [model providers](../model-providers/index.md).
:::
...
In the following code blocks, we are pulling our demo datasets from Hugging Face and writing them to new collections in our Weaviate Serverless cluster. Before we can start importing the data into Weaviate, we need to **define the collections**, which means setting up the data schema and choosing the vectorizer/embedding service. 
...
The `QueryAgent` uses the **descriptions of collections and properties** to decide which ones to use when solving queries and to access more information about properties. You can experiment by changing these descriptions and providing more details. It's good practice to provide property descriptions too.

For example, below we make sure that the `QueryAgent` knows that prices are all in USD, which is information that would otherwise be unavailable.
...
╭───────────────────────────────────────────────────────────────────────────────────────────────────────────────── 📝 Final Answer ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────╮
│                                                                                                                                                                                                                                                   │
│ Here are some vintage clothing options available for less than $200:                                                                                                                                                                              │
│                                                                                                                                                                                                                                                   │
│ 1. **Vintage Philosopher Midi Dress** - $125                                                                                                                                                                                                      │
│    - Brand: Echo & Stitch                                                                                                                                                                                                                         │
│    - Colors: Deep green velvet with antique gold button detailing                                                                                                                                                                                 │
│    - Description: This vintage-inspired midi dress is perfect for those who love classic styles with its tailored fit and pleated skirt.                                                                                                          │
│                                                                                                                                                                                                                                                   │
│ 2. **Vintage Gale Pleated Dress** - $120                                                                                                                                                                                                          │
│    - Brand: Solemn Chic                                                                                                                                                                                                                           │
│    - Colors: Burgundy                                                                                                                                                                                                                             │
│    - Description: Capturing the essence of Dark Academia, this dress features deep pleats with a scholarly silhouette.                                                                                                                            │
│                                                                                                                                                                                                                                                   │
│ 3. **Retro Groove Flared Pants** - $59                                                                                                                                                                                                            │
│    - Brand: Vivid Verse                                                                                                                                                                                                                           │
│    - Colors: Electric Blue                                                                                                                                                                                                                        │
│    - Description: Inspired by early 2000s fashion, these vibrant flared pants bring a playful vibe to any outfit.                                                                                                                                 │
│                                                                                                                                                                                                                                                   │
│ 4. **RetroFuturist Tee** - $29.98                                                                                                                                                                                                                 │
│    - Brand: Vivid Verse                                                                                                                                                                                                                           │
│    - Colors: Blue, Silver                                                                                                                                                                                                                         │
│    - Description: A graphic tee that combines early 2000s pop culture with a futuristic flair.                                                                                                                                                    │
│                                                                                                                                                                                                                                                   │
│ 5. **TechGlam Graphic Tee** - $29.98                                                                                                                                                                                                              │
│    - Brand: Vivid Verse                                                                                                                                                                                                                           │
│    - Colors: Blue, Silver                                                                                                                                                                                                                         │
│    - Description: This tee features futuristic visuals and pop culture references from the early 2000s.                                                                                                                                           │
│                                                                                                                                                                                                                                                   │
│ 6. **Vintage Scholar Tote** - $90                                                                                                                                                                                                                 │
│    - Brand: Echo & Stitch                                                                                                                                                                                                                         │
│    - Colors: Deep Green and Brown leather accents                                                                                                                                                                                                 │
│    - Description: Combining functionality and elegance, this tote is ideal for carrying scholarly essentials.                                                                                                                                     │
│                                                                                                                                                                                                                                                   │
│ 7. **Victorian Velvet Jumpsuit** - $120                                                                                                                                                                                                           │
│    - Brand: Solemn Chic                                                                                                                                                                                                                           │
│    - Colors: Black, Burgundy                                                                                                                                                                                                                      │
│    - Description: Evocative of vintage romance and academic elegance, perfect for intellectual settings.                                                                                                                                          │
│                                                                                                                                                                                                                                                   │
│ 8. **Vintage Scholar Turtleneck** - $55                                                                                                                                                                                                           │
│    - Brand: Echo & Stitch                                                                                                                                                                                                                         │
│    - Colors: Black, Grey                                                                                                                                                                                                                          │
│    - Description: A turtleneck that brings a Dark Academia aesthetic to any wardrobe.                                                                                                                                                             │
│                                                                                                                                                                                                                                                   │
│ These items capture various aspects of vintage fashion and are budget-friendly options for under $200.                                                                                                                                            │
│                                                                                                                                                                                                                                                   │
╰───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────╯
...
╭─────────────────────────────────────────────────────────────────────────────────────────────────────────────────── 📚 Sources ────────────────────────────────────────────────────────────────────────────────────────────────────────────────────╮
│                                                                                                                                                                                                                                                   │
│  - object_id='d97e3418-2b53-471d-bc6e-4ec2429e0e8d' collection='Ecommerce'                                                                                                                                                                        │
│  - object_id='a40fe71c-a37f-4ab4-a41c-b1e5493a408c' collection='Ecommerce'                                                                                                                                                                        │
│  - object_id='a6c28245-7795-4a91-9a9c-668a033dda8a' collection='Ecommerce'                                                                                                                                                                        │
│  - object_id='834b4125-672d-4cff-a71c-6db504716d74' collection='Ecommerce'                                                                                                                                                                        │
│  - object_id='111c65a5-2c09-4739-b585-e84ea1f78194' collection='Ecommerce'                                                                                                                                                                        │
│  - object_id='281b550a-4308-4512-bb47-58938c1bc2e6' collection='Ecommerce'                                                                                                                                                                        │
│  - object_id='54dbedea-b07d-4234-95e6-55a4298c1fda' collection='Ecommerce'                                                                                                                                                                        │
│  - object_id='e6f64102-a9db-43f3-acc6-8c5bcb8cf5dd' collection='Ecommerce'                                                                                                                                                                        │
│  - object_id='e3f0f18c-0867-4801-9963-2c37867c56a5' collection='Ecommerce'                                                                                                                                                                        │
│  - object_id='e1ce340f-aaa2-4923-872e-ed705448facc' collection='Ecommerce'                                                                                                                                                                        │
│                                                                                                                                                                                                                                                   │
╰───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────╯
...
╭───────────────────────────────────────────────────────────────────────────────────────────────────────────────── 📝 Final Answer ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────╮
│                                                                                                                                                                                                                                                   │
│ Unfortunately, the search and aggregation results did not provide information regarding which brand lists the most shoes. Without specific data or examples from the search results, this question cannot be answered at this time.               │
│                                                                                                                                                                                                                                                   │
╰───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────╯
╭───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────╮
│                                                                                                                                                                                                                                                   │
...
│     aggregations=[IntegerPropertyAggregation(property_name='collection', metrics=<NumericMetrics.COUNT: 'COUNT'>)],                                                                                                                               │
│     filters=[TextPropertyFilter(property_name='collection', operator=<ComparisonOperator.EQUALS: '='>, value='shoes')],                                                                                                                           │
│     collection='Ecommerce'                                                                                                                                                                                                                        │
│ )                                                                                                                                                                                                                                                 │
│                                                                                                                                                                                                                                                   │
╰───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────╯
...
│                                                                                                                                                                                                                                                   │
│ - Brand with the most shoes listed.                                                                                                                                                                                                               │
│                                                                                                                                                                                                                                                   │
╰───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────╯
...
```
Eko & Stitch operates in the UK as it is based there. It does not have an additional branch because the brand itself is located in the UK. Additionally, Eko & Stitch has parent and child companies. The parent brand of Eko & Stitch is Nova Nest, also situated in the UK. Eko & Stitch has child brands named Eko & Stitch Active and Eko & Stitch Kids, but there is no specific mention of these child brands having separate, distinct locations within the UK.
```
...
- [Weaviate Agents - Query Agent](../../agents/query.md)

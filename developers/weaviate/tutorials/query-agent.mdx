...
We've prepared a few open datasets that you can use to explore the Query Agent.  
...
To use the Weaviate Query Agent and Weaviate Embedding service, you need to have a [Weaviate Cloud](https://weaviate.io/deployment/serverless) account.
...
Now you can finally connect to you Weaviate Cloud instance with the parameters from the first step:

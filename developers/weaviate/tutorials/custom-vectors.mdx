---
title: Custom vectors
sidebar_position: 10
image: og/docs/tutorials.jpg
# tags: ['getting started']
---

As a [vector database](https://weaviate.io/blog/what-is-a-vector-database), Weaviate operates using vector representations, also known as "embeddings", of data objects.

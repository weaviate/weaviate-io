...
| [Demo dataset News Publications with Contextionary](https://github.com/weaviate/weaviate-examples/tree/main/weaviate-contextionary-newspublications) | yaml | Docker-compose configuration file of Weaviate with a News Publications demo dataset. |

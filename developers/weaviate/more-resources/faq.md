...
- [Weaviate's HNSW implementation in the docs)[/developers/weaviate/concepts/vector-index-plugins.md#hnsw)

_Note I: HNSW is just one implementation in Weaviate, but Weaviate can support multiple indexing algoritmns as outlined [here)[/developers/weaviate/vector-index-plugins/)_

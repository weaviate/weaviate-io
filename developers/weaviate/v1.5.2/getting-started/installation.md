...
long-running deployments or those with specific availablity expectations, such
...
* Helm (both v2 and v3 are compatible. Note that Helm v2 requires [setting up Tiller on the
  cluster](https://v2.helm.sh/docs/using_helm/#initialize-helm-and-install-tiller)
  prior to installing charts)

...
```json
{
  ...
  "vectorizer": "text2vec-contextionary",   // vectorizer to use for data objects added to this class, defaults to text2vec-contextionary for now
  "moduleConfig": {
...
The vectorizer can be specified per class in the [schema object](#schema-object). The only available vectorizer is currently the [`text2vec-contextionary`](../modules/text2vec-contextionary.html).

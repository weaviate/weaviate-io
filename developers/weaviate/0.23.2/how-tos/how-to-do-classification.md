...
toc: true
redirect_from:
    - /documentation/weaviate/current/how-tos/how-to-do-classification.html
---
...
1. **Contextual classification**. Uses the context of data points to make new references. There is no training data needed, and this type of classification is the right pick if you have a strong semantic relation in your data. See [here](../restful-api-references/classification.html#contextual-classification) for more information. 
...
If we later want to know to which `Category` a specific `Article` refers to, we can send the following `GET` request to `/v1/things/{ArticleID}/?include=_classification`, which will return: 
        ...
        "Article": [
          {
            ...
            "wordCount": 908,
            "hasPopularity": [{
              "beacon": "weaviate://localhost/things/c9a0e53b-93fe-38df-a6ea-4c8ff4501798",
              "href": "/v1/things/c9a0e53b-93fe-38df-a6ea-4c8ff4501798"
            }]
          },
          {
            ...
            "wordCount": 361,
            "hasPopularity": [{
              "beacon": "weaviate://localhost/things/aca140a9-ac15-4b0c-a508-85534c4def44",
              "href": "/v1/things/aca140a9-ac15-4b0c-a508-85534c4def44"
            }]
          },
          {
...
{% include code/0.23.2/classification.knn.post.articles.html %}
...
```bash
curl http://localhost:8080/v1/things/8676e36a-8d60-3402-b550-4e792bb9d32f?include=classification
```

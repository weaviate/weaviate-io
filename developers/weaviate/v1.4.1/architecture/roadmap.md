...
<table class="roadmap-table">
  ...
  <tr>
    <td>
      <i>status: done in (<a href="https://github.com/semi-technologies/weaviate/releases/tag/v1.5.0-rc.1">v1.5.0-rc.1</a> (Note: This is a release candidate))</i>
    </td>
  </tr>
  <tr>
    <td>
...
<table class="roadmap-table">
  ...
  <tr>
    <td>
      <i>status: in progress (<a href="https://github.com/semi-technologies/weaviate/milestone/22">follow on GitHub</a>)</i>
    </td>
  </tr>
  <tr>
    <td>

...
- Check out how to [spin up a Weaviate](/developers/weaviate/quickstart/installation.md) with your own [schema](/developers/weaviate/tutorials/how-to-create-a-schema.md) and [data](/developers/weaviate/tutorials/how-to-import-data.md).

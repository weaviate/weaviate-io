...
You will be able to use the gRPC interace through the upcoming Weaviate Python client library version `v4` ([preview version](../client-libraries/experimental)). gRPC support in the other client libraries will follow.

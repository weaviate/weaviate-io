...
Weaviate is open source and you can easily [run the binary on Linux](../installation/embedded.md) or [run a local instance from a Docker image](../installation/docker-compose.md) on any OS, or even easier - you can create a free sandbox instance with the [Weaviate Cloud](../../wcs/quickstart.mdx) (WC).

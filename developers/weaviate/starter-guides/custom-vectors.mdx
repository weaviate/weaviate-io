...
This tutorial will guide you through the process of using Weaviate with your own vectors.

If you choose to specify your own vector embeddings, you can perform a vector search with Weaviate like this:

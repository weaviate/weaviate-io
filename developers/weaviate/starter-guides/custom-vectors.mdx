...
Vectorizer One way to generate these vectors is to use a ["vectorizer" module](../modules/retriever-vectorizer-modules/index.md), which will generate a vector at import and query time. This can be a convenient method if you are using a publicly available model and want to simplify your pipeline.
...
This tutorial guides you through the process of using Weaviate with your own vectors.

1. Create a Weaviate instance
2. Connect to the Weaviate instance
3. Import your data while specifying your own vectors

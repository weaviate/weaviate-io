...
This feature is useful for occasional queries on offloaded tenants that aren't frequently accessed, or require low latency / high throughput.
...
:::caution TODO
@loicreyreaud this page is just to let people know about the feature.
:::

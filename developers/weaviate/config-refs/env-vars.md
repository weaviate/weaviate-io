...
| <code>REINDEX<wbr />_SET_TO<wbr />_ROARINGSET<wbr />_AT_STARTUP</code> | Allow Weaviate to perform a one-off re-indexing to use roaring bitmaps. <br/><br/>Available in versions `1.18` and higher. | `string - true/false` | `true` |

...
| <code>WEAVIATE<wbr />_ASYNC<wbr />_INDEXING</code> | If set, Weaviate will perform indexing asynchronously to the object creation process. This can be useful for importing large amounts of data. (default: `false`) <br/><br/>Available in versions `1.22` and higher. | `string - true/false` | `false` |

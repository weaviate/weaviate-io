...
| `REPLICA_MOVEMENT_MINIMUM_ASYNC_WAIT` | How long replica movement waits during the [`dehydrating` phase](../../concepts/replication-architecture/cluster-architecture.md#movement-states), after file copy but before finalizing the move. Default: `60` seconds <br/>Added in `v1.32` | `string - number` | `90` |

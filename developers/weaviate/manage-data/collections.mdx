...
Multi-vector embeddings use up more memory than one-dimensional vector embeddings. You can use [vector quantization](../configuration/compression/index.md) to compress them and reduce memory usage.
:::

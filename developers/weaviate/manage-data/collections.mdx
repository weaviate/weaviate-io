...
You can update property descriptions after the collection has been created. 

<Tabs groupId="languages">
  <TabItem value="py" label="Python Client v4">
    <FilteredTextBlock
      text={PyCode}
      startMarker="# START UpdatePropertyDescriptions"
      endMarker="# END UpdatePropertyDescriptions"
      language="py"
    />
  </TabItem>

...
- Read more about index types & compression in [Concepts: Vector index](/developers/weaviate/concepts/indexing/vector-indexes).

</details>

## Set vector index parameters

Various vector index parameters are configurable at collection creation time, including [compression](../configuration/compression/index.md).
...
Configure a [`reranker`](../concepts/search/index.md#rerank) for [reranking retrieved results](../search/rerank.md).

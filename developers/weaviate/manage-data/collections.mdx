...
You can now [specify the generative model integration at query time](../search/generative.md#configure-a-generative-model-provider) without updating it in the collection configuration.

...
To create a collection, specify at least the collection name. If you don't specify any properties, [`auto-schema`](../config-refs/schema#auto-schema) creates them.  
...
To disable [`auto-schema`](../config-refs/schema#auto-schema) set `AUTOSCHEMA_ENABLED: 'false'` in your system configuration file.
...
- [Vectorizer configuration references](../config-refs/schema#vectorizer)
...
- [Vector indexes](../config-refs/schema#vectorindexconfig)
...
- [Replication](../config-refs/schema#replicationconfig)
...
- [Sharding](../config-refs/schema#shardingconfig)
...
- [References: Configuration: Schema](../config-refs/schema)
- [References: Schema](../config-refs/schema)

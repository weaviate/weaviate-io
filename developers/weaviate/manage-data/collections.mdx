...
To create a collection, specify at least the collection name. If you don't specify any properties, [`auto-schema`](/developers/weaviate/config-refs/schema#auto-schema) creates them.  
...
To disable [`auto-schema`](/developers/weaviate/config-refs/schema#auto-schema) set `AUTOSCHEMA_ENABLED: 'false'` in your system configuration file.
...
- [Vector indexes](/developers/weaviate/config-refs/schema#vectorindexconfig)

...
To configure how a module works with a specific collection, set the module level parameters in the collection schema.
...
To configure how a module works with specific collection parameters, use module parameters at the property level.
...
Configure indexing, sharding, and replication per collection.

...
Multi-vector embeddings use up more memory than single vector embeddings. You can use [vector quantization](../configuration/compression/multi-vectors.md#quantization) and [encoding](../configuration/compression/multi-vectors.md#encoding-muvera) to compress them and reduce memory usage.
:::

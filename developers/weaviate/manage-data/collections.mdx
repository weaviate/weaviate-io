...
You can manually update a shard to change it's state. For example, update the shard to change the state from `READONLY` to `READY` after lowering disk pressure.

...
- Manually, or
- Have Weaviate create it as needed, such as at import time. The [`Auto-schema` feature](../config-refs/schema.md#auto-schema) must be enabled for this to occur.
...
If you create objects into a class that does not yet exist, or if you create objects with properties that do not yet exist, Weaviate can create the class and/or properties for you. This is known as the `Auto-schema` feature.

Generally, we recommend you create classes and properties manually, as you will gain greater control over your data model.
...
Weaviate `1.22` added support for nested objects. This can be very useful for storing structured data, such as an address containing a street, city and country.

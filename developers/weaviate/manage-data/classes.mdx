...
- Manually, or
- Automatically. Weaviate can create collection as needed, such as at import time. The [`Auto-schema` feature](../config-refs/schema.md#auto-schema) must be enabled for this to occur.
...
Some property names are reserved for internal use. The list of reserved property names can be [found here](../config-refs/schema.md#reserved-words).

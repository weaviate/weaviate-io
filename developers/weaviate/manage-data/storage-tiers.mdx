...
The tenant's object data, vector index and inverted index are stored on disk, using `warm` resources. Since the tenant is stored locally, inactive tenants can be activated quickly.

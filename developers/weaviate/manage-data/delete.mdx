...
- There is a configurable [maximum limit (QUERY_MAXIMUM_RESULTS)](../config-refs/env-vars.md#general) on the number of objects that can be deleted in a single query (default 10,000). To delete more objects than the limit, re-run the query.

...
If you add a new property, Weaviate only vectorizes the new objects. Weaviate doesn't re-vectorize and re-index existing objects when anew property is added, only when an existing property is updated.

...
If you update the value of a previously vectorized property, Weaviate re-vectorizes the object automatically.

If you add a new property to your collection definition, Weaviate only vectorizes the new objects. Weaviate doesn't re-vectorize and re-index existing objects when a new property is defined, only when an existing property is updated.

...
<details>
  ...
  - Updates that include a `vector` property will recalculate the vector embedding (unless all updated `text` properties are [skipped](../configuration/schema-configuration.md#property-level-module-settings)).

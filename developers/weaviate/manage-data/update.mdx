...
If you update a vectorized property, Weaviate re-vectorizes the object automatically. If you change a property for all of the objects in a collection, Weaviate will re-vectorize all of the objects.

If you add a new property, Weaviate only vectorizes the new objects. Weaviate doesn't re-vectorize and re-index existing objects when a new property is added, only when an existing property is updated.

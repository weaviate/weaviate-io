...
When you create an object, you can specify named vectors (if [configured in your collection](./collections.mdx#define-named-vectors)).
...
Before you create an object, you can [validate](/developers/weaviate/api/rest#tag/objects/post/objects/validate) it against the collection definition.

...
import CurlCode from '!!raw-loader!/_includes/code/howto/manage-data.cross-refs.sh';
...
<Tabs groupId="languages">
  ...
  <TabItem value="curl" label="Curl">
    <FilteredTextBlock
      text={CurlCode}
      startMarker="# START OneWay Cross-references"
      endMarker="# END OneWay Cross-references"
      language="bash"
    />
  </TabItem>
</Tabs>

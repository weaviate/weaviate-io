...
To maximise import speed, enable asynchronous indexing in Weaviate and use gRPC batch imports. Asynchronous indexing decouples vector indexing from object creation ([read more](../config-refs/schema/vector-index.md#asynchronous-indexing)), and gRPC batch imports are faster than REST batch imports.
...
:::info See also
- [Configuration: Vector index](../config-refs/schema/vector-index.md#asynchronous-indexing)
:::

...
To maximize import speed, enable [asynchronous indexing](../config-refs/schema/vector-index#asynchronous-indexing) and use gRPC batch imports. 
...
- [Configuration: Indexes](../config-refs/schema/vector-index#asynchronous-indexing)

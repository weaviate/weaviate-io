...
Weaviate supports deployment with Docker. Starting in v1.24, there is an image that runs using default values. Alternatively, edit the `docker-compose.yml` file to customize your instance.

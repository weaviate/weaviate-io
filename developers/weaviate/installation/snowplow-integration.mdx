...
Then, load your data into the Snowflake stage. The upload takes a few seconds.

```sql
PUT file:///path/to/sample-data/SampleJSON.json @DATA overwrite=true auto_compress=false;
```

### 10. Configure the Jupyter Notebook login

Follow these steps to configure login for Jupyter Notebooks. 
...
### 11. Use a Jupyter Notebook to load your data

This client code creates a schema and loads the data you uploaded earlier into Weaviate.

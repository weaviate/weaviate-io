...
Grant permission to the services to the weaviate_role and load the logs from the jupyter endpoint to get a Jupyter key. Finally, get the public endpoint that you can use to access Jupyter Notebooks.
```sql

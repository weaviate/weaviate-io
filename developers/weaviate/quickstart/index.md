  ...
  <div class="row">
    ...
    <div class="col col--6 margin-bottom--md">
      <div class="card">
        ...
        <div class="card__body">
          <p>
            Check out the <a href="starter-guides/generative">Starter guide: retrieval augmented generation</a>, and the <a href="/developers/academy">Weaviate Academy</a> unit on <a href="/developers/academy/py/standalone/chunking">chunking</a>.
          </p>
        </div>
      </div>
    </div>

...
The [Query application (query tool)](/developers/wcs/tools/query-tool) is a browser-based GraphQL IDE. The Query tool is available in the Weaviate Cloud (WCD) console.

Use the query tool to work interactively with clusters hosted in Weaviate Cloud and self-hosted instances too.

## Open the query tool

To use the query tool, open your [WCD Dashboard](https://console.weaviate.cloud).

...
The [Query application (query app)](/developers/wcs/tools/query-tool) is a browser-based GraphQL IDE. The Query app is available in the Weaviate Cloud (WCD) console.

...
## Change the default URL or port
...
For additional client examples, see [OIDC authentication](/developers/weaviate/connections/connect-custom#oidc-authentication).

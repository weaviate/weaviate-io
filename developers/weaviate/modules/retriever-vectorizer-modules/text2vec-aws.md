...
This module uses your AWS credentials. API limits that restrict your AWS account also apply to the module. When the API returns an error, Weaviate returns an error message.

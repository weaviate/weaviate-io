...
- Which vectorizer and other modules are applied to which data classes is configured in the [schema](/developers/weaviate/configuration/schema-configuration.md#specify-a-vectorizer).
...
If you choose to build a completely new module including a Weaviate Go interface, you can contact us via [Slack](https://weaviate.io/slack) or through an [issue on GitHub](https://github.com/weaviate/weaviate/issues), so we can help you get started.

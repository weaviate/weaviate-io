...
This example searches for objects that have the keyword `food` in the only `question` property. It ranks the the objects using the BM25F scores of the searched property, and returns the top 3.

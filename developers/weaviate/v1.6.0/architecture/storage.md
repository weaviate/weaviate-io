...
WALs are append-only files, which are very efficent to write and rarely the
...
if an unexpected crash happens and Weaviate encounteres and "incomplete" WAL,
...
fresh, a background process will continously compact WAL files and remove

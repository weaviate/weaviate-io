...
The weaviate object is the main entry point for all API operations. The v3 client instantiates the weaviate object and [creates a connection](/developers/weaviate/connect/connect) to your Weaviate instance.
...
- [Connect to Weaviate](/developers/weaviate/connect/connect)
...
1. Edit your v2 code to [import](./developers/weaviate/client-libraries/typescript/typescript-v3#import-the-client) the v3 client package.
1. Edit your v2 [client instantiation](/developers/weaviate/client-libraries/typescript/typescript-v3#connect-to-weaviate) code.
1. Edit your code to reflect the [collection first](/developers/weaviate/client-libraries/typescript/typescript-v3#design-philosophy) client orientation.

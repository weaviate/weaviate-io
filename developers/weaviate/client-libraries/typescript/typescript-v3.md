...
The v2 client code examples are being updated for the v3 client. Some example code may not be available yet.
:::
...
The example code for the [RESTful endpoints](../../api/rest/index.md) and [GraphQL functions](../../api/graphql/index.md)  that the TypeScript client supports is written in JavaScript.

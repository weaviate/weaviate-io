...
You can instantiate the `WeaviateClient` object directly. However, in most cases it is better to use a connection helper function such as `connect_to_local` or `connect_to_wcs`.

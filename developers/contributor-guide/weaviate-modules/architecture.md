...
In more detail, let's look at how a specific (GraphQL) function is implemented in the [`text2vec-transformers`](/developers/docs/modules/retriever-vectorizer-modules/text2vec-transformers.md) module:

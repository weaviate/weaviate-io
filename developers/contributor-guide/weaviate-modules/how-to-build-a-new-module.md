...
On this page, you'll find how to create a complete new module (option B), so building part 1 and 2. If you only want to replace part 2 (so making use of an existing Weaviate module's API design), you can find instructions [here](/developers/weaviate/modules/custom-modules.md#a-replace-parts-of-an-existing-module).

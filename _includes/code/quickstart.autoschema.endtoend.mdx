...
const client = weaviate.client({
  ...
  headers: { 'X-OpenAI-Api-Key': '<YOUR-OPENAI-API-KEY>' },  // replace with your OpenAI API key
});
...
# Replace with your OpenAI API token (e.g. as an environment variable: $OPENAI_API_KEY)

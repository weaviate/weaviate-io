...
<FilteredTextBlock
  text={EndToEndPyCode}
  startMarker="# ===== Query instance ====="
  endMarker="# ===== Test query results ====="
  language="py"
/>
...
<FilteredTextBlock
  text={EndToEndJSCode}
  startMarker="// NearText JS"
  endMarker="// END NearText JS"
  language="js"
/>
...
<FilteredTextBlock
  text={EndToEndTSCode}
  startMarker="// NearText TS"
  endMarker="// END NearText TS"
  language="ts"
/>

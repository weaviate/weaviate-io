...
client = weaviate.Client("https://WEAVIATE_INSTANCE_URL/")  # Replace with your endpoint
...
const classObj = const schema = {
  ...
  vectorIndex: weaviate.configure.vectorIndex.hnsw({
    ...
    quantizer: weaviate.configure.vectorIndex.quantizer.pq({segments:192}),
  })
}
...
public class App {
  public static void main(String[] args) {
    Config config = new Config("https", "sWEAVIATE_INSTANCE_URL/");

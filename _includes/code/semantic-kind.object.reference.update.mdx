...
client.data_object.reference.update(
  ...
  consistency_level=weaviate.data.replication.ConsistencyLevel.QUORUM,  # default ALL
)
```
...
curl \
    ...
    http://localhost:8080/v1/objects/SourceClass/36ddd591-2dee-4e7e-a3cc-eb86d30a4303/references/wroteArticles?consistency_level=QUORUM
```

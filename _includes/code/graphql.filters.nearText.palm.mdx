...
const client = weaviate.client({
  scheme: 'http',
  host: 'localhost:8080',
  headers: {'X-Palm-Api-Key': '<THE-KEY>'},
});
...
func main() {
  cfg := weaviate.Config{
    Host:    "localhost:8080",
    Scheme:  "http",
    Headers: map[string]string{"X-Palm-Api-Key": "<THE-KEY>"},
  }

...
<TabItem value="py" label="Python (v4)">
    <FilteredTextBlock
      text={PyCode}
      startMarker="# START NearTextGoogle"
...
const client = weaviate.client({
  scheme: 'http',
  host: 'localhost:8080',
  headers: { 'X-Google-Api-Key': 'YOUR-GOOGLE-API-KEY' },
});
...
func main() {
  cfg := weaviate.Config{
    Host:    "localhost:8080",
    Scheme:  "http",
    Headers: map[string]string{"X-Google-Api-Key": "YOUR-GOOGLE-API-KEY"},
  }
...
public class App {
  public static void main(String[] args) {
    Map<String, String> headers = new HashMap<String, String>() { {
      put("X-Google-Api-Key", "YOUR-GOOGLE-API-KEY");
    } };

...
There are two ways to instantiate a Python client. Use the `connect_to_embedded()` helper method if you don't need to pass custom connection information:
...
To avoid connection errors if you create a client with `WeaviateClient()`, use `client.close()` or a context manager to close your client connections before you exit your script or application.

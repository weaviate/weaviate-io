...
import MyComponentSource from '!!raw-loader!/_includes/code/quickstart.autoschema.endtoend.py';

<FilteredTextBlock text={MyComponentSource} startMarker="import weaviate" endMarker="# ===== add schema ====="/>

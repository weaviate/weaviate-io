...
import EndToEndPyCode from '!!raw-loader!/_includes/code/quickstart/quickstart.create_collection.py';
...
<TabItem value="py" label="Python">
  ...
  <FilteredTextBlock
    text={EndToEndPyCode}
    startMarker="# ShortCreateCollection"
    endMarker="# END ShortCreateCollection"
    language="py"
  />

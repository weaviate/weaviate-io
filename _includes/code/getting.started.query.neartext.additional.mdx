...
nearText = {"concepts": ["famous scientist"]}
...
client.graphql
  ...
  .withFields('question answer _additional {vector certainty}')
  .withNearText({concepts: ["famous scientist"]})
  .withLimit(2)
  .do()
  .then(console.log)
  .catch(console.error);
...
func main() {
  ...
  concepts := []string{"famous scientist"}

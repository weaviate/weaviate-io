...
client = weaviate.Client(
    ...
    auth_client_secret=weaviate.AuthClientPassword(
        username = wcs_username,  # Replace with your Weaviate Cloud username
        password = wcs_password,  # Replace with your Weaviate Cloud password
    ),
)
```
...
const client = await weaviate.connectToWCD(
  'WEAVIATE_INSTANCE_URL', { // Replace WEAVIATE_INSTANCE_URL with your instance URL
    authCredentials: new weaviate.AuthUserPasswordCredentials({
        username: wcsUsername,  // Replace with your Weaviate Cloud username
        password: wcsPassword,  // Replace with your Weaviate Cloud password
      }), 
  } 
)
```
...
WeaviateAuthClient.clientPassword(
    config,
    wcsUsername,  // Replace with your Weaviate Cloud username
    wcsPassword,  // Replace with your Weaviate Cloud password
);
```

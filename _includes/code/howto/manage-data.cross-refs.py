...
assert any(category["href"] == f"/v1/objects/JeopardyCategory/{us_cities_id}"
           for category in sf["properties"]["hasCategory"])
# END Test results
...
assert any(category["href"] == "/v1/objects/JeopardyCategory/20ffc68d-986b-5e71-a680-228dba18d7ef"
           for category in sf["properties"]["hasCategory"])
assert any(category["href"] == "/v1/objects/JeopardyQuestion/00ff6900-e64f-5d94-90db-c8cfa3fc851b"
           for category in us_cities["properties"]["hasQuestion"])
# END Test results
...
assert any(category["href"] == f"/v1/objects/JeopardyCategory/{us_cities_id}"
           for category in sf["properties"]["hasCategory"])
assert any(category["href"] == f"/v1/objects/JeopardyCategory/{museums_id}"
           for category in sf["properties"]["hasCategory"])
# END Test results

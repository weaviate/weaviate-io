![Weaviate 1.16 release](./core-1-16-img/hero.png)
...
![New Filter Operators](./core-1-16-img/filters.png)
...
## Distributed Backups
![Distributed Backups](./core-1-16-img/distributed-backups.png)
...
![The dance of distributed backup and restore](./core-1-16-img/backup-dance.png)
...
![ref2vec-centroid Module](./core-1-16-img/ref2vec-centroid.png)
...
import centroidVideo from './core-1-16-img/ref2vec-centroid-demo.mp4';
...
## Node Status API
![Node status API](./core-1-16-img/node-status-api.png)
...
![More powerful OIDC Auth](./core-1-16-img/oidc.png)
...
![Fixes since v1.15](./core-1-16-img/fixes-since-1.15.png)
...
![Fixes in v1.16](./core-1-16-img/fixes-1.16.png)

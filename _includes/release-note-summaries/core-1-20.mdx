![Weaviate 1.20](./core-1-20-img/highlights.png)
...
![Conceptual diagram of multi-tenancy in Weaviate](./core-1-20-img/Weaviate-multi-tenancy-light.png#gh-light-mode-only)
![Conceptual diagram of multi-tenancy in Weaviate](./core-1-20-img/Weaviate-multi-tenancy-dark.png#gh-dark-mode-only)
...
![Conceptual diagram of query speed vs recall](./core-1-20-img/Weaviate-release-1-20_qps_recall_light.png#gh-light-mode-only)
![Conceptual diagram of query speed vs recall](./core-1-20-img/Weaviate-release-1-20_qps_recall_dark.png#gh-dark-mode-only)
...
![Fig 1](./core-1-20-img/fig1_before.png)
...
![Fig 2](./core-1-20-img/fig2_after.png)
...
![Fig 3](./core-1-20-img/fig3_real_world.png)
...
![A cute cartoon of Weaviate presenting results](./core-1-20-img/Weaviate-release-1-20_autocut_light.png#gh-light-mode-only)
![A cute cartoon of Weaviate presenting results](./core-1-20-img/Weaviate-release-1-20_autocut_dark.png#gh-dark-mode-only)
...
![A conceptual figure of a multi-stage search with Weaviate](./core-1-20-img/Weaviate-release-1-20_reranker_light.png#gh-light-mode-only)
![A conceptual figure of a multi-stage search with Weaviate](./core-1-20-img/Weaviate-release-1-20_reranker_dark.png#gh-dark-mode-only)
...
![A conceptual figure of a hybrid score merger](./core-1-20-img/Weaviate-release-1-20_hybrid_merger_light.png#gh-light-mode-only)
![A conceptual figure of a hybrid score merger](./core-1-20-img/Weaviate-release-1-20_hybrid_merger_dark.png#gh-dark-mode-only)
...
![A conceptual figure of Weaviate performing a search](./core-1-20-img/Weaviate-release-1-20_search_light.png#gh-light-mode-only)
![A conceptual figure of Weaviate performing a search](./core-1-20-img/Weaviate-release-1-20_search_dark.png#gh-dark-mode-only)
...
import WhatNextBlog from '/_includes/what-next-blog.mdx'

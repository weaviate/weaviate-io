![Weaviate 1.21](./core-1-21-img/hero.png)
...
![New `ContainsAll` / `ContainsAny` filter operators](./core-1-21-img/contains-all-any.png)
...
![Activate / Deactivate tenants](./core-1-21-img/mt-inactive.png)
...
![New `text2vec-gpt4all` module](./core-1-21-img/text2vec-gpt4all.png)
...
![New `multi2vec-bind` module](./core-1-21-img/multi2vec-bind.png)
...
![Image of a car representing the top retrieved image from an audio search](./core-1-21-img/car.jpg)
...
![Image of a bird representing the top retrieved image from a video search](./core-1-21-img/bird.jpg)
...
![Performance improvements](./core-1-21-img/performance.png)

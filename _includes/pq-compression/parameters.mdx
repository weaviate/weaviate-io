...
| :-- | :-- | :-- | :-- |
| `enabled` | boolean | `false` | Enable PQ when `true`. <br/> The Python client v4 does not use the `enabled` parameter. To enable PQ with the v4 client, set a `quantizer` in the collection definition. |

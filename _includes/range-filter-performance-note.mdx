...
- Configure `indexRangeFilters` for properties that require range-based filtering. You can [set inverted index parameters](https://weaviate.io/developers/weaviate/manage-data/collections#set-inverted-index-parameters) when creating your collection. Learn more about [configuring the inverted index](https://weaviate.io/developers/weaviate/concepts/indexing#configure-the-inverted-index) to optimize filter performance for your specific use case.

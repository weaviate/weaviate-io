...
Items in a collection can have multiple named vectors. Each named vectors has its own vector index. These vector indexes can be configured independently.

...
1. If import slows down after 2M objects, consider setting the [`vectorCacheMaxObjects`](/docs/weaviate/architecture/vector-index-plugins.md#hnsw) in your schema. Also, see [this example](https://github.com/semi-technologies/semantic-search-through-wikipedia-with-weaviate/blob/d4711f2bdc75afd503ff70092c3c5303f9dd1b3b/step-2/import.py#L58-L59).

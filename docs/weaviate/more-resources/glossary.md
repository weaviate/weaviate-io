...
| **Schema** | In Weaviate, a schema is used to define the types of data you will be adding and querying. You can learn more about it [here](/docs/weaviate/tutorials/how-to-create-a-schema.md). |

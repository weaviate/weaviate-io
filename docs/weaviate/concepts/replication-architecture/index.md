...
Read the [Replication Usage page here](/docs/weaviate/configuration/replication.md). You can enable replication on class-level in the data schema of your Weaviate instance. During querying, you can specify the consistency level.

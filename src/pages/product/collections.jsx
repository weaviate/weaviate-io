...
export default function QueryPage() {
  const app = appData.find((app) => app.name === 'Collections');
                ...
                <div className={styles.appDetailContent}>
                  <div className={styles.tabBottomContent}>
                    <div>
                      ...
                      <p>
                        Use the tool to precisely tune a new collection. Specify
                        a vectorizer and an embedding model. Configure
                        collection properties for faster searches and more
                        accurate results.{' '}
                      </p>
                    </div>

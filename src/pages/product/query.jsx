                ...
                <div className={styles.appDetailHeader}>
                  ...
                  <div>
                    ...
                    <div className={styles.installButtons}>
                      ...
                      <Link to="https://docs.weaviate.io/cloud/tools/query-tool">
                  ...
                  <div className={styles.tabBottomContent}>
                    <div>
                      ...
                      <p>
                        ...
                        data using GraphQL, making it easier to interact with
                        data within your clusters.The Query tool enables the

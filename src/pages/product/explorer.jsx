                ...
                <div className={styles.appDetailContent}>
                  <div className={styles.tabBottomContent}>
                    <div>
                      ...
                      <p>
                        The Explorer tool in Weaviate Cloud enables developers
                        and non-technical users to search and validate object
                        data within a collection of a cluster, providing an

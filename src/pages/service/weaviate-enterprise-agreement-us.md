...
description: Commercial Terms of Service
...
2. **Weaviate**
   ...
   <br></br>
   3. Tools and Apps. Weaviate additionally offers tools, extensions, and applications that run on Weaviate-managed infrastructure (“Weaviate Tools and Apps”). Weaviate Tools and Apps consume WUs or are billed at the rates set forth in the Customer Order Form.
   <br></br>

...
* [Developers · Weaviate Documentation](https://weaviate.io/developers/weaviate/)
* [Modules · Weaviate Documentation](https://weaviate.io/developers/weaviate/modules/)
* [CLIP · Weaviate Documentation](https://weaviate.io/developers/weaviate/model-providers/transformers/embeddings-multimodal)
...
* [JavaScript/TypeScript · Weaviate Documentation](https://weaviate.io/developers/weaviate/client-libraries/typescript)
<!-- * [Weaviate CLI · Weaviate Documentation](https://weaviate.io/developers/weaviate/client-libraries/_cli.md) -->
...
**Expected outcome:** A new Weaviate module [code](https://github.com/weaviate/weaviate/tree/master/modules) and [documentation](https://weaviate.io/developers/weaviate/modules/).
...
**Project Description:** At the moment, Weaviate is able to store [datatypes](https://weaviate.io/developers/weaviate/config-refs/datatypes) like text and images. The goal of this project is to create a new datatype for Weaviate, like speech, videos or 3D mesh. You'll work in Go.
You'll be guided and supported by Etienne and Marcin who are Go-gurus, so you can learn along the way.
...
* [Go · Weaviate Documentation](https://weaviate.io/developers/weaviate/client-libraries/go)
* [Custom modules · Weaviate Documentation](https://weaviate.io/developers/weaviate/modules/custom-modules)
* [Modules · Weaviate Documentation](https://weaviate.io/developers/weaviate/modules/)
...
<!-- **Documentation:**
[Weaviate CLI · Weaviate Documentation](https://weaviate.io/developers/weaviate/client-libraries/cli) -->
...
**Documentation:**
[Weaviate schema · Weaviate Documentation](https://weaviate.io/developers/weaviate/api/rest#tag/schema)
<!-- [Weaviate CLI · Weaviate Documentation](https://weaviate.io/developers/weaviate/client-libraries/cli) -->

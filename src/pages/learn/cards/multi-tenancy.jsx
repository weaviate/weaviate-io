...
const CardPage = () => {
  const card = knowledge.all.find((c) => c.title === 'Multi Tenancy');
  ...
  const structuredData = {
    ...
    image: imageFullUrl,
    url: `${window.location.origin}/learn/cards/multi-tenancy`,
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:url"
          content={`${window.location.origin}/learn/cards/multi-tenancy`}
        />

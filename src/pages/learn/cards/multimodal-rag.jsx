...
const CardPage = () => {
  const card = knowledge.all.find((c) => c.title === 'Multimodal RAG');
  ...
  const structuredData = {
    ...
    image: imageFullUrl,
    url: `${window.location.origin}/learn/cards/multimodal-rag`,
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:url"
          content={`${window.location.origin}/learn/cards/multimodal-rag`}
        />

...
const CardPage = () => {
  ...
  const redirectUrl = `/learn/knowledgebase#card=graphbased-index`;
  ...
  const structuredData = {
    ...
    image: imageFullUrl,
    url: `${window.location.origin}/learn/cards/graphbased-index`,
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:url"
          content={`${window.location.origin}/learn/cards/graphbased-index`}
        />

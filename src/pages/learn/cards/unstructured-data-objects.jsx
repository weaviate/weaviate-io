...
const CardPage = () => {
  const card = knowledge.all.find(
    (c) => c.title === 'Unstructured Data Objects'
  );
  ...
  const structuredData = {
    ...
    image: imageFullUrl,
    url: `${window.location.origin}/learn/cards/unstructured-data-objects`,
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:url"
          content={`${window.location.origin}/learn/cards/unstructured-data-objects`}
        />

...
const CardPage = () => {
  const card = knowledge.all.find((c) => c.title === 'Fusion Algorithm');
  ...
  const structuredData = {
    ...
    image: imageFullUrl,
    url: `${window.location.origin}/learn/cards/fusion-algorithm`,
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:url"
          content={`${window.location.origin}/learn/cards/fusion-algorithm`}
        />

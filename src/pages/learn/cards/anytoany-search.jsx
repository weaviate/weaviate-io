...
const CardPage = () => {
  ...
  const redirectUrl = `/learn/knowledgebase#card=anytoany-search`;
  ...
  const structuredData = {
    ...
    image: imageFullUrl,
    url: `${window.location.origin}/learn/cards/anytoany-search`,
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:url"
          content={`${window.location.origin}/learn/cards/anytoany-search`}
        />

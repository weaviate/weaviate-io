...
const CardPage = () => {
  const card = knowledge.all.find((c) => c.title === 'Layered Navigation');
  ...
  const structuredData = {
    ...
    image: imageFullUrl,
    url: `${window.location.origin}/learn/cards/layered-navigation`,
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:url"
          content={`${window.location.origin}/learn/cards/layered-navigation`}
        />

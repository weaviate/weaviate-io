...
const CardPage = () => {
  const card = knowledge.all.find((c) => c.title === 'Vector-Based Index');
  ...
  const structuredData = {
    ...
    image: imageFullUrl,
    url: `${window.location.origin}/learn/cards/vectorbased-index`,
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:url"
          content={`${window.location.origin}/learn/cards/vectorbased-index`}
        />

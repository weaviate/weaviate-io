...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'Transformer Model');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Transformer Model - Weaviate Knowledge Cards',
    description:
      "A transformer model is a type of neural network architecture designed to handle sequential data, like text, for tasks such as translation and question-answering. It's efficient and scalable, using attention mechanisms to weigh the importance of different parts of the input data.",
    image: 'https://weaviate.io/img/cards/transformer-model.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/transformer-model',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Transformer Model - Weaviate Knowledge Cards"
          />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/transformer-model.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/transformer-model"
          />
          <meta
            property="og:description"
            content="A transformer model is a type of neural network architecture designed to handle sequential data, like text, for tasks such as translation and question-answering. It's efficient and scalable, using attention mechanisms to weigh the importance of different parts of the input data."
          />

...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'Semantic Chunking');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Semantic Chunking - Weaviate Knowledge Cards',
    description:
      'In this technique, the text is divided into meaningful units, such as sentences or paragraphs, which are then vectorized...',
    image: 'https://weaviate.io/img/cards/semantic-chunking.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/semantic-chunking',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Semantic Chunking - Weaviate Knowledge Cards"
          />
          <meta name="robots" content="index, follow" />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/semantic-chunking.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/semantic-chunking"
          />
          <meta
            property="og:description"
            content="In this technique, the text is divided into meaningful units, such as sentences or paragraphs, which are then vectorized..."
          />

...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'Data Transformation');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Data Transformation - Weaviate Knowledge Cards',
    description:
      'Data Transformation involves converting all processed content into a standardized schema regardless of original file type.',
    image: 'https://weaviate.io/img/cards/data-transformation.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/data-transformation',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Data Transformation - Weaviate Knowledge Cards"
          />
          <meta name="robots" content="index, follow" />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/data-transformation.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/data-transformation"
          />
          <meta
            property="og:description"
            content="Data Transformation involves converting all processed content into a standardized schema regardless of original file type."
          />

...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'Multi-vector Embeddings');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Multi-vector Embeddings - Weaviate Knowledge Cards',
    description:
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Multi-vector Embeddings - Weaviate Knowledge Cards"
          />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/multi-vector-embeddings.jpg"
          />
          ...
          <meta
            ...
            content="Usage of multiple vectors instead of one pooled vector  to represent e.g., token-wise embeddings (e.g., ColBERT). Allows for more detailed representation of complex texts."
          />

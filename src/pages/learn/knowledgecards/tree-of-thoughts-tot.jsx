...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'Tree of Thoughts (ToT)');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Tree of Thoughts (ToT) - Weaviate Knowledge Cards',
    description:
      'Tree of Thoughts prompting builds on CoT by instructing the model to evaluate its responses at each step in the problem-solving process or even generate several different solutions to a problem.',
    image: 'https://weaviate.io/img/cards/tree-of-thoughts.jpg',
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Tree of Thoughts (ToT) - Weaviate Knowledge Cards"
          />
          <meta name="robots" content="index, follow" />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/tree-of-thoughts.jpg"
          />
          ...
          <meta
            ...
            content="Tree of Thoughts prompting builds on CoT by instructing the model to evaluate its responses at each step in the problem-solving process or even generate several different solutions to a problem."
          />

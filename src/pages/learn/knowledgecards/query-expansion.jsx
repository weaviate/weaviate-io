...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'Query Expansion');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Query Expansion - Weaviate Knowledge Cards',
    description:
      'This is an optional parameter in hybrid search queries that determines the weighting of each search algorithm during the re-ranking process...',
    image: 'https://weaviate.io/img/cards/query-expansion.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/query-expansion',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Query Expansion - Weaviate Knowledge Cards"
          />
          <meta name="robots" content="index, follow" />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/query-expansion.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/query-expansion"
          />
          <meta
            property="og:description"
            content="This is an optional parameter in hybrid search queries that determines the weighting of each search algorithm during the re-ranking process. An alpha value of 0 gives full weight to the sparse vector (BM25), 1 gives full weight to the dense vector, and 0.5 gives equal weight to both."
          />

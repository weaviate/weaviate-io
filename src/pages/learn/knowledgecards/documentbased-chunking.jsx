...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'Document-Based Chunking');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Document-Based Chunking - Weaviate Knowledge Cards',
    description:
      "This technique creates chunks based on the natural divisions within the document, such as headings or sections. It's very effective for structured data like HTML...",
    image: 'https://weaviate.io/img/cards/documentbased-chunking.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/documentbased-chunking',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/documentbased-chunking.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/documentbased-chunking"
          />
          <meta
            property="og:description"
            content="This technique creates chunks based on the natural divisions within the document, such as headings or sections. It\'s very effective for structured data like HTML..."
          />

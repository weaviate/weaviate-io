...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'Metadata Filtering');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Metadata Filtering - Weaviate Knowledge Cards',
    description:
      'Metadata is contextual information attached to documents in vector databases, including timestamps, categories, and source references.',
    image: 'https://weaviate.io/img/cards/metadata-filtering.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/metadata-filtering',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Metadata Filtering - Weaviate Knowledge Cards"
          />
          <meta name="robots" content="index, follow" />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/metadata-filtering.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/metadata-filtering"
          />
          <meta
            property="og:description"
            content="Metadata is contextual information attached to documents in vector databases, including timestamps, categories, and source references."
          />

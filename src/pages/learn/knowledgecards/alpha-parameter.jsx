...
const KnowledgeBasePage = () => {
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Alpha Parameter - Weaviate Knowledge Cards',
    description:
    ...
    image: 'https://weaviate.io/img/cards/alpha-parameter.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/alpha-parameter',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Alpha Parameter - Weaviate Knowledge Cards"
          />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/alpha-parameter.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/alpha-parameter"
          />
          <meta

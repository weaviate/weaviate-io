...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find(
    (c) => c.title === 'Data Extraction and Parsing'
  );
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Data Extraction and Parsing - Weaviate Knowledge Cards',
    description:
      'Data extraction and parsing convert raw data into an LLM-ready format. Text-based files retain structure, while OCR handles scanned docs. Advanced multimodal models may replace OCR by embedding images directly.',
    image: 'https://weaviate.io/img/cards/data-extraction-and-parsing.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/data-extraction-and-parsing',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Data Extraction and Parsing - Weaviate Knowledge Cards"
          />
          <meta name="robots" content="index, follow" />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/data-extraction-and-parsing.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/data-extraction-and-parsing"
          />
          <meta
            property="og:description"
            content="Data extraction and parsing convert raw data into an LLM-ready format. Text-based files retain structure, while OCR handles scanned docs. Advanced multimodal models may replace OCR by embedding images directly."
          />

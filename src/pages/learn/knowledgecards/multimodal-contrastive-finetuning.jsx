...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find(
    (c) => c.title === 'Multimodal Contrastive Finetuning'
  );
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Multimodal Contrastive Finetuning - Weaviate Knowledge Cards',
    description:
    ...
    image:
      'https://weaviate.io/img/cards/multimodal-contrastive-finetuning.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/multimodal-contrastive-finetuning',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/multimodal-contrastive-finetuning.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/multimodal-contrastive-finetuning"
          />
          <meta

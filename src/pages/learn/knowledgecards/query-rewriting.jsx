...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'Query Rewriting');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Query Rewriting - Weaviate Knowledge Cards',
    description:
      'Query Rewriting involves reformulating the original user query to make it more suitable for retrieval...',
    image: 'https://weaviate.io/img/cards/query-rewriting.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/query-rewriting',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Query Rewriting - Weaviate Knowledge Cards"
          />
          <meta name="robots" content="index, follow" />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/query-rewriting.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/query-rewriting"
          />
          <meta
            property="og:description"
            content="Query Rewriting involves reformulating the original user query to make it more suitable for retrieval."
          />

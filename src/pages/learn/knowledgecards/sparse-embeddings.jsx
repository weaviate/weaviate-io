...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'Sparse Embeddings');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Sparse Embeddings - Weaviate Knowledge Cards',
    description:
      'Sparse vectors are often high-dimensional with many zero values. They are generated from algorithms like BM25 and SPLADE...',
    image: 'https://weaviate.io/img/cards/sparse-embeddings.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/sparse-embeddings',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Sparse Embeddings - Weaviate Knowledge Cards"
          />
          <meta name="robots" content="index, follow" />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/sparse-embeddings.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/sparse-embeddings"
          />
          <meta
            property="og:description"
            content="Sparse vectors are often high-dimensional with many zero values. They are generated from algorithms like BM25 and SPLADE..."
          />

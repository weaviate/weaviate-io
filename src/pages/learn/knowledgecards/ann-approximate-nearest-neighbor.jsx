...
const KnowledgeBasePage = () => {
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'ANN - Approximate Nearest Neighbor - Weaviate Knowledge Cards',
    description:
      'ANN algorithms calculate the approximate nearest neighbors to a query, as opposed to kNN algorithms, which calculate the true nearest neighbors...',
    image: 'https://weaviate.io/img/cards/ann-approximate-nearest-neighbor.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/ann-approximate-nearest-neighbor',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/ann-approximate-nearest-neighbor.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/ann-approximate-nearest-neighbor"
          />
          <meta
            property="og:description"
            content="ANN algorithms calculate the approximate nearest neighbors to a query, as opposed to kNN algorithms, which calculate the true nearest neighbors. ANN algorithms enable the quick and efficient identification of the closest data points at scale. This makes ANN suitable for big data where speed matters more than perfect accuracy."
          />

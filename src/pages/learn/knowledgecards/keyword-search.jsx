...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'Keyword Search');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Keyword Search - Weaviate Knowledge Cards',
    description:
    ...
    image: 'https://weaviate.io/img/cards/keyword-search.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/keyword-search',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Keyword Search - Weaviate Knowledge Cards"
          />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/keyword-search.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/keyword-search"
          />
          <meta
            property="og:description"
            content="Keyword search finds objects with an exact match between the terms in the query and in the documents. Weaviate uses the BM25/F function to calculate the relevancy of a document to a query, which uses both the term frequency and inverse document frequency."
          />

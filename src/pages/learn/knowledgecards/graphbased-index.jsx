...
const KnowledgeBasePage = () => {
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Graph-Based Index - Weaviate Knowledge Cards',
    description:
      'HNSW is a graph-based indexing technique, meaning that it organizes the data points in a graph structure rather than traditional tree-based or hash-based structures...',
    image: 'https://weaviate.io/img/cards/graph-based-index.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/graphbased-index',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Graph-Based Index - Weaviate Knowledge Cards"
          />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/graph-based-index.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/graphbased-index"
          />
          <meta
            property="og:description"
            content="HNSW is a graph-based indexing technique, meaning that it organizes the data points in a graph structure rather than traditional tree-based or hash-based structures. This graph-based approach is key to its performance in high-dimensional vector space searches."
          />

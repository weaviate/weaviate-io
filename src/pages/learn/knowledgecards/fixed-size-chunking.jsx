...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'Fixed Size Chunking');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Fixed Size Chunking - Weaviate Knowledge Cards',
    description:
    ...
    image: 'https://weaviate.io/img/cards/fixed-size-chunking.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/fixed-size-chunking',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Fixed Size Chunking - Weaviate Knowledge Cards"
          />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/fixed-size-chunking.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/fixed-size-chunking"
          />
          <meta
            property="og:description"
            content="This technique splits the text into chunks of a fixed size, without considering natural breaks or the structure of the content..."
          />

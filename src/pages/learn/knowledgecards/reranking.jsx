...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'Reranking');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Reranking - Weaviate Knowledge Cards',
    description:
    ...
    image: 'https://weaviate.io/img/cards/reranking.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/reranking',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Reranking - Weaviate Knowledge Cards"
          />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/reranking.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/reranking"
          />
          <meta
            property="og:description"
            content="Re-ranking is adjusting the scores of search results after initial retrieval. It usually uses a machine learning model to reassess the relevance between the query and each result, refining the scores to improve accuracy and relevance for the user or an LLM's task. It's like a second quality check."
          />

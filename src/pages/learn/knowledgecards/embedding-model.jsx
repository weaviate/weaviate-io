...
const KnowledgeBasePage = () => {
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Embedding model - Weaviate Knowledge Cards',
    description:
      'An embedding model, or vectorizer, transforms text or images into vector embeddings, capturing semantic meaning through statistical analysis, converting conceptual significance into numerical representations.',
    image: 'https://weaviate.io/img/cards/embedding-model.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/embedding-model',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Embedding model - Weaviate Knowledge Cards"
          />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/embedding-model.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/embedding-model"
          />
          <meta
            property="og:description"
            content="An embedding model, or vectorizer, transforms text or images into vector embeddings, capturing semantic meaning through statistical analysis, converting conceptual significance into numerical representations."
          />

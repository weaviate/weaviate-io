...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find(
    (c) => c.title === 'Embedding Model Fine-Tuning'
  );
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Embedding Modal Fine-tuning -  Weaviate Knowledge Cards',
    description:
      'Embedding model fine-tuning can significantly improve the quality of embeddings, subsequently improving performance on downstream tasks like RAG...',
    image: 'https://weaviate.io/img/cards/embedding-modal-fine-tuning.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/embedding-modal-fine-tuning',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Embedding Modal Fine-tuning -  Weaviate Knowledge Cards"
          />
          <meta name="robots" content="index, follow" />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/embedding-modal-fine-tuning.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/embedding-modal-fine-tuning"
          />
          <meta
            property="og:description"
            content="Embedding model fine-tuning can significantly improve the quality of embeddings, subsequently improving performance on downstream tasks like RAG."
          />

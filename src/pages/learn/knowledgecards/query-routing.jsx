...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'Query Routing');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Query Routing - Weaviate Knowledge Cards',
    description:
      'Query routing directs queries to specific pipelines based on content and intent, optimizing RAG systems.',
    image: 'https://weaviate.io/img/cards/query-routing.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/query-routing',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Query Routing - Weaviate Knowledge Cards"
          />
          <meta name="robots" content="index, follow" />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/query-routing.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/query-routing"
          />
          <meta
            property="og:description"
            content="Query routing directs queries to specific pipelines based on content and intent, optimizing RAG systems."
          />

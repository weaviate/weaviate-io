...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'Binary Embeddings');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Binary Embeddings - Weaviate Knowledge Cards',
    description:
      'Extreme quantization, reducing vector components to binary (0 or 1) values. Drastically reduces memory use.',
    image: 'https://weaviate.io/img/cards/binary-embeddings.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/binary-embeddings',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Binary Embeddings - Weaviate Knowledge Cards"
          />
          <meta name="robots" content="index, follow" />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/binary-embeddings.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/binary-embeddings"
          />
          <meta
            property="og:description"
            content="Extreme quantization, reducing vector components to binary (0 or 1) values. Drastically reduces memory use."
          />

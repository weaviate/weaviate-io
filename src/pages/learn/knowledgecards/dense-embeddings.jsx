...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'Dense Embeddings');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Dense Embeddings - Weaviate Knowledge Cards',
    description:
    ...
    image: 'https://weaviate.io/img/cards/dense-embeddings.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/dense-embeddings',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/dense-embeddings.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/dense-embeddings"
          />
          <meta
            property="og:description"
            content="Dense embeddings contain mostly non-zero values and are generated from machine learning models like Transformers. These vectors capture the semantic meaning of text and are used in semantic search."
          />

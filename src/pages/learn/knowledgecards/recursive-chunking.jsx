...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'Recursive Chunking');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Recursive Chunking - Weaviate Knowledge Cards',
    description:
    ...
    image: 'https://weaviate.io/img/cards/recursive-chunking.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/recursive-chunking',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Recursive Chunking - Weaviate Knowledge Cards"
          />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/recursive-chunking.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/recursive-chunking"
          />
          <meta
            property="og:description"
            content="Text is initially split using a primary separator, like paragraphs. If the resulting chunks are too large, secondary separators..."
          />

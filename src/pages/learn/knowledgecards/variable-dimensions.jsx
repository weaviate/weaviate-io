...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'Variable Dimensions');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Variable Dimensions- Weaviate Knowledge Cards',
    description:
      'Flexible embedding sizes, like Matryoshka embeddings. Encode information hierarchically, allowing adaptation...',
    image: 'https://weaviate.io/img/cards/variable-dimensions.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/variable-dimensions',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Variable Dimensions - Weaviate Knowledge Cards"
          />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/variable-dimensions.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/variable-dimensions"
          />
          <meta
            property="og:description"
            content="Flexible embedding sizes, like Matryoshka embeddings. Encode information hierarchically, allowing adaptation..."
          />

...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'LLM-Based Chunking');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'LLM-Based Chunking - Weaviate Knowledge Cards',
    description:
    ...
    image: 'https://weaviate.io/img/cards/llmbased-chunking.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/llmbased-chunking',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="LLM-Based Chunking - Weaviate Knowledge Cards"
          />
          <meta name="robots" content="index, follow" />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/llmbased-chunking.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/llmbased-chunking"
          />
          <meta
            property="og:description"
            content="This advanced technique uses a Language Model (LLM) to generate chunks. The LLM processes the text and generates semantically isolated sentences..."
          />

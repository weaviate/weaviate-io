...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'Data Pre-Processing');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Data Pre-Processing - Weaviate Knowledge Cards',
    description:
      'Data pre-processing thoughtfully transforms your raw data into a structured format suitable for LLMs.',
    image: 'https://weaviate.io/img/cards/data-pre-processing.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/data-pre-processing',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Data Pre-Processing - Weaviate Knowledge Cards"
          />
          <meta name="robots" content="index, follow" />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/data-pre-processing.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/data-pre-processing"
          />
          <meta
            property="og:description"
            content="Data pre-processing thoughtfully transforms your raw data into a structured format suitable for LLMs."
          />

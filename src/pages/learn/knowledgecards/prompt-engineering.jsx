...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'Prompt Engineering');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Prompt Engineering -  Weaviate Knowledge Cards',
    description:
      'Distance thresholding adds a quality check by setting a maximum allowed distance between vectors...',
    image: 'https://weaviate.io/img/cards/prompt-engineering.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/prompt-engineering',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Prompt Engineering -  Weaviate Knowledge Cards"
          />
          <meta name="robots" content="index, follow" />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/prompt-engineering.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/prompt-engineering"
          />
          <meta

...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'Data Cleansing');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Data Cleansing - Weaviate Knowledge Cards',
    description:
      'Data cleaning and noise reduction involves removing irrelevant information (such as headers, footers, or boilerplate text), correcting inconsistencies, and handling missing values.',
    image: 'https://weaviate.io/img/cards/data-cleansing.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/data-cleansing',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Data Cleansing - Weaviate Knowledge Cards"
          />
          <meta name="robots" content="index, follow" />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/data-cleansing.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/data-cleansing"
          />
          <meta
            property="og:description"
            content="Data cleaning and noise reduction involves removing irrelevant information (such as headers, footers, or boilerplate text), correcting inconsistencies, and handling missing values."
          />

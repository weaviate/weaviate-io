...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'Embeddings Model');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Embeddings Model - Weaviate Knowledge Cards',
    description:
      'An algorithm or model that transforms objects (like words) into vector embeddings. This enables capturing contextual and semantic information.',
    image: 'https://weaviate.io/img/cards/embeddings-model.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/embeddings-model',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Embeddings Model - Weaviate Knowledge Cards"
          />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/embeddings-model.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/embeddings-model"
          />
          <meta
            property="og:description"
            content="An algorithm or model that transforms objects (like words) into vector embeddings. This enables capturing contextual and semantic information."
          />

...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'Hybrid Search');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Hybrid Search - Weaviate Knowledge Cards',
    description:
      'Hybrid search in Weaviate combines keyword (BM25) and vector search to leverage both exact term matching and semantic context. It uses rankedFusion or relativeScoreFusion algorithms to merge results, providing a balance between precision and semantic understanding.',
    image: 'https://weaviate.io/img/cards/hybrid-search.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/hybrid-search',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Hybrid Search - Weaviate Knowledge Cards"
          />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/hybrid-search.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/hybrid-search"
          />
          <meta
            property="og:description"
            content="Hybrid search in Weaviate combines keyword (BM25) and vector search to leverage both exact term matching and semantic context. It uses rankedFusion or relativeScoreFusion algorithms to merge results, providing a balance between precision and semantic understanding."
          />

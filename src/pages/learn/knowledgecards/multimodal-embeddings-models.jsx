...
const KnowledgeBasePage = () => {
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Multimodal Embeddings Models - Weaviate Knowledge Cards',
    description:
    ...
    image: 'https://weaviate.io/img/cards/multimodal-embeddings-models.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/multimodal-embeddings-models',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Multimodal Embeddings Models - Weaviate Knowledge Cards"
          />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/multimodal-embeddings-models.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/multimodal-embeddings-models"
          />
          <meta

...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'Quantized Embeddings');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Quantized Embeddings - Weaviate Knowledge Cards',
    description:
      'Compressed dense vectors using lower-precision data types (e.g., float32 to int8). Reduces memory usage and speeds up search...',
    image: 'https://weaviate.io/img/cards/quantized-embeddings.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/quantized-embeddings',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Quantized Embeddings - Weaviate Knowledge Cards"
          />
          <meta name="robots" content="index, follow" />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/quantized-embeddings.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/quantized-embeddings"
          />
          <meta
            property="og:description"
            content="Compressed dense vectors using lower-precision data types (e.g., float32 to int8). Reduces memory usage and speeds up search..."
          />

...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'Autocut');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Autocut - Weaviate Knowledge Cards',
    description:
      'Autocut is a method to filter out irrelevant information retrieved from the database...',
    image: 'https://weaviate.io/img/cards/autocut.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/autocut',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Autocut - Weaviate Knowledge Cards"
          />
          <meta name="robots" content="index, follow" />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/autocut.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/autocut"
          />
          <meta
            property="og:description"
            content="Autocut is a method to filter out irrelevant information retrieved from the database."
          />

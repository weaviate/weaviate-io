...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find(
    (c) => c.title === 'Reasoning and Acting (ReAct)'
  );
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Reasoning and Acting (ReAct) - Weaviate Knowledge Cards',
    description:
      'ReAct prompting combines CoT with agents, creating a system where the model can generate thoughts and delegate actions to agents that interact with external data sources.',
    image: 'https://weaviate.io/img/cards/reasoning-and-acting.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/reasoning-and-acting-react',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Reasoning and Acting (ReAct) - Weaviate Knowledge Cards"
          />
          <meta name="robots" content="index, follow" />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/reasoning-and-acting.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/reasoning-and-acting-react"
          />
          <meta

...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'HNSW');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'HNSW - Weaviate Knowledge Cards',
    description:
    ...
    image: 'https://weaviate.io/img/cards/hnsw.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/hnsw',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/hnsw.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/hnsw"
          />
          <meta
            property="og:description"
            content="HNSW (Hierarchical Navigable Small World) is a graph-based vector indexing method for efficient approximate nearest neighbor searches. It organizes data in a multi-layer structure, enabling fast and accurate queries by navigating through layers from coarse to fine granularity."
          />
          ...
          <meta
            name="twitter:title"
            content="HNSW - Weaviate Knowledge Cards"
          />
          <meta

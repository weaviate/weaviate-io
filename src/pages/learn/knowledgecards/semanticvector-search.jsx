...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'Semantic/Vector Search');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Semantic/Vector Search - Weaviate Knowledge Cards',
    description:
      'Semantic search, also known as vector search, uses machine learning to grasp text context, not just keywords. It converts text to numerical vectors, finding matches based on conceptual similarity for accurate, relevant search results.',
    image: 'https://weaviate.io/img/cards/semantic-vector-search.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/semanticvector-search',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Semantic/Vector Search - Weaviate Knowledge Cards"
          />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/semantic-vector-search.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/semanticvector-search"
          />
          <meta
            property="og:description"
            content="Semantic search, also known as vector search, uses machine learning to grasp text context, not just keywords. It converts text to numerical vectors, finding matches based on conceptual similarity for accurate, relevant search results."
          />

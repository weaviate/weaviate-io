...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'Cross Modal Reasoning');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Cross Modal Reasoning - Weaviate Knowledge Cards',
    description:
    ...
    image: 'https://weaviate.io/img/cards/cross-modal-reasoning.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/cross-modal-reasoning',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Cross Modal Reasoning - Weaviate Knowledge Cards"
          />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/cross-modal-reasoning.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/cross-modal-reasoning"
          />
          <meta
            property="og:description"
            content="Cross-modal reasoning refers to the ability to make connections by integrating information from different modalities or sources including text, images, audio and video. It involves leveraging knowledge from one modality to understand or reason about data from another modality."
          />

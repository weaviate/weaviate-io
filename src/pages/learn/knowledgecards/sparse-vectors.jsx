...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'Sparse Vectors');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Sparse Vectors - Weaviate Knowledge Cards',
    description:
      'Sparse embeddings are generated from algorithms like BM25 and SPLADE...',
    image: 'https://weaviate.io/img/cards/sparse-vectors.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/sparse-vectors',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Sparse Vectors - Weaviate Knowledge Cards"
          />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/sparse-vectors.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/sparse-vectors"
          />
          <meta
            property="og:description"
            content="Sparse vectors are often high-dimensional with many zeros. Sparse embeddings are generated from algorithms like BM25 and SPLADE. These algorithms are used in keyword-based search to represent text documents."
          />

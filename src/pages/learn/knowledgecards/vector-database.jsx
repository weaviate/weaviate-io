...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'Vector Database');
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Vector Database - Weaviate Knowledge Cards"
          />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/vector-database.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/vector-database"
          />
          <meta

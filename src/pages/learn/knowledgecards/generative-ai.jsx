...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'Generative AI');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Generative AI - Weaviate Knowledge Cards',
    description:
      'Generative AI is a type of artificial intelligence powered by generative machine learning models that produces new and original outputs like images, text, audio, or video based off user provided prompts or input.',
    image: 'https://weaviate.io/img/cards/generative-ai.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/generative-ai',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Generative AI - Weaviate Knowledge Cards"
          />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/generative-ai.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/generative-ai"
          />
          <meta
            property="og:description"
            content="Generative AI is a type of artificial intelligence powered by generative machine learning models that produces new and original outputs like images, text, audio, or video based off user provided prompts or input."
          />

...
const KnowledgeBasePage = () => {
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Vector-Based Index - Weaviate Knowledge Cards',
    description:
      'A vector index is a type of data structure for efficiently storing high-dimensional vector data generated by machine learning models. Its main purpose is facilitating quick and accurate similarity searches, using algorithms like trees or hashing to reduce complexity in high-dimensional spaces.',
    image: 'https://weaviate.io/img/cards/vector-based-index.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/vectorbased-index',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Vector-Based Index - Weaviate Knowledge Cards"
          />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/vector-based-index.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/vectorbased-index"
          />
          <meta
            property="og:description"
            content="A vector index is a type of data structure for efficiently storing high-dimensional vector data generated by machine learning models. Its main purpose is facilitating quick and accurate similarity searches, using algorithms like trees or hashing to reduce complexity in high-dimensional spaces."
          />

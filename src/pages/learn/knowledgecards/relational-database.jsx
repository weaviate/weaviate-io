...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'Relational Database');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Relational Database - Weaviate Knowledge Cards',
    description:
      'A relational database organizes data into tables linked by relationships...',
    image: 'https://weaviate.io/img/cards/relational-database.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/relational-database',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Relational Database - Weaviate Knowledge Cards"
          />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/relational-database.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/relational-database"
          />
          <meta
            property="og:description"
            content="A relational database organizes data into tables linked by relationships, enabling complex queries like finding students with both cats and dogs. It uses SQL for structured, precise data management, optimizing operations like filtering and joining for efficient data retrieval."
          />

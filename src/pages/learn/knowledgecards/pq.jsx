    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          {/* Open Graph */}
          <meta property="og:title" content="PQ - Weaviate Knowledge Cards" />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/pq.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/pq"
          />
          <meta
            property="og:description"
            content="Product quantization (PQ) is a compression technique for vectors, reducing memory usage by up to 90%. It's a lossy algorithm, meaning it trades some accuracy for significant memory savings. However, Weaviate employs a rescoring technique to reduce the loss of recall."
          />
          ...
          <meta name="twitter:title" content="PQ - Weaviate Knowledge Cards" />
          <meta

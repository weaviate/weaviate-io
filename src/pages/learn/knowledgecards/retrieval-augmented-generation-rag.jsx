...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find(
    (c) => c.title === 'Retrieval Augmented Generation (RAG)'
  );
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Retrieval Augmented Generation (RAG) - Weaviate Knowledge Cards',
    description:
    ...
    image: 'https://weaviate.io/img/cards/retrieval-augmented-generation.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/retrieval-augmented-generation-rag',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Retrieval Augmented Generation (RAG) - Weaviate Knowledge Cards"
          />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/retrieval-augmented-generation.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/retrieval-augmented-generation-rag"
          />
          <meta
            property="og:description"
            content="Retrieval Augmented Generation (RAG) is the process of contextualising prompts for large language models (LLMs) by leveraging available data in a store allowing an LLMs to ingest relevant information that guides their predictions."
          />

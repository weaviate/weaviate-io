...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'Context Compression');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Context Compression -  Weaviate Knowledge Cards',
    description:
      'Context compression refines RAG retrieval by filtering out irrelevant or redundant data, reducing token usage and costs...',
    image: 'https://weaviate.io/img/cards/context-compression.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/context-compression',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Context Compression -  Weaviate Knowledge Cards"
          />
          <meta name="robots" content="index, follow" />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/context-compression.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/context-compression"
          />
          <meta
            property="og:description"
            content="Context compression refines RAG retrieval by filtering out irrelevant or redundant data, reducing token usage and costs."
          />

...
const KnowledgeBasePage = () => {
  ...
  const card = knowledge.all.find((c) => c.title === 'Distance Thresholding');
  ...
  const structuredData = {
    ...
    '@type': 'Article',
    headline: 'Distance Thresholding - Weaviate Knowledge Cards',
    description:
      'Distance thresholding adds a quality check by setting a maximum allowed distance between vectors.',
    image: 'https://weaviate.io/img/cards/distance-thresholding.jpg',
    url: 'https://weaviate.io/learn/knowledgecards/distance-thresholding',
  };
    ...
    <div className="custom-page noBG">
      <Layout>
        <Head>
          ...
          <meta
            property="og:title"
            content="Distance Thresholding - Weaviate Knowledge Cards"
          />
          <meta name="robots" content="index, follow" />
          <meta property="og:type" content="article" />
          <meta
            property="og:image"
            content="https://weaviate.io/img/cards/distance-thresholding.jpg"
          />
          <meta property="og:image:alt" content="Knowledge card image" />
          <meta
            property="og:url"
            content="https://weaviate.io/learn/knowledgecards/distance-thresholding"
          />
          <meta
            property="og:description"
            content="Distance thresholding adds a quality check by setting a maximum allowed distance between vectors."
          />

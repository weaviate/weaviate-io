...
import { RangeMark } from "src/components/Elements/Form/RangeInput/RangeMark/RangeMark"
...
export const RangeInput = (props: IRangeInputProps) => {
  ...
  const onMouseDown: MouseEventHandler<HTMLInputElement> = () => updateMouseDown(true)
  const onMouseUp: MouseEventHandler<HTMLInputElement> = () => updateMouseDown(false)

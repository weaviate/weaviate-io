      ...
      <div className="container">
        <div className={styles.grid}>
          <div className={styles.box}>
            ...
            <h1>Automatically improve the quality of data</h1>
            <p>
              Better data means better outcomes. Use content generated by Large
              Language Models (LLMs) to enrich your dataset. Spend less time on
              tedious, manual data cleaning.
            </p>

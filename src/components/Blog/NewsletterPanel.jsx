  ...
  return (
    ...
    >
      <div className="tw-px-[34px] tw-py-[30px]">
        ...
        <div className="tw-h-[53px] tw-max-w-[380px] tw-overflow-hidden tw-rounded-lg tw-border-[0.5px] tw-border-solid tw-border-[#6E6B91] tw-bg-[#080a0e]">
          <iframe
        ...
        <div className="tw-flex tw-flex-wrap tw-gap-3 tw-mt-[-11px]">
          {socialLinks.map(([label, href, image]) => (
            <a
              key={label}
              href={href}
              className="tw-inline-flex tw-h-[38px] tw-w-[38px] tw-items-center tw-justify-center tw-rounded-lg tw-border-[0.5px] tw-border-solid tw-border-[#6E6B91] tw-bg-[#0b0e15] tw-text-[#d0d8ea] hover:tw-border-[#63e689]"
              aria-label={label}

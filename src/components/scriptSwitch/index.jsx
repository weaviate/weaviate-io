...
const CustomScriptLoader = () => {
  useEffect(() => {
    ...
    const getScriptForPath = (pathname) => {
      const scriptsMap = {
        "/developers/":
          "https://pixel.weaviate.cloud/a.png?x-pxid=2758e82f-6546-4356-a8bd-5b5c16368efb",
        "/pricing":
          "https://pixel.weaviate.cloud/a.png?x-pxid=5c79460c-47af-4477-a1d9-3624dcce35d3",
      };

      const defaultScript =
        "https://pixel.weaviate.cloud/a.png?x-pxid=a41b0758-a3a9-4874-a880-8b5d5a363d40";

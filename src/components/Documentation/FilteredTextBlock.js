...
const DOC_SYSTEMS = {
    py: {
      baseUrl: 'https://weaviate-python-client.readthedocs.io/en/stable/weaviate.html',
      constructUrl: (baseUrl, ref) => `${baseUrl}#weaviate.${ref}`,
      icon: '/img/site/logo-py.svg'
    },
    pyv3: {
      baseUrl: 'https://weaviate-python-client.readthedocs.io/en/v3.26.2/weaviate.html',
      constructUrl: (baseUrl, ref) => `${baseUrl}#weaviate.${ref}`,
      icon: '/img/site/logo-py.svg'
    },
    ts: {
    ...
    go: {
      baseUrl: 'https://pkg.go.dev/github.com/weaviate/weaviate-go-client/v4/weaviate',
      constructUrl: (baseUrl, ref) => `${baseUrl}#${ref}`,
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                    ...
                    {language === 'pyv3' && (
                        <a
                            ...
                            style={{ ...badgeStyles.badge, ...badgeStyles.deprecated }}
                        >
                            <svg height="16" width="16" aria-hidden="true" viewBox="0 0 16 16" fill="currentColor" style={{ verticalAlign: 'middle' }}>
                                <path d="M8.982 1.566a1.13 1.13 0 0 0-1.96 0L.165 13.233c-.457.778.091 1.767.98 1.767h13.713c.889 0 1.438-.99.98-1.767L8.982 1.566zM8 5c.535 0 .954.462.9.995l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 5.995A.905.905 0 0 1 8 5zm.002 6a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>
                            </svg>
                            <span style={{ verticalAlign: 'middle' }}>&nbsp;&nbsp;Deprecated (v3)</span>
                        </a>
                    )}

        ...
        <div className={styles.diagramBox}>
          ...
          <div className={styles.content}>
            <div className={styles.leftContent}>
              <div className={styles.featureItem}>
                ...
                <p>
                  Get started in minutes — just bring your data. Weaviate
                  manages all infrastructure, configuration, and upgrades, so
              ...
              <div className={styles.featureItem}>
                ...
                <p>
                  ...
                  cloud-native AI services such as the Embedding Service and
                  Query Agent.
                </p>
              </div>
            </div>
          ...
          <div className={styles.bottomContent}>
            <h2 className={styles.getStarted}>
              Ready to get started? Choose your <Link to="/pricing">plan</Link>.
            </h2>

            <p>
              Visit our <Link to="/pricing">pricing page</Link> for details and

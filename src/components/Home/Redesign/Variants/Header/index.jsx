...
export default function HomepageHeaderV2() {
  return (
    <>
          ...
          <div className="container">
            <div className={styles.grid}>
              <div className={styles.box}>
                <h1>
                  Revolutionizing Software <br></br>with AI-native Databases
                </h1>
                <h2>
                  Unlock the full potential of intuitive AI applications.
                  Experience minimal data hallucination, zero vendor lock-in,
                  and robust security with the open-source vector database that
                  developers adore.
                </h2>
              </div>

      ...
      <div className="container">
        <div className={styles.grid}>
          <div className={styles.box}>
            ...
            <h1>Build secure, explainable AI applications</h1>
            <p>
              Reduce hallucination and make generative AI applications more
              reliable. Use proprietary or domain specific data to improve
              accuracy, without compromising data privacy.
            </p>

    ...
    <div className={styles.resourceBg}>
      <div className="container">
        ...
        <div className={styles.latestModule}>
          ...
          <Link to="https://aws.amazon.com/marketplace/pp/prodview-cicacyv63r43i?sr=0-1&ref_=beagle&applicationId=AWSMPContessa&utm_source=website&utm_medium=button&utm_campaign=AWSMarketplace">
            <div className={styles.latestBox}>

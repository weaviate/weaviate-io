        ...
        <div className={styles.box}>
          <div className={`${styles.card} ${styles.bigCard}`}>
            ...
            <div className={styles.contentDiv}>
              <div className={`${styles.textCardContent} ${styles.bigText}`}>
                <p>
                  A language-learning app built using Weaviate’s vector database
                  and Confluent Cloud, a fully managed streaming data service
                  based on Apache Kafka. See how <strong>real-time data</strong>{' '}
                  and <strong>vector embeddings</strong> enable personalized
                  learning by continuously adapting to user performance.
                </p>
                <div className={styles.bottomContainer}>
                  <Link
                    to="https://weaviate.io/blog/wealingo-demo"
                    className={styles.cardButton}
                  >
                    {' '}
                    <span className={styles.blog}></span> Blogpost
                  ...
                  <Link
                    to="https://github.com/weaviate/wealingo-demo"
                    className={`${styles.gitButton} ${styles.cardButton} `}
                  >
                    {' '}
                    <span className={styles.git}></span> GitHub
          ...
          <div className={`${styles.imageCard} ${styles.movie}`}>
            ...
            >
              <source
                src="/img/site/Wealingo_Video.mp4"
                poster="img/site/screenshot-wealingo.png"
                type="video/mp4"
              />

              <source
                src="/img/site/Wealingo_Video.mov"
                poster="img/site/screenshot-wealingo.png"
                type="video/mov"
              />

              <source
                src="/img/site/Wealingo_Video.webm"
                poster="img/site/screenshot-wealingo.png"
                type="video/webm"
              />
            </video>

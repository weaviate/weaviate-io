      ...
      <div className="container">
        <div className="tw-grid tw-items-center tw-gap-12 lg:tw-grid-cols-[0.9fr_1.1fr] lg:tw-gap-20">
          <div>
            <h1 className="tw-mb-8 tw-font-['Plus_Jakarta_Sans'] tw-text-[3rem] tw-font-semibold tw-leading-[130%] tw-tracking-[-0.03em]">
              ...
              <span className="tw-block tw-text-[#DDEBF2]">
                AI Database for Developers who Love to Build
              </span>
            </h1>

            <p className="tw-mb-12 tw-max-w-2xl tw-font-['Inter'] tw-text-xl tw-leading-relaxed tw-text-[#b8c4d4] md:tw-text-2xl">
              Purpose-built open source AI database for a new breed of software
              applications.
            </p>
            ...
            <div className="tw-flex tw-flex-wrap tw-gap-5">
              ...
              <Link
                to="https://docs.weaviate.io/database"
          ...
          <div className="tw-relative">
            <div className="tw-absolute tw-inset-0 tw-rounded-[1.875rem] tw-bg-[linear-gradient(123deg, #26D6FF 12.44%, #D77AFF 109.26%)] tw-opacity-20" />
            ...
            <div className="tw-relative tw-rounded-[1.875rem] tw-border tw-border-white/10 tw-bg-[linear-gradient(123deg,_rgba(38,214,255,0.2)_12.44%,_rgba(215,122,255,0.2)_109.26%)] tw-p-6 tw-shadow-[0_28px_90px_rgba(0,0,0,0.35)] md:tw-p-10">
              <img
                src="/img/site/2026/database-diagram-26.svg"
                alt="Vector database diagram"
                className="tw-h-auto tw-max-h-80 tw-w-full tw-rounded-2xl"
              />
            </div>
          </div>
        </div>

            ...
            navbar: {
                ...
                items: [
                    ...
                    items: [
                        {
                            type: 'html',
                            value : '<div class="holder"><ul class="holdRightnoBorder"><li class="dropDownLabel">Solutions</li><li><a class="dropdown__link" href="/platform">RAG</a></li><li><a class="dropdown__link" href="/platform">Hybrid Search</a></li><li><a class="dropdown__link" href="/platform">Generative Feedback Loops</a></li></ul><div class="divider"></div><ul class="holdRightnoBorder"><li class="dropDownLabel" >Use Cases</li><li><a class="dropdown__link" href="/services/serverless">Chatbot</a></li><li><a class="dropdown__link" href="/services/enterprise-dedicated">Document Search</a></li><li><a class="dropdown__link" href="/services/byoc">Multimodal Search</a></li><li><a class="dropdown__link" href="/services/education-and-support">Recommendation Engine</a></li></ul><div class="divider"></div><ul class="holdRightnoBorder"><li class="dropDownLabel" >Examples</li><li><a class="dropdown__link" href="/case-studies/instabase">Case Studies</a></li><li><a class="dropdown__link" href="/community/build-with-weaviate">Build With Weaviate</a></li><li><a class="dropdown__link" href="/community/demos">Demos</a></li></ul></div>',
                            className: 'dropDownContainer2',
                        },

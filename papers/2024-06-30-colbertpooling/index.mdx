...
## Multi-vector retrieval approaches, like ColBERT, have great retrieval quality but vector count can baloon, AnswerAI propose a solution!

AnswerAI announced a technique to make ColBERT more efficient.
...
**Cross-encoders:**
- Document text & query_text strings concatenated and passed into a cross-encoder which then outputs a rank/score.

**Bi-encoders:**
- Document text passed into an encoder and generates a document_embedding
- Query text seperately passed into an encoder and generates a query embedding
...
- Similarity computation occurs between individual query and document tokens, as opposed to the full document.

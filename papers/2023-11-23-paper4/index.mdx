...
Synthetic data is quite promising, but to see how far we can push the limit with it, this paper investigates what happens when text produced by a version of GPT forms most of the training dataset of following models. What happens to GPT versions GPT-{'{'}n{'}'}
 as generation n increases?
...
<p>
  <DownloadButton link='https://arxiv.org/abs/2305.17493'>🔗 arXiv Link</DownloadButton>
</p>
<p>
  <DownloadButton link='https://arxiv.org/pdf/2305.17493'>📜 Download paper</DownloadButton>
</p>

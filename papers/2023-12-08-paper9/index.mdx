...
tags: []
image: ./img/hero.jpeg
descpription: "Get an LLM to check its own responses for hallucination."
---
...
<p>
  <DownloadButton link={require('./download/2303.08896.pdf').default}>Download the paper - as a button</DownloadButton>
</p>

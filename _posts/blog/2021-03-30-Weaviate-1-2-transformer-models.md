...
By selecting the text-module in the [Weaviate configuration tool](/developers/weaviate/current/installation/#customize-your-weaviate-setup){:target="_blank"}, you can run Weaviate with transformers in one command. You can learn more about the Weaviate transformer module [here](/developers/weaviate/v1.11.0/retriever-vectorizer-modules/text2vec-transformers.html){:target="_blank"}.

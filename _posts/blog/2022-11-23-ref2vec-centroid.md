...
Weaviate 1.16 introduced the [Ref2Vec](/developers/weaviate/current/retriever-vectorizer-modules/ref2vec-centroid.html) module. In this article, we give you an overview of what Ref2Vec is and some examples in which it can add value such as recommendations or representing long objects.
...
![Ref2Vec Image](/img/blog/ref2vec/ref2vec.png)

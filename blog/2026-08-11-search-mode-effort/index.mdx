...
faq:
  ...
  - question: "How much accuracy does higher effort buy in Search Mode?"
    answer: "It depends on the difficulty of the retrieval problem. On reasoning-intensive benchmarks the gains are large — high effort lifts nDCG@10 on BRIGHT Biology from 13.0 with Hybrid Search to 57.5, and reaches roughly a 7x Success@1 improvement on OBLIQ-Bench Congress. On domain-specific benchmarks like IRPAPERS and WixQA, low effort already captures most of the gain."
  - question: "Which Search Mode effort tier should I use for my application?"
    answer: "Turn effort up when the answer matters and down when latency does. For agentic workflows, deep research, or high-stakes question answering, experiment with medium and high effort. If you are latency-sensitive, test whether low effort or Weaviate's Hybrid Search is already enough — on shorter, less reasoning-intensive queries it often is."
  - question: "Does higher effort always outperform lower effort in Search Mode?"
    answer: "On average, yes: across all eight benchmarks and trials, higher effort consistently delivers higher accuracy. But Search Mode's pipeline is stochastic, so adjacent tiers can overlap on individual datasets — on BRIGHT Economics, low effort edges out medium."

...
faq:
  ...
  - question: "How do I set the effort parameter in the Weaviate Query Agent?"
    answer: "Effort is available in weaviate-agents 1.8.0 (Python) and agents-typescript-client 1.7.0 (TypeScript). Pass effort=\"high\", \"medium\", or \"low\" to the Query Agent's search method per request."

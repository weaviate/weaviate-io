...
---
[![SeMI Technologies introduces an all-new business model for vector search](./img/hero.png)](/blog/2022-09-01-weaviate-cloud-service/index.mdx)

<!-- truncate -->

**Amsterdam NL - September 1, 2022**
 
SeMI Technologies, the leader in open-source vector-search technology, announces an [entirely new pricing model](/pricing) for its Weaviate Cloud Services.
...
In addition to remarkably convenient access to the latest vector-search capabilities, Weaviate Cloud Services customers get dedicated customer support on a private Slack channel. However, consistent with SeMI's commitment to creating truly open-source software, customers using the free service will always be able to access all of the Weaviate vector-search engine's capabilities.
...
{/* TODO: change the link to /company/about */}
For more information about the company visit: [about-us](/company/about-us).
 
Customers interested in the private beta of the Weaviate Cloud Services can purchase service for $0.05 per million dimensions. Or, spend an entire dollar and get 20 million dimensions.
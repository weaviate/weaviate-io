...
![document sample](img/document-sample.png)
...
collection_config_params = {
    ...
    # queries or can do so externally, you can change the vector_config to None. 
    "vector_config": [Configure.Vectors.text2vec_transformers(name="embedding", source_properties=['text_representation'])],
}

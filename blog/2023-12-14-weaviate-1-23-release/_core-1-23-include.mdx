...
4. **Performance improvements** - We improved MTTR (mean time to recovery) for Weaviate by changing the way shards are loaded, and by adding automatic resource limiting to prevent out-of-memory errors.

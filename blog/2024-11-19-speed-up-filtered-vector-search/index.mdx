...
For more information on using ACORN in Weaviate, check out our [documentation](https://weaviate.io/developers/weaviate/), such as [how to enable ACORN](https://weaviate.io/developers/weaviate/manage-data/collections#set-vector-index-parameters), and [how to perform filtered searches](https://weaviate.io/developers/weaviate/search/filters).

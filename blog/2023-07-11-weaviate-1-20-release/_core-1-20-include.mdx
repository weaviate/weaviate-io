...
:::tip Read more:
- [Modules / Reranker-cohere](/developers/weaviate/model-providers/cohere/reranker)
- [Modules / Reranker-transformers](/developers/weaviate/model-providers/transformers/reranker)

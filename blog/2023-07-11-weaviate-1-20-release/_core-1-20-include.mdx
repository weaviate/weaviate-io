...
:::tip Read more:
- [Concepts: Data # Multi-tenancy](https://weaviate.io/developers/weaviate/concepts/data#multi-tenancy)
- [How-to manage data: Multi-tenancy operations](https://weaviate.io/developers/weaviate/manage-data/multi-tenancy)
:::
...
:::tip Read more:
- [Concepts: Vector Indexing # Product Quantization](https://weaviate.io/developers/weaviate/concepts/vector-index#hnsw-with-product-quantizationpq)
- [How-to configure: Indexes # Vector index (see `pq`)](https://weaviate.io/developers/weaviate/config-refs/schema/vector-index#weaviates-vector-index)
:::
...
Please refer to [our documentation](https://weaviate.io/developers/weaviate/api/graphql/additional-operators#autocut) for more code examples, including for various Weaviate client libraries.
:::
...
It can be combined with all [vector search operators](https://weaviate.io/developers/weaviate/api/graphql/get#vector-search-operators): `nearXXX`, `bm25`, and `hybrid`. `autocut` is placed after the operator, at the same level with `limit`/`offset`. It is disabled by default and can be explicitly disabled by setting its value to 0 or a negative number.

:::tip Read more:
- [GraphQL references: Additional operators # Autocut](https://weaviate.io/developers/weaviate/api/graphql/additional-operators#autocut)
- [How-to search: Similarity search # Autocut](https://weaviate.io/developers/weaviate/search/similarity#autocut)
- [How-to search: BM25 search # Autocut](https://weaviate.io/developers/weaviate/search/bm25#autocut)
- [How-to search: Hybrid search # Autocut](https://weaviate.io/developers/weaviate/search/hybrid#autocut)
:::
...
:::tip See our documentation for more examples
Please refer to [our documentation](https://weaviate.io/developers/weaviate/search/rerank) for more code examples, including for various Weaviate client libraries.
:::
...
:::tip Read more:
- [Modules / Reranker-cohere](https://weaviate.io/developers/weaviate/model-providers/cohere/reranker)
- [Modules / Reranker-transformers](https://weaviate.io/developers/weaviate/model-providers/transformers/reranker)
- [How-to search: Reranking](https://weaviate.io/developers/weaviate/search/rerank)
:::
...
:::tip See our documentation for more examples
Please refer to [our documentation](https://weaviate.io/developers/weaviate/search/hybrid#fusion-ranking-method) for more code examples, including for various Weaviate client libraries.
:::
...
:::tip Read more:
- [GraphQL references: Search operators # hybrid](https://weaviate.io/developers/weaviate/api/graphql/search-operators#variables-2)
- [How-to search: Hybrid](https://weaviate.io/developers/weaviate/search/hybrid)
:::
...
The full list of metrics that are offered can be found [here](https://weaviate.io/developers/weaviate/configuration/monitoring#obtainable-metrics)

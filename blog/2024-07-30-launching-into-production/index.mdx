...
Our first app is a [Recommender service](/product/personalization-agent), now in private beta. The Recommender is a fully managed, low-code way to build scalable recommendation systems. It offers configurable endpoints for item-to-item, item-to-user, and user-to-user recommendation scenarios across multimodal data. Sign up for the private beta [here](https://events.weaviate.io/early-access), and stay tuned for more Apps updates coming soon. 
...
Lastly, new [Weaviate Cloud Tools](/product) give developers and non-technical users an easier way to manage, explore, and interact with their data within Weaviate Cloud. The [Query](/product/query) and [Collections](/product/collections) tools are available now in the Weaviate Cloud Console.

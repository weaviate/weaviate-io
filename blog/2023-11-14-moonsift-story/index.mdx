...
## What's next
Interested in using Weaviate to power your search and AI applications? [Give our fully managed cloud offering a spin](https://console.weaviate.cloud/) for free. 

Check out [Getting Started with Weaviate](/developers/weaviate/quickstart), and begin building amazing apps with Weaviate.

You can reach out to us on [Slack](https://weaviate.io/slack) or [Twitter](https://twitter.com/weaviate_io), or [join the community foru](https://forum.weaviate.io/).

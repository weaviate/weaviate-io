...
For more information on how to use the `IsNull` filter, check out the [documentation](https://weaviate.io/developers/weaviate/api/graphql/filters#by-null-state).
...
For more information on how to filter by the property length, check out the [documentation](https://weaviate.io/developers/weaviate/api/graphql/filters#by-property-length).
...
Check the [ref2vec-centroid](https://weaviate.io/developers/weaviate/modules/ref2vec-centroid) documentation to learn how to work with Ref2Vec.
...
Check the [/v1/nodes](https://weaviate.io/developers/weaviate/config-refs/nodes) documentation to learn how to use the `Node Status API`.

## More powerful OIDC Auth
![More powerful OIDC Auth](./img/oidc.png)

Security is very, very important. And let's face it - nobody wants to deal with yet another password. That's why we support OpenID Connect (OIDC) [authentication](https://weaviate.io/developers/weaviate/configuration/authentication) in Weaviate, which users experience as a convenient and secure single sign-on.
...
* [Authorization](https://weaviate.io/developers/weaviate/configuration/authorization)
* [Environment variables](https://weaviate.io/developers/weaviate/installation/docker-compose#environment-variables)

...
![Hybrid relativeScoreFusion algorithm depicted as two judges holding up two scores](../../_includes/release-note-summaries/core-1-20-img/Weaviate-release-1-20_hybrid_merger_dark.png#gh-dark-mode-only)
![Hybrid relativeScoreFusion algorithm depicted as two judges holding up two scores](../../_includes/release-note-summaries/core-1-20-img/Weaviate-release-1-20_hybrid_merger_light.png#gh-light-mode-only)
...
Before adding these scores up, they are weighted according to the alpha parameter. Let’s assume `alpha=0.5`, meaning both search types contribute equally to the final result and therefore each score is mutiplied by 0.5.

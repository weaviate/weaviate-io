...
Suppose we are getting these scores from keyword and vector search:
...
First, these scores are weighted according to the alpha parameter. Let’s assume alpha=0.5, meaning both search types contribute equally to the final result:

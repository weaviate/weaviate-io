...
As of `1.20`, there are two algorithms available - one called `rankedFusion` (the current default until `1.24`) and another called `relativeScoreFusion`, the default until `1.24`.

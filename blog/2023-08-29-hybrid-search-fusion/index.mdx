...
This is captured in the final result of `relativeScoreFusion`, where the object with ID 1 is the top score. This is justified because this document was the best result in the keyword search with a big gap to the next-best score and in the top group of vector search.

In contrast, for `rankedFusion`, the object with ID 2 is the top result, closely followed by IDs 1 and 0.

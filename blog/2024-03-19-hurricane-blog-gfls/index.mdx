...
async def weaviate_relevance_generator(request: SessionRequest):
    ...
    weaviate_blog_collection = weaviate_gfl_client.collections.use("Blog")
  ...
  return (
    <div class="blogstyling">
      ...
      {blogPost.introduction_paragraph && (
        <p>{blogPost.introduction_paragraph}</p>
      )}
      {blogPost.evidence_paragraphs &&
        blogPost.evidence_paragraphs.length > 0 && (
          <div>

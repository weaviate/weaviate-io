...
### Query Example: “AirBnB near a place to walk my dog”
...
### Targeted Ads
Please write the ad to target {target}.

What we are going to do is create 3 Ads per listing:

1. For young couples
2. For elderly couples
3. For single travelers

We will add the target as a property to the `Ad` class, like this:

...
All good things have to come to an end. In this case, it's time for us to start saying goodbye to the v3 API in our [Weaviate Python client](https://weaviate.io/developers/weaviate/client-libraries/python).
...
Our documentation includes a [migration guide here](https://weaviate.io/developers/weaviate/client-libraries/python/v3_v4_migration), and many code examples include both v3 and v4 syntax. We will be adding more dedicated resources for you to ease the migration experience.

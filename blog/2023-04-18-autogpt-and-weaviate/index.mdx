...
Edit (5/Jun/2023): AutoGPT seems to have removed support for external vector stores for now. (https://github.com/Significant-Gravitas/Auto-GPT/blob/60ac0c4da15930d5e40af87fba6248ec37a951ee/BULLETIN.md?plain=1#L27)

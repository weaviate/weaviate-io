...
:::info AutoGPT being re-factored
Edit (5/Jun/2023): AutoGPT is re-factoring its memory backend, and has removed support for external vector stores for now. (https://github.com/Significant-Gravitas/Auto-GPT/blob/60ac0c4da15930d5e40af87fba6248ec37a951ee/BULLETIN.md?plain=1#L27)

We are working on adding support back in. For now, please use this version (https://github.com/Significant-Gravitas/Auto-GPT/tree/v0.3.1) if you would like to use it with Weaviate.
:::

...
Our Community is active across the web and in real life. We see engagement in channels like LinkedIn, Twitter, GitHub, Discourse, and StackOverflow, as well as at conferences, meetups, and hackathons. In all places community members:
...
- **Open:** People actively share questions, knowledge, and feedback within more than 200 messages per week inside our open [discourse forum](https://forum.weaviate.io), or [GitHub](https://github.com/weaviate) repositories
...
Weaviate Heroes are passionate about Weaviate. They build AI-native applications and contribute back to our community and product roadmap in a true open-source manner. Members of the Weaviate Hero program share their ideas, thoughts, and feedback to improve Weaviate through GitHub, or direct conversations with our engineers.

They engage in early access initiatives and share their knowledge and experience in various ways, like answering Questions in our Weaviate Forum, or Stack Overflow, joining our Podcasts or live streams, publishing blog posts, or attending community and in-person events.
...
Reach out to Ron on [LinkedIn](https://www.linkedin.com/in/ron-parker-scbbs/)
...
You find Patrice on [LinkedIn](https://www.linkedin.com/in/patrice-bourgougnon-46a2b71b3/).
...
If you are interested or have questions on topics like Product growth hacking, GenAI/ML, Channel and B2B technologies, Cloud Computing trends, or also enjoy Competitive FPS games (Apex Legends) - reach out to Travis on [LinkedIn](https://linkedin.com/in/travis-rehl-tech).
...
As a first step, start engaging in our open source community by collaborating with other community members in our [forum.weaviate.io](http://forum.weaviate.io), with content on our [blog](https://weaviate.io/blog) (or your own) or via social media. **EVERYONE** can become a hero!

...
We will cover some highlights about this great multimodal model below but for all the details have a look at this [blog](https://imagebind.metademolab.com/) and the [paper](https://arxiv.org/abs/2305.05665).
...
![Top retrieved image](./img/car.jpg)
...
![Top retrieved image](./img/bird.jpg)

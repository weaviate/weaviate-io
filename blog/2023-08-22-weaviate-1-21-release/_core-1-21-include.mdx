...
Deactivating unused subsets of data will help to reduce cost and improve the overall performance. We are very excited for you to [try it out](/developers/weaviate/manage-data/multi-tenancy).

> Read more:
> - [REST API: Schema: Multi-tenancy](/developers/weaviate/api/rest#tag/schema/post/schema/%7BclassName%7D/tenants)
...
> Read more:
> - [Modules: text2vec-gpt4all](/developers/weaviate/model-providers/gpt4all/embeddings)
...
We’ll explore the awesomeness of this new module more in a blog soon but for now, you can read more about the details of how you can use `multi2vec-bind` in the [documentation](/developers/weaviate/model-providers/imagebind/embeddings-multimodal).

> Read more:
> - [Modules: multi2vec-bind](/developers/weaviate/model-providers/imagebind/embeddings-multimodal)

...
<video width="100%" autoplay loop controls>
  <source src="./img/joke2.mp4" type="video/mp4" />
...
The setup is quite straightforward, all you need is the [Weaviate Client](/developers/weaviate/client-libraries/index.html). We provide an example that uses the Python Client and the dpr-question_encoder-single-nq-base model (i.e., the module that is used to vectorize objects in Sphere).

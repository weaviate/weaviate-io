...
By selecting the text-module in the [Weaviate configuration tool](/docs/weaviate/installation/docker-compose#configurator), you can run Weaviate with transformers in one command. You can learn more about the Weaviate transformer module [here](/docs/weaviate/modules/retriever-vectorizer-modules/text2vec-transformers).
...
You can also use custom transformer models that are compatible with Huggingface's `AutoModel` and `AutoTokenzier`. Learn more about using custom models in Weaviate [here](/docs/weaviate/modules/retriever-vectorizer-modules/text2vec-transformers).

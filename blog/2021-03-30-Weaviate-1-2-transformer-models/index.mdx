...
You can also use custom transformer models that are compatible with Huggingface's `AutoModel` and `AutoTokenzier`. Learn more about using custom models in Weaviate [here](/developers/weaviate/modules/retriever-vectorizer-modules/text2vec-transformers).
...
## What next
Check out the [Getting Started with Weaviate](/developers/weaviate/current/getting-started) and begin building amazing apps with Weaviate.

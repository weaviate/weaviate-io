...
:::caution Verba has been deprecated
Verba is no longer actively maintained. For RAG demos and interactive examples, visit **[playground.weaviate.io](https://playground.weaviate.io)** — including [Elysia](https://elysia.weaviate.io/), our next-generation agentic RAG assistant, and more.
:::

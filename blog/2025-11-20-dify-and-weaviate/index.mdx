...
| Feature | Description |
| ----- | ----- |
| **Hybrid Search** | Combines semantic and keyword search. Use the alpha parameter to balance them, alpha=0.5 means equal weighting, alpha=0 is pure keyword search, and alpha=1 is pure vector search. The default is alpha=0.5. |

...
A live MCP endpoint returns a JSON-RPC envelope listing the available tools. You don't need to parse it — a non-empty response is enough. If you get a connection refused, MCP isn't enabled.

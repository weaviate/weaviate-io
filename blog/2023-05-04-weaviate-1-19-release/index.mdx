...
We initially introduced this consistency tuning feature in the [`1.17` release](/blog/weaviate-1-17-release) and later expanded it to support all read and write REST operations in the [`1.18` release](/blog/weaviate-1-17-release).

...
See below for an example of how you can use the module. For more information on how to set up and use the module please refer to the [documentation](/developers/weaviate/model-providers/cohere/generative).

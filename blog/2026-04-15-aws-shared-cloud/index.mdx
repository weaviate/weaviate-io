...
<div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'16px', margin:'24px 0'}}>
  <div style={{background:'#fff', border:'1px solid #e8e8f0', borderRadius:'8px', padding:'24px', boxShadow:'0px 4px 16px rgba(22,27,45,0.06)'}}>
    <a href="https://docs.weaviate.io/query-agent" target="_blank" rel="noopener noreferrer" style={{color:'#61bd73', fontWeight:600, marginBottom:'8px', fontSize:'0.875rem', textTransform:'uppercase', letterSpacing:'0.05em', textDecoration:'none', display:'block'}}>Query Agent →</a>

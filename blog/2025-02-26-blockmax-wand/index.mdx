...
| (64 \* 4 = 256 bits) | \- 1000000: encode fully as 64 bits  \- encode number of bits needed to represent: 6 bits \- remaining values: encode as floor(log2(3))+1 = 2 bits 64 \+ 6 \+ 2\*3 = 76 bits | 

...
Comparing avg. % of doc query terms scored Weaviate 1.29.0 on standard [beir datasets](https://github.com/beir-cellar/beir). Exhaustive search would always need to examine 100% of the document query terms with at least one query term.
...
| (64 \* 4 = 256 bits) | <ul><li>1000000 encode fully: 64 bits</li><li>2: number of bits needed to represent deltas: 6 bits</li><li>remaining values: encode as floor(log2(3))+1 = 2 bits</li><li> 64 \+ 6 \+ 2\*3 = 76 bits</li></ul> | 

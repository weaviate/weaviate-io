...
tags: ['release']
image: ./img/hero.png
description: "Accelerate your enterprise AI with Weaviate's latest launch—featuring 94% faster keyword search, Weaviate Embeddings and Role-Based Access Control general availability, dedicated Azure deployments, NVIDIA integrations, and more. Discover the new features and join our March 5 deep dive."
---
![hero](./img/hero.png)
...
Together, these enhancements further elevate Weaviate’s position as a leading enterprise-grade vector database. For a deeper dive into the technical details, check out the [Weaviate 1.29 Release Highlights blog](/blog/weaviate-1-29-release).
...
[^1]:  Weaviate internal tests (Fever dataset–5.4M documents): reduced search time from 517ms to 33ms. Results to be published on Feb 26.

[^2]:  Weaviate internal tests (MS Marco dataset–8.6M documents): from 10.53 GB to 0.92 GB, 77% fewer documents scored, 79% fewer blocks decompressed. Results to be published on Feb 26.

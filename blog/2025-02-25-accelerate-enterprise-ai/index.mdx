...
In the meantime, if you’re eager to get hands-on, check out the [**Quickstart tutorial**](https://weaviate.io/developers/wcs/embeddings#get-started), or explore [**Weaviate Cloud with a free trial**](https://console.weaviate.cloud/)—and experience for yourself how Weaviate can supercharge your AI applications. We’re excited to see what you build\!

...
2. Have a [Weaviate cluster](https://console.weaviate.cloud/) — you can create a 14-day free sandbox or run Embedded Weaviate ([other installation options](https://weaviate.io/developers/weaviate/installation#installation-methods))
...
:::info
This demo uses the Python v3 client, however, there is a new and improved v4 client! I will migrate this demo to use the v4 client - here is a [guide](https://weaviate.io/developers/weaviate/client-libraries/python/v3_v4_migration) on how to do so.
:::

...
* [Learn about Weaviate](/docs/weaviate/concepts)
* [Weaviate Installation](/docs/weaviate/installation)
...
How cool is that? We can find visually similar dogs in just a simple query to Weaviate. We could even scale this to millions of images running in milliseconds with [Weaviate's ANN index](/docs/weaviate/concepts/vector-index-plugins). 

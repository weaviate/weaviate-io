...
* [Learn about Weaviate](https://weaviate.io/developers/weaviate/current/core-knowledge/basics.html)
* [Weaviate Installation](https://weaviate.io/developers/weaviate/current/getting-started/installation.html)
* [Docker Installation](https://docs.docker.com/engine/install/)


[Check out this article](https://weaviate.io/blog/2022/09/Why-is-Vector-Search-so-fast.html) to learn more about why vector search engines are so fast and how they work.

We will provide code snippets in this post, but you can check out the full code base in the [Github repository](https://github.com/semi-technologies/weaviate-examples) under the `nearest-neighbor-dog-search` directory. We encourage you to follow along with us by cloning the repository!
...
```
How cool is that? We can find visually similar dogs in just a simple query to Weaviate. We could even scale this to millions of images running in milliseconds with [Weaviate's ANN index](https://weaviate.io/developers/weaviate/current/vector-index-plugins/index.html). 
...
Thanks for reading, and see you soon. You can also check out the other great [Weaviate demos](https://github.com/semi-technologies/weaviate-examples) on Github!  

## What’s Next
Check out the [Getting Started with Weaviate](https://weaviate.io/developers/weaviate/current/getting-started/index.html) and begin building amazing apps with Weaviate.

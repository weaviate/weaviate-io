...
---
[![How to build an Image Search Application with Weaviate](./img/hero.png)](/blog/2022-10-18-how-to-build-an-image-search-application-with-weaviate/index.mdx)
...
We will provide code snippets in this post, but you can check out the full code base in the [Github repository](https://github.com/weaviate/weaviate-examples) under the `nearest-neighbor-dog-search` directory. We encourage you to follow along with us by cloning the repository!

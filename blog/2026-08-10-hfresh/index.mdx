...
We benchmarked uncompressed HNSW, HNSW with RQ1, HNSW with RQ8, and HFresh on the DBpedia OpenAI 1M dataset. HNSW indexes were built with `efConstruction=256` and `maxConnections=16`. The chart below includes the machine configuration and query settings.

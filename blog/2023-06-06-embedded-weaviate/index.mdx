...
For a more detailed take on using Weaviate in CI/CD pipelines, see the [Automated testing for Weaviate applications](../2023-06-29-automated-testing/) blog post.

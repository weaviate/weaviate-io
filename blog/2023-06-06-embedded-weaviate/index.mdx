...
Running Weaviate locally from client code is obviously useful for getting started very quickly with Weaviate, be it with standalone code, or from Jupyter notebooks. It's also great for CI/CD pipelines, where you can run integration tests without having to manage a separate server instance.

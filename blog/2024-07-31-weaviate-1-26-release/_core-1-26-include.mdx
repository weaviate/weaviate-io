...
The `ENABLE_API_BASED_MODULES` variable disables the [`Explore`](/developers/weaviate/api/graphql/explore) feature when `ENABLE_API_BASED_MODULES` is `true`.

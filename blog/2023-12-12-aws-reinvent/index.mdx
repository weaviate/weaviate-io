...
Weaviate and AWS compliment each other nicely. You can use Weaviate as your vector database with Amazon Bedrock. Start building with the [`text2vec-aws` module](https://docs.weaviate.io/weaviate/model-providers/aws/embeddings) today!

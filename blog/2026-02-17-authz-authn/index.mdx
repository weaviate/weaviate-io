...
For organizations with enterprise security requirements, Weaviate Cloud's **Premium plan** offers dedicated infrastructure with SSO/SAML support, custom identity provider integration, PrivateLink, and compliance certifications (SOC II, HIPAA). This lets your team authenticate to Weaviate Cloud through your existing identity provider — check out the [Pricing Plan](https://weaviate.io/pricing) for details or [contact us](https://weaviate.io/contact) for more info.

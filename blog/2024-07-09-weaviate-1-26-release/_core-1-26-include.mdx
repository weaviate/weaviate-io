...
When you search, add a list of target vectors to the query. Weaviate automatically combines the results. The mechanism is similar to the [hybrid fusion](/blog/hybrid-search-fusion-algorithms) algorithm in [hybrid search](/developers/weaviate/search/hybrid).

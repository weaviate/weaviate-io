...
See the [Anthropic integration page](/developers/weaviate/model-providers/anthropic/index.md) for more information.
...
This feature is available for self-hosted instances. It is not yet available in [Weaviate Cloud](/developers/wcs).

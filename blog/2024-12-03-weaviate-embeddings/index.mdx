...
We’re excited to announce that [**Weaviate Embeddings**](https://docs.weaviate.io/wcs/embeddings), a new embedding service in Weaviate Cloud that makes creating vector embeddings as easy as possible for AI developers, is now available in preview. 

...
Note that currently, this feature must be enabled before ingesting any data, as it requires re-indexing your data. (We do not yet support migrations.)
...
Enjoy the new features and improvements in Weaviate `1.28`. The release is available open-source as always [on GitHub](https://github.com/weaviate/weaviate/releases/tag/v1.28.0), and is available for new Sandboxes on [Weaviate Cloud](https://console.weaviate.cloud/).

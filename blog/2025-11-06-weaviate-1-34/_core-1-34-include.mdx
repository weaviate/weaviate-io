...
| Quantization | Recall with [rescore limit](https://docs.weaviate.io/weaviate/concepts/vector-quantization#over-fetching--re-scoring) 100 | Approx. QPS (_Queries Per Second_) |
| ------------ | ------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- |
| **RQ 8-bit** | ~100%                                                                                                                     | ~400                               |
| **RQ 1-bit** | ~100%                                                                                                                     | ~800                               |
| **BQ**       | ~98%                                                                                                                      | ~1,900                             |

_Benchmark: DBpedia 100k with OpenAI Ada-002 embeddings_

![Flat Index RQ - Recall performance](./img/recall-graph.png)
![Flat Index RQ - QPS performance](./img/qps-graph.png)
...
Check out the complete example and installation instruction in our [documentation](https://docs.weaviate.io/weaviate/client-libraries/java/java-v6).
...
Check out the complete example and installation instruction in our [documentation](https://docs.weaviate.io/weaviate/client-libraries/csharp).
...
import PerformanceImprovements from './img/improvements.png';
...
- [Weaviate 1.34: GitHub release notes](https://github.com/weaviate/weaviate/releases/tag/v1.34.0)
...
- [@hzy12138](https://github.com/hzy12138) contributed [#9342](https://github.com/weaviate/weaviate/pull/9342)
- [@waveywaves](https://github.com/waveywaves) contributed [#8978](https://github.com/weaviate/weaviate/pull/8978)

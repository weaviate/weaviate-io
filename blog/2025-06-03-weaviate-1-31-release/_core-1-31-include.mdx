...
ColBERT or ColPali-like [multi-vector embeddings](/developers/weaviate/tutorials/multi-vector-embeddings) went generally available in Weaviate `v1.30`. As a reminder, here is an illustration showing the difference between single-vector and multi-vector embeddings.
...
- [Collection configuration with multi-vector embeddings](/developers/weaviate/manage-data/collections#define-multi-vector-embeddings-eg-colbert-colpali)
- [How-to Configure: Vector Compression - Multi-vector embeddings](/developers/weaviate/configuration/compression/multi-vectors)
...
In case you are wondering - yes, this is available with Weaviate's [hybrid search](/developers/weaviate/concepts/hybrid-search) as well. 😉 So you can granularly control the keyword search part of your hybrid search even more.

:::info Related resources
- [How-to: Keyword search: Operators](/developers/weaviate/search/bm25#search-operators)
- [How-to: Hybrid search: Keyword search operators](/developers/weaviate/search/hybrid#keyword-search-operators)
- [Concepts: Keyword search](/developers/weaviate/concepts/search/keyword-search#keyword-search-operators)
:::
...
:::info Related resources
- [How-to: Manage collections: Add new vectorizer](/developers/weaviate/manage-data/collections#add-new-named-vectors)
:::
...
Now, `v1.31` introduces HNSW snapshotting. The `tl;dr` is that Weaviate can now create *snapshots* of your HNSW index, instead of having to re-build the index from its [write-ahead log (WAL)](/developers/weaviate/concepts/storage#write-ahead-log).
...
:::info Related resources
- [Concepts: Storage: HNSW snapshots](/developers/weaviate/concepts/storage#hnsw-snapshots)
- [How-to: Configure: HNSW snapshots](/developers/weaviate/configuration/hnsw-snapshots)
:::
...
:::info Related resources
- [Model integrations](/developers/weaviate/model-providers/)
:::
...
If you are interested in contributing to Weaviate, please check out our [contribution guide](/developers/contributor-guide/), and the list of open issues on [GitHub](https://github.com/weaviate/weaviate/issues). Filtering for the `good-first-issue` label is a great way to get started.

:::info Related resources
- [Contribution guide](/developers/weaviate/more-resources/contributing)
:::

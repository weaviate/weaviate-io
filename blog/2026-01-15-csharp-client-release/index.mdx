...
This is just a glimpse of what this new client has to offer — there's much more to discover in the [official documentation](https://docs.weaviate.io/weaviate/client-libraries/csharp) and the [GitHub repository](https://github.com/weaviate/csharp-client). We're excited to bring first-class Weaviate support to the .NET community!

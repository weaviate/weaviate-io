...
I am using the [text2vec-transformers](/developers/weaviate/model-providers/transformers/embeddings) module to create the embeddings Weaviate will use, and using [Ollama](https://ollama.ai/) to host our Mistral model locally.

...
To judge how similar two objects are, we can compare their vector values, by using various d**istance metrics**.
...
![Multi-Dmensional](img/vectors-example.png)
...
![Squared Euclidean](img/l2-formula.png)
...
![Manhattan Example](img/manhattan-example.png)
...
![Hamming and BPR](img/hamming-and-bpr.png)

...
* Improved lifecycle management via [collection aliases](https://docs.weaviate.io/weaviate/manage-collections/collection-aliases), [replica movement](https://docs.weaviate.io/deploy/configuration/replica-movement) GA, and [TTL](https://docs.weaviate.io/weaviate/manage-collections/time-to-live) support  
* Expanded security and access controls, including [cluster RBAC](https://docs.weaviate.io/weaviate/configuration/rbac), OIDC [group management](/blog/weaviate-1-33-release#oidc-group-management) and [runtime configurable certificates](https://weaviate.io/blog/weaviate-1-35-release?utm_source=chatgpt.com#runtime-configurable-oidc-certificates)  
...
Many of these capabilities are already taking shape. We’re extending agentic retrieval into richer reasoning workflows, expanding multimodal support to give agents deeper context, introducing tools to measure and compare model performance \[link to preview signup\], and building shared memory \[link to preview signup\] to enable agents that evolve as they are used. 

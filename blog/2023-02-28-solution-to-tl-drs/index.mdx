...
Published 2023-02-28. Code samples use the now-deprecated `text2vec-contextionary` module and pin Weaviate to `v1.17.4`. The `sum-transformers` module still exists; for current generative-summarization patterns, see the [Cohere generative docs](https://docs.weaviate.io/weaviate/model-providers/cohere/generative).
:::

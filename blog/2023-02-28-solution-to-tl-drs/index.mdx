...
Our summarizer module ([`sum-transformers`](https://weaviate.io/developers/weaviate/modules/sum-transformers)) can be added to a Weaviate instance to do exactly that.
...
You might have heard of our new [`generative-openai` module](https://weaviate.io/developers/weaviate/model-providers/openai/generative) already. It can take your results, and provide a prompt to a generative model to get back a response.
...
In addition to these two models, however, you can use any model from the Hugging Face Hub (or your own) by following [this guide](https://weaviate.io/developers/weaviate/modules/sum-transformers#use-another-summarization-module-from-hugging-face).

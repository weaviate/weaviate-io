...
:::note Module update
`text2vec-contextionary` is deprecated. For current vectorizer + generative-summarization patterns, see the [model providers reference](https://docs.weaviate.io/weaviate/model-providers).
:::
...
The [Goldilocks Principle](https://en.wikipedia.org/wiki/Goldilocks_principle) also applies here, where too short an input may cause the summarizer model to misbehave (i.e. [hallucinate](https://en.wikipedia.org/wiki/Hallucination_%28artificial_intelligence%29)).

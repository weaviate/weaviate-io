...
I'm here to tell you, however, that it doesn't have to be that way. In this article, I'll show you how to make testing easier with [Embedded Weaviate](/developers/weaviate/installation/embedded), and other tips for better automated testing.
...
For one, Weaviate must interact with the application in a variety of ways. In addition, Weaviate will interact with additional, external services such as vectorizers or LLMs.
...
<Tabs groupId="languages">
  ...
  <FilteredTextBlock
    ...
    endMarker="# END ConnectAndCleanup"
    language="py"
  />
  </TabItem>

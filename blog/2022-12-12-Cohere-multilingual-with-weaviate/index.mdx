...
> If you don’t consider a “blink of an eye” as a scientific metric (note: it isn’t!), you can check Weaviate’s [benchmarks](/developers/weaviate/benchmarks/ann.html#results) on some standard datasets.
...
### Text2vec-cohere
Over the last few weeks, we’ve partnered with Cohere to create a new Weaviate module – [text2vec-cohere](/developers/weaviate/modules/retriever-vectorizer-modules/text2vec-cohere.html) – it allows you to use Cohere’s LLMs to run complex NLP queries straight from Weaviate.

You can learn all about [text2vec-cohere from the docs](/developers/weaviate/modules/retriever-vectorizer-modules/text2vec-cohere.html).
...
## What next
Check out the [text2vec-cohere](/developers/weaviate/modules/retriever-vectorizer-modules/text2vec-cohere.html) to learn more about the new module.

If you are new to Weaviate, check out the [getting started guide](/developers/weaviate/getting-started/index.html).

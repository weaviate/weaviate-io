...
> If you don’t consider a "blink of an eye" as a scientific metric (note: it isn’t!), you can check Weaviate’s [benchmarks](/developers/docs/benchmarks/ann#results) on some standard datasets.
...
### Text2vec-cohere
Over the last few weeks, we’ve partnered with Cohere to create a new Weaviate module – [text2vec-cohere](/developers/docs/modules/retriever-vectorizer-modules/text2vec-cohere) – it allows you to use Cohere’s LLMs to run complex NLP queries straight from Weaviate.

You can learn all about [text2vec-cohere from the docs](/developers/docs/modules/retriever-vectorizer-modules/text2vec-cohere).
...
## What next
Check out the [text2vec-cohere](/developers/docs/modules/retriever-vectorizer-modules/text2vec-cohere) to learn more about the new module.

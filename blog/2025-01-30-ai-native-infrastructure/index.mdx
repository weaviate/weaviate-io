...
* **Integration with Agentic Frameworks:** Weaviate works with popular LLMs and agent tools like [LangChain](https://docs.weaviate.io/integrations/llm-agent-frameworks/langchain) and [LlamaIndex](https://docs.weaviate.io/integrations/llm-agent-frameworks/llamaindex), making it easier to build and deploy agentic workflows. 

...
Check out the [metrics documentation page](/developers/weaviate/references/distances#distance-implementations-and-optimizations) for a complete overview of all available metrics in Weaviate.

...
# date: 2022-09-07
# toc: false
# redirect_from: /blog/Weaviate-release-1-15.html
---
...
Without getting into too many details (see the [docs for more precise instructions](/developers/docs/configuration/backups)), each module requires a different set of settings.
...
Head to the [documentation](/developers/docs/configuration/backups) for a more in-depth overview and instructions.
...
For more information, see the [Docker Compose environment variables](/developers/docs/installation/docker-compose#environment-variables) in the docs.
...
Check out the [metrics documentation page](/developers/docs/configuration/distances#distance-implementations-and-optimizations) for a complete overview of all available metrics in Weaviate.
...
Head to the [Summarization Module docs page](/developers/docs/modules/reader-generator-modules/sum-transformers) to learn more.
...
To learn more, head to the [HuggingFace Module docs page](/developers/docs/modules/retriever-vectorizer-modules/text2vec-huggingface).

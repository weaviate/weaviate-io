...
<!-- Today, people from the SeMI team are working on API design, core implementation, [tools and libraries](/developers/weaviate/references/client-libraries), and many other things related to Weaviate. -->

...
<!-- Today, people from the SeMI team are working on API design, core implementation, [tools and libraries](/developers/docs/client-libraries), and many other things related to Weaviate. -->

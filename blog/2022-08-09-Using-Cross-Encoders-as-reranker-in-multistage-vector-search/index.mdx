...
> Note. Vector search engines **compute** dense vector embeddings **during import**. Calculating vectors up-front coupled with [ANN algorithms](/developers/weaviate/vectorization) (for faster retrieval) makes working with Bi-Encoder highly efficient.

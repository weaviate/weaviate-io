...
> Note. Vector search engines **compute** dense vector embeddings **during import**. Calculating vectors up-front coupled with [ANN algorithms](/docs/weaviate/concepts/vector-index-plugins) (for faster retrieval) makes working with Bi-Encoder highly efficient.

...
---
Vector Search engines – like [Weaviate](/developers/weaviate/current/) – use **Machine Learning models** to analyze data and **calculate vector embeddings**. The vector embeddings are **stored together with the data** in a database, and later are used to query the data.
...
Check out this article to learn [Why Vector Search engines are so fast](/blog/2022/09/Why-is-Vector-Search-so-fast.html) and how they work.

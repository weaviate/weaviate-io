...
A major highlight of the [GA release of the Query Agent](https://weaviate.io/blog/query-agent-generally-available) is the introduction of **Search Mode**! This feature draws on decades of information retrieval best practices such as query decomposition, query expansion, reranking, and more, to deliver higher quality search results. In this blog post, we compare Search Mode against Hybrid Search across several leading Information Retrieval benchmarks, including BEIR, LoTTe, BRIGHT, EnronQA, and WixQA.

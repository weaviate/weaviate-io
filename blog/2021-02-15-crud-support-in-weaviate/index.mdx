...
Check out the [quickstart guide](https://weaviate.io/developers/weaviate/quickstart) in the documentation or [learn more about Weaviate here](https://weaviate.io/developers/weaviate). If you like what you've read and would consider using Weaviate in the future, feel free to leave a star on [GitHub](https://github.com/weaviate/weaviate).

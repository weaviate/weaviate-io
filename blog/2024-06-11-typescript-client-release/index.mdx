...
const { vectors, dataType } = weaviate.configure;
...
```ts
import weaviate from 'weaviate-client';
const { vectors, vectorIndex } = weaviate.reconfigure;
...
```ts
import weaviateNext, { weaviateV2 as weaviate } from 'weaviate-client'
```
...
- [Migrate from v2 to v3](https://docs.weaviate.io/weaviate/client-libraries/typescript/typescript-v3)

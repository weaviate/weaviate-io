...
### Learn more
To learn more, see the [documentation](/developers/weaviate/current/more-resources/monitoring.html).
...
### Learn more
For more info, check out [the documentation](/developers/weaviate/current/vector-index-plugins/distances.html).
...
### Guide
Here is a little guide on [how to write great bug reports](/developers/weaviate/current/tutorials/write-great-bug-reports.html).

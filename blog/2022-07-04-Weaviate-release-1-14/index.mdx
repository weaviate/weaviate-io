...
Check out [the changelog](https://github.com/semi-technologies/weaviate/releases/tag/v1.14.0) to see the complete list of features and over 25 bug fixes.
...
[See more on github](https://github.com/semi-technologies/weaviate/pull/1976).
...
Check out [the changelog](https://github.com/semi-technologies/weaviate/releases/tag/v1.14.0) to see the complete list.
...
### Try it yourserlf
Here is an [example project](https://github.com/semi-technologies/weaviate-examples/tree/main/monitoring-prometheus-grafana), it contains:
...
### Learn more
To learn more, see the [documentation](/developers/docs/configuration/monitoring).
...
### Learn more
For more info, check out [the documentation](/developers/docs/configuration/distances).

### Contribute
Adding other distances is surprisingly easy, which could be a great way to contribute to the Weaviate project.

If that is something up your street, check out [the distancer code on github](https://github.com/semi-technologies/weaviate/tree/master/adapters/repos/db/vector/hnsw/distancer), to see the implementation of other metrics.
...
### Background
One of Weaviate's features is full CRUD support. CRUD operations enable the mutability of data objects and their vectors, which is a key difference between a vector database and an ANN library. In Weaviate, every data object has an ID (UUID). This ID is stored with the data object in a key-value store. IDs don't have to be globally unique, because in Weaviate [classes](/developers/docs/configuration/schema-configuration#class-object) act as namespaces. While each class has a different [HNSW index](/developers/docs/concepts/vector-index-plugins#hnsw), including the store around it, which is isolated on disk.

There was however one point in the API where reusing IDs between classes was causing serious issues. Most noticeable this was for the [v1/objects/{id}](/developers/docs/api/rest/objects) REST endpoints.
...
* [Weaviate's Slack](https://join.slack.com/t/weaviate/shared_invite/zt-goaoifjr-o8FuVz9b1HLzhlUfyfddhw) – you can join anytime
* [GitHub issues for Weaviate Core](https://github.com/semi-technologies/weaviate/issues/new)
* [GitHub issues for Weaviate's documentation](https://github.com/semi-technologies/weaviate-io/issues/new/choose)
...
### Guide
Here is a little guide on [how to write great bug reports](/developers/docs/more-resources/write-great-bug-reports).

## Enjoy
We hope you enjoy the most reliable and observable Weaviate release yet!

Please share your feedback with us via [Slack](https://join.slack.com/t/weaviate/shared_invite/zt-goaoifjr-o8FuVz9b1HLzhlUfyfddhw), [Twitter](https://twitter.com/weaviate_io), or [Github](https://github.com/semi-technologies/weaviate).

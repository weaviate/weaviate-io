...
Enjoy the new features and improvements in Weaviate `1.25`. This release is available as a docker image and coming soon to Weaviate Cloud [WCD](https://console.weaviate.cloud/).

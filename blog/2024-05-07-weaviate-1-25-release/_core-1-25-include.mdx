...
- [**Dynamic Vector Index**](/blog/weaviate-1-25-release#dynamic-vectr-index) An index configuration that allows Weaviate to dynamically switch from flat to HNSW as object count increases.

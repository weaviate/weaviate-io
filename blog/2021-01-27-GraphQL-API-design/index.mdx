...
<a href="/developers/weaviate" target="_blank"><img src="./img/weaviate-demo.gif?i=8" alt="Demo of Weaviate" width="100%" /></a>
...
[Click here](/developers/weaviate/references/graphql) to learn more about the complete GraphQL structure.

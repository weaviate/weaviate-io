...
# date: 2022-09-27
# toc: true
# redirect_from: /blog/Hugging-Face-Inference-API-in-Weaviate.html
---
...
> Both modules are enabled by default in the [Weaviate Cloud Service](/pricing).
...
Every new Weaviate instance created with the [Weaviate Cloud Service](/pricing) has the Hugging Face module enabled out of the box. You don't need to update any configs or anything, it is there ready and waiting.
...
For more detailed instructions please check the [documentation](/developers/docs/modules/retriever-vectorizer-modules/text2vec-huggingface).
:::
...
## Summary
> Now you can use [Hugging Face](/developers/docs/modules/retriever-vectorizer-modules/text2vec-huggingface) or [OpenAI](/developers/docs/modules/retriever-vectorizer-modules/text2vec-openai) modules in Weaviate to delegate model inference out.
...
## What next
Check out the [text2vec-huggingface](/developers/docs/modules/retriever-vectorizer-modules/text2vec-huggingface) documentation to learn more about the new module.

If you are new to Weaviate, check out the [getting started guide](/developers/docs/quickstart).

...
For more detailed instructions please check the [documentation](/docs/weaviate/modules/retriever-vectorizer-modules/text2vec-huggingface).
:::
...
## Summary
> Now you can use [Hugging Face](/docs/weaviate/modules/retriever-vectorizer-modules/text2vec-huggingface) or [OpenAI](/docs/weaviate/modules/retriever-vectorizer-modules/text2vec-openai) modules in Weaviate to delegate model inference out.
...
## What next
Check out the [text2vec-huggingface](/docs/weaviate/modules/retriever-vectorizer-modules/text2vec-huggingface) documentation to learn more about the new module.

If you are new to Weaviate, check out the [getting started guide](/docs/weaviate/quickstart).

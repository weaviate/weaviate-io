...
:::note Roadmap items shipped
The "coming soon" features mentioned in this post (Vamana indexing, HNSW+PQ) have since shipped. See the [ANN benchmarks page](https://docs.weaviate.io/weaviate/benchmarks/ann) for current Sphere usage.
:::

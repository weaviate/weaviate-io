...
Published 2022-12-27. Several "coming soon" items referenced in this post (Vamana, HNSW+PQ) have since shipped. Code samples use the pre-v4 Python client and the now-deprecated `string` data type. For current Sphere usage, see the [ANN benchmarks page](https://docs.weaviate.io/weaviate/benchmarks/ann).
:::

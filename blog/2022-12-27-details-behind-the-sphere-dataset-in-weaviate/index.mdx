...
We used a single 64 GiB Google Cloud Platform(GCP) n2 instance to run Spark. The steps below can be followed to import data from the Sphere dataset. You can refer to this [tutorial](https://weaviate.io/developers/weaviate/tutorials/spark-connector) for details on the import code.

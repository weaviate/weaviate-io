...
:::info TL;DR
We've released a pre-release version of our new Python client API. It's available for you to try out and provide feedback. We've made a number of major improvements, including strong typing, a collections-first approach, and performance improvements. You can try it here - [Experimental clients](/developers/weaviate/client-libraries/experimental).
:::
...
If you're keen to try it, please head over to our [Experimental clients](/developers/weaviate/client-libraries/experimental) page. There, you'll find the installation, usage and feedback instructions.
:::
...
> **Highlights: Simplified methods, easier defaults, import error handling**
...
Another big improvement is how we handle errors during data import. Many of you let us know that you would like to get more information around any errors at a macro and micro level. So, we've added a couple of features to help with this.
...
## Object typing, all the way down

> **Highlights: Strong typing in queries, retrieval augmented generation, data operations, ...**

We've mentioned object typing a few times already, but let's take a closer look at a few more concrete examples. To get started you can import the set of submodules like shown below, and use them as needed.
...
client.collection.create(
    ...
    vector_index_config=wvc.ConfigFactory.vector_index(distance_metric=wvc.VectorDistance.COSINE),
...
We have prepared a [dedicated page](/developers/weaviate/client-libraries/experimental) with instructions on how to install and use the new client. The page also includes a link to a feedback form where you can share your thoughts and suggestions.

We can't wait to hear what you think! Please do share your feedback with us there, and on Slack and the community forum as well.

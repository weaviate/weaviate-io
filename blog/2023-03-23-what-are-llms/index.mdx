...
1. You’ve heard the prior phrase before whereas you’ve never heard the latter; one combination of words is common and familiar whereas the other is not.
...
Furthermore, by putting together knowledge of commonly occurring words they can also learn higher level concepts such as relations between words to learn that feathers can go in caps but they don’t go on cats to reach the second point above.
...
One limitation of LLMs currently, which can prevent them from attaining points 3 and 4 repititively and is actively being worked on, is how far these features and interactions can penetrate into deeper meanings of language to follow logic and use a world-model to understand and follow a sequence of actions. GPT 4.0 shows great strides forwards compared to GPT 3.5 in this domain as demonstrated by [Daniel Feldman's prompting](https://twitter.com/d_feldman/status/1636955260680847361) shared below:

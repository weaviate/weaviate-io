...
Speaking of Cloud, arguably the easiest way to spin up a new use case with Weaviate is through the [Weaviate Cloud Services](/pricing). Having spent some time in private beta, the public beta is approaching rapidly.

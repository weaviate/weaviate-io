...
As with any Sycamore script, this script can be run on a few documents on a laptop or scale to a cluster to process a large set of documents without changing the code. You can learn more about Sycamore's approach to scalability [here](https://sycamore.readthedocs.io/en/stable/data_ingestion_and_preparation/data_preparation_concepts.html).
...
You can find out more about Sycamore at [https://github.com/aryn-ai/sycamore](https://github.com/aryn-ai/sycamore) and more about the Aryn Partitioning Service [here](https://sycamore.readthedocs.io/en/stable/aryn_cloud/aryn_partitioning_service.html). An extended version of this post is avaialble a Jupyter notebook at XXX.

...
- [How to configure authentication](https://weaviate.io/developers/weaviate/configuration/authentication)
- [How to configure authorization](https://weaviate.io/developers/weaviate/configuration/authorization)
- [References: Environment variables](https://weaviate.io/developers/weaviate/config-refs/env-vars)
- [Weaviate clients](https://weaviate.io/developers/weaviate/client-libraries/)

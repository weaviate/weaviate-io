...
- [How to configure authentication](https://docs.weaviate.io/weaviate/configuration/authentication)
- [How to configure authorization](https://docs.weaviate.io/weaviate/configuration/authorization)
- [References: Environment variables](https://docs.weaviate.io/weaviate/config-refs/env-vars)
- [Weaviate clients](https://docs.weaviate.io/weaviate/client-libraries/)

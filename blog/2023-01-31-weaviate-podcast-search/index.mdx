...
[Broken link test](https://aaa12357253.broken.link.com)
...
Using the `where` filter with hybrid search could improve the search results. This [feature](https://github.com/weaviate/weaviate/issues/2393) will be added to the Weaviate v.18 release.
...
* Graph neural network aggregation: Graph neural networks are a perfect functional class for aggregating a variable amount of edges, for example one podcast may have 20 Segments and another 35!
...
“Dog-fooding” describes learning about your product by using it, as in eating your own dog food. There are 3 main features in development of Weaviate that I am super excited to develop with the Weaviate Podcast serving as the dataset.
...
2. Custom Models
	...
	Since joining Weavaite I have been fascinated with the conversation around zero-shot versus fine-tuned embedding models. Particularly from my conversation with Nils Reimers, I have become very interested in the continual learning nature of this. 
    ...
    I am also very interested in the fine-tuning of cross-encoder models, which you can learn more about [here](/blog/using-cross-encoders-as-reranker-in-multistage-vector-search).
...
All you do is ask ChatGPT to `please generate a query that would match the information in this document`. There are a little more details to this such as roundtrip consistency filtering, stay tuned for our Weaviate podcast with Leo Boystov to learn more about this!

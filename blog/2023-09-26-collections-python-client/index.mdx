...
We've released a pre-release version of our new Python client API. It's available for you to try out and provide feedback [through this form](https://forms.gle/8ZzP2BuCbnFc7jA88). We've made a number of major improvements, including strong typing, a collections-first approach, and performance improvements.
...
We have prepared a [dedicated page](/developers/weaviate/client-libraries/experimental) with instructions on how to install and use the new client. The page also includes a link to [the feedback form](https://forms.gle/8ZzP2BuCbnFc7jA88) where you can share your thoughts and suggestions.

...
We've released a pre-release version of our new Python client API. It's available for you to try out and provide feedback. We've made a number of major improvements, including strong typing, a collections-first approach, and performance improvements.

<br/>

You can try it here - [Experimental clients](/developers/weaviate/client-libraries/experimental).

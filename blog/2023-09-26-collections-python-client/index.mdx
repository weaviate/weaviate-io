...
We have prepared a [dedicated page](/developers/weaviate/client-libraries/experimental) with instructions on how to install and use the new client. The page also includes a link to [the feedback form](https://tally.so/r/wa4NDB) where you can share your thoughts and suggestions.

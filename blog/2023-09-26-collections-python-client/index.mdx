...
You can try it here - [Experimental clients](https://weaviate.io/developers/weaviate/client-libraries/python).
...
If you're keen to try it, please head over to our [Experimental clients](https://weaviate.io/developers/weaviate/client-libraries/python) page. There, you'll find the installation, usage and feedback instructions.
:::
...
We have prepared a [dedicated page](https://weaviate.io/developers/weaviate/client-libraries/python) with instructions on how to install and use the new client. The page also includes a link to [the feedback form](https://tally.so/r/wa4NDB) where you can share your thoughts and suggestions.

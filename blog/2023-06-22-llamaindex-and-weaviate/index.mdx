...
The next step is to 1) define a `WeaviateVectorStore`, and 2) build a [vector index](https://weaviate.io/developers/weaviate/concepts/vector-index) over this vector store using LlamaIndex.

...
The full code can be found in the [Weaviate recipes repo](https://github.com/weaviate/recipes/tree/main/integrations/llm-frameworks/llamaindex/simple-query-engine).

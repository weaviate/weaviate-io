...
```python
# pip install weaviate-client llama-index-core llama-index-readers-file llama-index-vector-stores-weaviate llama-index-embeddings-openai llama-index-llms-openai
import os
import weaviate

# connect to your weaviate instance (embedded)

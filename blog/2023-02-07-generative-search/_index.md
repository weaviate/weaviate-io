...
## How to use it
The [Generative OpenAI](https://weaviate.io/developers/weaviate/model-providers/openai/generative) module is a new feature that can generate responses based on your data. To access this module, you will need to use Weaviate `1.17.3` or a newer version.
...
* [text2vec-openai](https://weaviate.io/developers/weaviate/model-providers/openai/embeddings)
* [text2vec-cohere](https://weaviate.io/developers/weaviate/model-providers/cohere/embeddings)
* [text2vec-huggingface](https://weaviate.io/developers/weaviate/model-providers/cohere/embeddings)
* [generative-openai](https://weaviate.io/developers/weaviate/model-providers/openai/generative)
:::
...
:::note
Notice in `ENABLE_MODULES`, we are enabling two modules. In the above example we are using the `text2vec-openai` vectorization module; however, you can use another module of choice (Cohere or Hugging Face). Check out the [documentation](https://weaviate.io/developers/weaviate/model-providers/openai/generative#introduction) to learn more about this.
:::

...
- [`text2vec-google`](/developers/weaviate/modules/retriever-vectorizer-modules/text2vec-google) for generating vector embeddings and running semantic (`nearText`) queries, and
- [`generative-google`](/developers/weaviate/modules/reader-generator-modules/generative-google) for generative search.
...
And we are excited to tell you about the ['text2vec-google`](/developers/weaviate/modules/retriever-vectorizer-modules/text2vec-google) and ['generative-google'](/developers/weaviate/modules/reader-generator-modules/generative-google) modules. These modules will help you to bring the power of the newest LLM on the block to the, *ahem*, `PaLM` of your hand - or at least, to your Weaviate instance.

### <i class="fa-solid fa-input-numeric"></i> Embeddings with `text2vec-google`

The [`text2vec-google`](/developers/weaviate/modules/retriever-vectorizer-modules/text2vec-google) module can use a PaLM model to convert text to vector embeddings that represent their meaning.

So, you can use the `text2vec-google` module to build a Weaviate database using PaLM-derived vectors for text objects, and perform lightning-fast searches.
...
### <i class="fa-solid fa-typewriter"></i> Generative search with `generative-google`

The [`generative-google`](/developers/weaviate/modules/reader-generator-modules/generative-google) module is another exciting development for Weaviate and Google Cloud / Vertex AI users.
...
- [`text2vec-google`](/developers/weaviate/modules/retriever-vectorizer-modules/text2vec-google), and
- [`generative-google`](/developers/weaviate/modules/reader-generator-modules/generative-google).

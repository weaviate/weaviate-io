...
- [`text2vec-palm`](/developers/weaviate/model-providers/google/embeddings) for generating vector embeddings and running semantic (`nearText`) queries, and
- [`generative-palm`](/developers/weaviate/model-providers/google/generative) for generative search.
...
And we are excited to tell you about the ['text2vec-palm`](/developers/weaviate/model-providers/google/embeddings) and ['generative-palm'](/developers/weaviate/model-providers/google/generative) modules. These modules will help you to bring the power of the newest LLM on the block to the, *ahem*, `PaLM` of your hand - or at least, to your Weaviate instance.

### <i class="fa-solid fa-input-numeric"></i> Embeddings with `text2vec-palm`

The [`text2vec-palm`](/developers/weaviate/model-providers/google/embeddings) module can use a PaLM model to convert text to vector embeddings that represent their meaning.
...
The [`generative-palm`](/developers/weaviate/model-providers/google/generative) module is another exciting development for Weaviate and Google Cloud / Vertex AI users.
...
- [`text2vec-palm`](/developers/weaviate/model-providers/google/embeddings), and
- [`generative-palm`](/developers/weaviate/model-providers/google/generative).

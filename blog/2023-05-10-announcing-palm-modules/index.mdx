...
- [`generative-palm`](/developers/weaviate/modules/reader-generator-modules/generative-google) for generative search.
...
The [`generative-palm`](/developers/weaviate/modules/reader-generator-modules/generative-google) module is another exciting development for Weaviate and Google Cloud / Vertex AI users.
...
- [`generative-palm`](/developers/weaviate/modules/reader-generator-modules/generative-google).

...
Weaviate can generate vector embeddings for objects using [model provider integrations](https://weaviate.io/developers/weaviate/model-providers/).
...
- Only vectorize properties that use the `text` or `text[]` data type (unless [skip](https://weaviate.io/developers/weaviate/manage-data/collections#property-level-module-settings)ped)
...
> You can read more about each variable in the [schema configuration documentation](https://weaviate.io/developers/weaviate/manage-data/collections).

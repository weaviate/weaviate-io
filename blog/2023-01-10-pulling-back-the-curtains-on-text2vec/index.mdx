...
[![Pulling back the curtains on text2vec](./img/hero.png)](/blog/2023-01-10-pulling-back-the-curtains-on-text2vec/index.mdx)
...
If you would like to follow along, the Jupyter notebook and data are available [here](https://github.com/weaviate/weaviate-examples/tree/main/text2vec-behind-curtain). You can use our free [Weaviate Cloud Services](https://console.weaviate.io/) (WCS) sandbox, or set up your own Weaviate instance also.

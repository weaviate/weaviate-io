...
faq:
  - question: "Why do agents need memory?"
    answer: “Agentic systems need memory to retain context, operate over time and adapt as circumstance change.”
  - question: "What are the characteristics of an effective agentic memory layer?"
    answer: “Good memory requires active lifecycle management over simple storage and functions such as write control, deduplication, reconciliation, etc.”
  - question: "Why should memory be first-class infrastructure?"
    answer: “Memory must store and retrieve states with strong data guarantees, and thus be treated as critical infrastructure for applications.”
---
...
- **Write Control:** what to store, when to store it, and at what confidence.
  Not every interaction deserves to become a memory. A passing comment, speculative answer, or unverified assumption should not be treated the same as confirmed preference or durable decision. Good write control prevents noise from _becoming_ fact.

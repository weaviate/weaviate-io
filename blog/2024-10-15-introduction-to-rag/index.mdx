...
tags: ["concepts"]
image: ./img/hero.png
description: "Learn what LLM RAG (Retrieval Augmented Generation) is, how RAG pipelines work, key use cases, implementation approaches, and evaluation methods."
faq:
  - question: "What is Retrieval-Augmented Generation (RAG)?"
    answer: "Retrieval-Augmented Generation (RAG) is a framework that augments the general knowledge of a generative LLM by providing it with additional data relevant to the task at hand retrieved from an external data source."
  - question: "How does RAG work?"
    answer: "RAG works in two stages: ingestion and inference. During inference, the system retrieves relevant data, augments the user prompt, and generates a response."
  - question: "How do you implement RAG?"
    answer: "RAG can be implemented using frameworks like LangChain, LlamaIndex, and DSPy, which provide tools and integrations for building RAG pipelines and connecting to services like vector databases."
  - question: "How do you evaluate RAG?"
    answer: "RAG evaluation can be done at the component level (retriever and generator) and end-to-end. This helps ensure both component reliability and overall answer quality."
  - question: "What is the difference between RAG and fine-tuning?"
    answer: "Fine-tuning trains a model on domain data to specialize behavior, while RAG retrieves external data at inference time to improve accuracy and reduce hallucinations without retraining."
---
...
In production RAG pipelines, retrieval quality is heavily influenced by [**chunking strategy**](/blog/chunking-strategies-for-rag) and how you index content for search and filtering.
...
If you're looking for a way to get up and running with RAG quickly, try [**Elysia**](https://elysia.weaviate.io/), our agentic RAG assistant. Elysia connects directly to your Weaviate Cloud instance, automatically understands your data structure, and handles complex queries across multiple data types — no framework setup required. You can also explore more RAG demos at [playground.weaviate.io](https://playground.weaviate.io/).
...
**AI agents** are autonomous systems that can interpret information, formulate plans, and make decisions. When added to a RAG pipeline, agents can reformulate user queries and re-retrieve more relevant information if initial results are inaccurate or irrelevant. [**Agentic RAG**](/blog/what-is-agentic-rag/) can also handle more complex queries that require multi-step reasoning, like comparing information across multiple documents, asking follow-up questions, and iteratively adjusting retrieval and generation strategies. Agentic RAG extends the LLM RAG pipeline by adding agents that can plan, re-retrieve, validate context, and use tools.

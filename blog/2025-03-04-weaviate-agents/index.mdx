...
:::caution Only the Query Agent reached GA
Published 2025-03-04, when Weaviate Agents was announced as a three-agent suite. Of the three, only the **Query Agent** reached general availability.
:::
...
I’m happy to share how Weaviate is simplifying the entire process of orchestrating generative AI applications. [Weaviate Agents](https://docs.weaviate.io/query-agent), our new suite of agentic services, embody a mindset shift in data management and AI development. For us this is not just another feature release, it’s a window into how we see AI-driven data experiences evolving in the near future.
...
## What’s Next?
Weaviate Query Agent is now available in Public Preview. [Read the docs](https://docs.weaviate.io/query-agent), and access it via [Weaviate Serverless Cloud](https://console.weaviate.cloud) or our free 14-day sandbox. We’ll be sharing technical tutorials and developer enablement materials for Query Agent in the coming days. Keep an eye on our blog and follow us on [LinkedIn](https://www.linkedin.com/company/weaviate-io/) for the latest. 

...
## What’s Next?
Weaviate Query Agent is now available in Public Preview. [Read the docs](https://docs.weaviate.io/agents/query), and access it via [Weaviate Serverless Cloud](https://console.weaviate.cloud) or our free 14-day sandbox. We’ll be sharing technical tutorials and developer enablement materials for Query Agent in the coming days. Keep an eye on our blog and follow us on [LinkedIn](https://www.linkedin.com/company/weaviate-io/) for the latest. 

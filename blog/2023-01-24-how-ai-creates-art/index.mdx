...
tags: []
image: ./img/hero.png
description: Machine learning models that can create beautiful and novel images. Learn how that works and how you could make use of it.
---
...
Models like [DALL.E 2](https://openai.com/dall-e-2/), [Stable Diffusion](https://stability.ai/blog/stable-diffusion-v2-release) and others which are the technologies underlying many platforms such as [Lensa](https://prisma-ai.com/lensa) and [Midjourney](http://midjourney.com) are being used by millions of people and are quickly becoming main stream as people realize their potential. 
...
- [From Deep Learning Foundations to Stable Diffusion](https://www.fast.ai/posts/part2-2022-preview.html)

...
For more information on how to use the `IsNull` filter, check out the [documentation](/developers/weaviate/references/graphql/filters#filter-by-null-state).
...
For more information on how to filter by the property length, check out the [documentation](/developers/weaviate/references/graphql/filters#filter-by-property-length).
...
Check the [/v1/nodes](/developers/weaviate/references/rest/nodes) documentation to learn how to use the `Node Status API`.

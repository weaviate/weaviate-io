...
tags: ['concepts']
image: ./img/hero.png
description: "Two weeks of using Engram — Weaviate's memory product — in daily Claude Code sessions surfaced exactly where AI memory adds value, and the specific mechanics that prevent it from working."
faq:
  - question: "What is Engram?"
    answer: "Engram is Weaviate's memory product built on vector search technology, designed to give AI coding assistants like Claude Code persistent, cross-session context and reasoning history."
  - question: "How is Engram different from MEMORY.md?"
    answer: "MEMORY.md holds stable conclusions — facts that don't change session to session. Engram captures what led to those conclusions: decision reasoning, rejected alternatives, and the evolution of context over time."
  - question: "When does memory retrieval work best in AI workflows?"
    answer: "Memory retrieval is most effective for decision archaeology — resuming long-running work and recovering not just facts but the reasoning behind them. It is less reliable when the model treats a task as forward-looking and skips retrieval of prior context entirely."
---
...
Claude and I are fast friends. Claude Code is an integral part of my workflow as a product manager: research and analysis, design and prototyping, project and requirement planning. But the longer I use it, the more I notice the quiet friction of sessions starting cold and needing to restate what we decided last week or how we reframed an old problem. This is exactly the memory problem we made the case for in [The Limit in the Loop](https://weaviate.io/blog/limit-in-the-loop) that needs first-class infrastructure, and it's why we built **Engram**, our memory product now in private preview, on Weaviate's core vector search technology.
...
*Illustration 1: How Engram Grounds Memory*
...
*Illustration 2: How Engram Grounds Sessions*
...
> **Interested in trying Engram in your own coding assistant workflow? [Sign up for the Engram Preview](https://weaviate.io/product-previews#preview-engram)**

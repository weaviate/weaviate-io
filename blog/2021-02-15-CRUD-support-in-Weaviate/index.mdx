...
Check out the [quickstart guide](/docs/weaviate/quickstart) in the documentation or [learn more about Weaviate here](/docs/weaviate). If you like what you've read and would consider using Weaviate in the future, feel free to leave a star on [GitHub](https://github.com/semi-technologies/weaviate).

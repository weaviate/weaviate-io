...
Check out the [quickstart guide](/developers/docs/quickstart) in the documentation or [learn more about Weaviate here](/developers/docs). If you like what you've read and would consider using Weaviate in the future, feel free to leave a star on [GitHub](https://github.com/semi-technologies/weaviate).

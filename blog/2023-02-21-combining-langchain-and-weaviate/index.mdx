...
MyOpenAI = OpenAI(temperature=0.2, openai_api_key="sk-key")

qa = ConversationalRetrievalChain.from_llm(MyOpenAI, vectorstore.as_retriever())

chat_history = []

print("Welcome to the Weaviate ConversationalRetrievalChain Demo!")

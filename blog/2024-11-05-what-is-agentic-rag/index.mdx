...
faq:
  - question: "What is Agentic RAG?"
    answer: "Agentic RAG describes an AI agent-based implementation of RAG. It incorporates AI agents into the RAG pipeline to orchestrate its components and perform additional actions beyond simple information retrieval and generation."
  - question: "How does Agentic RAG work?"
    answer: "Agentic RAG most commonly refers to using agents in the retrieval component. The agent can retrieve, evaluate, re-retrieve, and validate context before generating the final answer."
  - question: "What is the difference between Agentic RAG and vanilla RAG?"
    answer: "Vanilla RAG is typically one-shot retrieval with limited tool access, while Agentic RAG generalizes retrieval with tool use, multi-step retrieval, and validation of retrieved information."
  - question: "How do you implement Agentic RAG?"
    answer: "You can build Agentic RAG using language models with function calling or agent frameworks. Both approaches connect an LLM to tools and add routing/looping logic to support retrieval and validation."
  - question: "Why are enterprises adopting Agentic RAG?"
    answer: "Enterprises are moving from vanilla RAG to agentic systems to produce more accurate responses, perform tasks autonomously, and better collaborate with humans through tool use and validation."
---

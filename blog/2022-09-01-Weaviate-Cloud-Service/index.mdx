...
# isMLResearch: false
# isDBResearch: false
# redirect_from: /blog/Weaviate-Cloud-Service.html
---
![SeMI Technologies introduces an all-new business model for vector search](./img/hero.png)

**Amsterdam NL – September 1, 2022**
 
SeMI Technologies, the leader in open-source vector-search technology, announces an [entirely new pricing model](/pricing) for its Weaviate Cloud Service.

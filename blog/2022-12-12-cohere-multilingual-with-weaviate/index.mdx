...
1. set up a new Weaviate instance in [WCS](https://console.weaviate.io/)
...
Please reach out to us via [Slack](https://weaviate.io/slack), [Twitter](https://twitter.com/weaviate_io), or [GitHub](https://github.com/weaviate/weaviate).

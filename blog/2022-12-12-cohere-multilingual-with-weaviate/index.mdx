...
Published 2022-12-12. This post is built around Cohere's `embed-multilingual-v2.0`, which is now two generations behind. For current guidance, see the [Cohere embeddings docs](https://docs.weaviate.io/weaviate/model-providers/cohere/embeddings) — the recommended default is `embed-multilingual-v3.0`, and `embed-v4.0` is the current flagship.
:::

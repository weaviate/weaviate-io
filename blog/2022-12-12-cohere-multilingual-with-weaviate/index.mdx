...
### Text2vec-cohere
Over the last few weeks, we’ve partnered with Cohere to create a new Weaviate module – [text2vec-cohere](/developers/weaviate/model-providers/cohere) – it allows you to use Cohere’s LLMs to run complex NLP queries straight from Weaviate.

You can learn all about [text2vec-cohere from the docs](/developers/weaviate/model-providers/cohere/embeddings).
...
## What next
Check out the [text2vec-cohere](/developers/weaviate/model-providers/cohere/embeddings) to learn more about the new module.

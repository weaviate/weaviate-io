...
$$
\text\{Precision\}\text\{@\}\text\{K\} = \frac\{TP\}\{TP+FP\}= \frac\{TP\}\{K\}
...
$$
\text\{Recall\}\text\{@\}\text\{K\} = \frac\{TP\}\{TP+FN\}
...
$$
\text\{MRR\}\text\{@\}\text\{K\} = \frac\{1\}\{U\}\sum_\{u=1\}^\{U\}\frac\{1\}\{\text\{RR\}_u\}
$$
...
$$
\text\{MAP\}\text\{@\}\text\{K\} = \frac\{1\}\{U\}\sum_\{u=1\}^\{U\}AP\text\{@\}K_u
$$
...
$$
\text\{AP\}\text\{@\}\text\{K\} = \frac\{1\}\{N\}\sum_\{k=1\}^\{K\}\text\{Precision(k)\}\times \text\{rel(k)\}
$$
...
$$
\text\{NDCG\}\text\{@\}\text\{K\} = \frac\{\text\{DCG\}\text\{@\}\text\{K\}\}\{\text\{IDCG\}\text\{@\}\text\{K\}\}
$$

The DCG is calculated as follows:

$$
\text\{DCG\}\text\{@\}\text\{K\} = \sum_\{k=1\}^K\frac\{\text\{rel\}_i\}\{\log_2(i+1)\}
$$

...
To see these techniques in action, try [**Elysia**](https://elysia.weaviate.io/), our agentic RAG assistant built on Weaviate — or explore the full range of demos at [playground.weaviate.io](https://playground.weaviate.io/). If you want to dig into the implementation details, the [Elysia documentation](https://weaviate.github.io/elysia/) walks through the architecture and configuration options.

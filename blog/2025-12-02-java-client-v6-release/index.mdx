...
![Weaviate Java Client v6](./img/hero.jpg)
...
```kotlin
implementation("io.weaviate:client6:6.2.0")
```

#### Quickstart code

The following script will connect to a Weaviate Cloud instance, create a `Movie` collection, populate it and perform a semantic search:
...
You can clone the repository and run the demo locally:
  ...
  * **Repository:** [github.com/weaviate-tutorials/VectorStore](https://github.com/weaviate-tutorials/VectorStore)

## Resources

- **Documentation:** [docs.weaviate.io/weaviate/client-libraries/java](https://docs.weaviate.io/weaviate/client-libraries/java)
- **GitHub:** [github.com/weaviate/java-client](https://github.com/weaviate/java-client/tree/v6)
- **Demo app**: Check out our [e-commerce demo application](https://github.com/weaviate-tutorials/VectorStore) showcasing the new Java client v6 syntax in action with Spring Boot.

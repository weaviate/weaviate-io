...
!["Placeholder: Graph demonstrating Ask vs Search mode in action"](./img/weaviate-query-agent-generally-available.jpg)
...
We also introduced [**Ask Mode**](https://docs.weaviate.io/agents/query/usage#ask-mode), which replaces the old run() method with a clearer and more natural API for conversational and query-driven workflows. 

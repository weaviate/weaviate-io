...
client.roles.create(
    role_name="Clinician",
    permissions=[
        # Read access to MedicalArticles (config + data)
        Permissions.collections(collection="MedicalArticles", read_config=True),
        Permissions.data(collection="MedicalArticles", read=True),
        # Read & update access to PatientRecords (config + data)
        Permissions.collections(collection="PatientRecords", read_config=True),
        Permissions.data(collection="PatientRecords", read=True, update=True),
    ],
)

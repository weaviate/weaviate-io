...
The repository will be published with the final article so readers can inspect the scanner, enrichment manifest, Weaviate schema, import flow, and search interface together.

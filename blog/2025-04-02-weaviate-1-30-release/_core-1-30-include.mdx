...
<figure>
  <img
    ...
    width="600"
  />
    <figcaption><small>Example screenshot of BlockMax WAND calculation from our <a href="/blog/blockmax-wand/">BlockMax WAND blog</a>.<br/><a href="https://weaviate.io/blog/2025-02-26-blockmax-wand/">Read the full blog post</a> <br /><br /></small></figcaption>
</figure>

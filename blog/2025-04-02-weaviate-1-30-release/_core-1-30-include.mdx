...
User management is a whole lot more flexible from `v1.30`, Weaviate now supports API-based management of users. This means that you can now manage roles and permissions with Weaviate client libraries, or using the REST API, as long as you have the necessary permissions.

...
BlockMax WAND [significantly speeds up keyword and hybrid searches](https://weaviate.io/developers/weaviate/concepts/indexing#blockmax-wand-algorithm) in Weaviate. Originally introduced as a technical preview in `1.28`, it is now generally available in `v1.30`. In fact, it is now the default indexing algorithm for all new Weaviate instances from this version onwards.
...
Existing instances' data can be migrated to use BlockMax WAND by following [this guide](https://weaviate.io/developers/weaviate/more-resources/migration/weaviate-1-30). This is a one-time operation, and once completed, the instance will use BlockMax WAND for all future searches.
...
- [Concepts: Indexing - BlockMax WAND](https://weaviate.io/developers/weaviate/concepts/indexing#blockmax-wand-algorithm)
- [Migration Guide: BlockMax WAND](https://weaviate.io/developers/weaviate/more-resources/migration/weaviate-1-30)
:::

## Multi-vector embeddings

ColBERT or ColPali-like [multi-vector embeddings](https://weaviate.io/developers/weaviate/tutorials/multi-vector-embeddings) are now generally available in Weaviate for production use. Here is an illustration showing the difference between single-vector and multi-vector embeddings.
...
:::info Related resources
- [Multi-vector embeddings tutorial](https://weaviate.io/developers/weaviate/tutorials/multi-vector-embeddings)
- [How-to Configure: Vector Quantization](https://weaviate.io/developers/weaviate/configuration/compression)
:::
...
:::info Related resources
- [Database user management API](https://weaviate.io/developers/weaviate/configuration/rbac/manage-users)
:::
...
:::info Related resources
- [How-to: Search: Configure a generative model provider](https://weaviate.io/developers/weaviate/search/generative#configure-a-generative-model-provider)
:::


## xAI model integration

Weaviate's suite of [model integrations](https://weaviate.io/developers/weaviate/model-providers/) now includes support for xAI's generative AI models.

To use xAI's generative AI models with Weaviate, take a look at the [xAI model integration page](https://weaviate.io/developers/weaviate/model-providers/xai/) for detailed instructions on how to configure Weaviate with xAI models and start using them in your applications.

:::info Related resources
- [Model provider integrations: xAI](https://weaviate.io/developers/weaviate/model-providers/xai)
:::
...
For detailed instructions on how to set this up, and what settings are available, refer to the [Runtime config management page](https://weaviate.io/developers/weaviate/config-refs/env-vars/runtime-config).

:::info Related resources
- [References: Configuration: Runtime config management](https://weaviate.io/developers/weaviate/config-refs/env-vars/runtime-config)
- [References: Configuration: Environment variables](https://weaviate.io/developers/weaviate/config-refs/env-vars)
:::
...
However, if you finding yourself hitting or even nearing this limit, we advise you to check out this guide on [scaling limits with collections](https://weaviate.io/developers/weaviate/starter-guides/managing-collections/collections-scaling-limits) to see if you can optimize your Weaviate instance.
...
:::info Related resources
- [Guide: Scaling limits with collections](https://weaviate.io/developers/weaviate/starter-guides/managing-collections/collections-scaling-limits)
- [References: Configuration: Environment variables](https://weaviate.io/developers/weaviate/config-refs/env-vars)
:::
...
:::info Related resources
- [References: Configuration: Environment variables](https://weaviate.io/developers/weaviate/config-refs/env-vars)
- [References: Collection definition: Limit tokenizer concurrency](https://weaviate.io/developers/weaviate/config-refs/schema#limit-the-number-of-gse-and-kagome-tokenizers)
:::
...
See the [RBAC documentation](https://weaviate.io/developers/weaviate/configuration/rbac) for more information.

:::info Related resources
- [How-to configure: Role-based access control](https://weaviate.io/developers/weaviate/configuration/rbac)
:::
...
For those of you upgrading a self-hosted version, please check the [migration guide](https://weaviate.io/developers/weaviate/more-resources/migration#general-upgrade-instructions) for detailed instructions.

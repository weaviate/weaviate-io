...
At Day Zero, we believe that enablement and developer experience are paramount, which we tackle through [events](https://weaviate.io/community/events), [education](https://academy.weaviate.io/), and [documentation](https://docs.weaviate.io/weaviate). And yes, that even includes enabling the vibe-coders.
...
* A wide range of [**educational content and guides**](https://academy.weaviate.io/);  
...
* Powerful [Database Agents](https://docs.weaviate.io/query-agent)

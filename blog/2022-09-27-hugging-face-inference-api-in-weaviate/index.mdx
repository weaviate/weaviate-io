...
## Summary
> Now you can use [Hugging Face](/developers/weaviate/model-providers/cohere/embeddings) or [OpenAI](/developers/weaviate/model-providers/openai/embeddings) modules in Weaviate to delegate model inference out.

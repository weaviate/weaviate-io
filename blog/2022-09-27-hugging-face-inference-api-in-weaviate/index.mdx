...
For more detailed instructions please check the [documentation](/developers/weaviate/model-providers/cohere/embeddings).
:::
...
## Summary
> Now you can use [Hugging Face](/developers/weaviate/model-providers/cohere/embeddings) or [OpenAI](/developers/weaviate/modules/retriever-vectorizer-modules/text2vec-openai) modules in Weaviate to delegate model inference out.
...
## What next
Check out the [text2vec-huggingface](/developers/weaviate/model-providers/cohere/embeddings) documentation to learn more about the new module.

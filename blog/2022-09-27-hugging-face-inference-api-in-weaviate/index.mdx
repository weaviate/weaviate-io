...
> Both modules are enabled by default in the [Weaviate Cloud Services](/products).
...
Every new Weaviate instance created with the [Weaviate Cloud Services](/products) has the Hugging Face module enabled out of the box. You don't need to update any configs or anything, it is there ready and waiting.

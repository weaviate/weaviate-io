...
The Weaviate [Python client v4](/developers/weaviate/client-libraries/python) is officially available. The latest release adds support for named vectors and brings numerous other updates.

* Read [Weaviate Python client (v4) goes GA](../2024-02-01-py-client-v4-release/index.mdx) blog post to learn more.
* See the [v3 to v4 migration guide](/developers/weaviate/client-libraries/python/v3_v4_migration) to learn how to upgrade your code to use the new Python client.

...
For details, see [Multiple vector embeddings](https://weaviate.io/developers/weaviate/config-refs/schema/multi-vector).

## HNSW and binary quantization

![HNSW and binary quantization](./img/hnsw-and-bq.png)

Weaviate improves [binary quantization (BQ)](https://weaviate.io/developers/weaviate/configuration/compression/bq-compression) in 1.24 to be faster, more memory efficient, and more cost-effective. Use BQ vector compression with [HNSW indexes](https://weaviate.io/developers/weaviate/concepts/vector-index#hierarchical-navigable-small-world-hnsw-index) to dramatically improve your query speed.
...
For details, see [Docker configuration](https://weaviate.io/developers/weaviate/installation/docker-compose)
...
The new Weaviate [Python client v4](https://weaviate.io/developers/weaviate/client-libraries/python) is available. The latest release adds support for named vectors and brings numerous other updates. If you have feedback on the new client, please let us know.

- To learn more about the new client, read the [client release blog post](/blog/py-client-v4-release).
- To learn how to upgrade your code, see the [v3 to v4 migration guide](https://weaviate.io/developers/weaviate/client-libraries/python/v3_v4_migration).

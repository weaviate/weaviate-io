...
Following our introduction of the [**`QueryAgent`**](https://weaviate.io/blog/query-agent) last week, we’re back with yet another one: The **`TransformationAgent`** is now ready in public preview for all [Weaviate Serverless Cloud](https://weaviate.io/deployment/serverless) users (including free Sandbox users)!
...
3.  Give the abstracts an “NLP relevance” score of [0-10].
4.  Have a boolean flag indicating wether it’s a survey paper or not

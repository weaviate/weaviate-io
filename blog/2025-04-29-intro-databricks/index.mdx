...
collection = client.collections.create(
    name="AmazonProducts",
    vector_config=[
        wvcc.Configure.Vectors.text2vec_databricks(
            name="default", 
...
collection = client.collections.use("AmazonProducts")
```
...
* Vectorize Objects (`vector_config`): The `text2vec_databricks` configuration enables Weaviate to generate embeddings for the Amazon products using the Databricks endpoint specified in `EMBEDDINGS_ENDPOINT`.   
...
```python
products = client.collections.use("AmazonProducts")
```
...
Alpha is an optional parameter. The default is set to `0.5`.

...
* Vectorize Objects (`vectorizer_config`): The `text2vec_databricks` configuration enables Weaviate to generate embeddings for the job postings using the Databricks endpoint specified in `EMBEDDINGS_ENDPOINT`.   

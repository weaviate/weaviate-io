...
- [Comparing Product and Binary Quantization](#comparing-product-and-binary-quantization) - Experiments comparing PQ and BQ.
...
**Fig**: _Elementwise binary quantization of a vector from float32 to 1 bit._
...
**Fig**: _An image when binary quantized_
...
| Sentence: _"All your vector embeddings belong to you!"_ |
| :-----------------------------------------------------: |
|            ![OriginalVec](./img/image14.jpg)            |
|             ![BinaryVec](./img/image7.png)              |

**Fig**: _Visualization of a sentence vector embedding when binary quantized_
...
**Fig**: _BQ with 1 dimensional vectors_
...
**Fig**: _BQ with 2 dimensional vectors_
...
**Fig**: _Displays some counter-intuitive facts about hamming distances between 2d binary vectors_
...
**Fig**: _Displays the exponentially decreasing probability for collisions in vector representations. In essence, this means that the higher the dimensionality of your data, the more effectively you can expect binary quantization to perform._
...
**Table 1**: _Vector search time improvements between uncompressed and BQ._
...
**Table 2**: _Indexing time improvements between flat, HNSW uncompressed and BQ indexes._
...
**Table 3**: _Memory footprint improvements for the various indexes._
...
**Fig**: _QPS vs Recall for 100k DBPedia vectors_
...
**Fig**: _QPS vs Recall for 100k DBPedia vectors comparing various indexes._
...
**Fig**: _QPS vs Recall for 1000k DBPedia vectors comparing various indexes._

## Comparing Product and Binary Quantization
...
**Fig**: _QPS vs Recall for 1000k DBPedia vectors comparing HNSW with and without PQ and BQ compression._
...
**Table 4**: _Comparing the various indexes and compression techniques._

...
To learn how to enable and configure Weaviate to use BQ refer to the docs [here](https://weaviate.io/developers/weaviate/configuration/compression/bq-compression). You can read more about HNSW+BQ in the documentation [here](https://weaviate.io/developers/weaviate/concepts/vector-quantization#binary-quantization).
:::

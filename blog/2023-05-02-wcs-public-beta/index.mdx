...
The Weaviate Cloud enables AI application developers to use the [open source Weaviate vector database](https://docs.weaviate.io/weaviate) as a fully managed cloud service. It’s the easiest way to get a vector database cluster up and running within minutes, so you can get right to loading, vectorizing, and searching your data.
...
And if you have questions or feedback, please join the [Weaviate Forum](https://forum.weaviate.io). We look forward to hearing from you!

...
## Query Helper Application {#query_app}
...
- **OpenAI API Key:** Access key to OpenAI that Weaviate uses to access OpenAI Large Language Models to query embeddings. Create a key at: [https://openai.com](https://openai.com)
- **Cohere API Key:** Access key to Cohere that Weaviate uses for text embedding, generative AI and reranking. Create a key at: [https://cohere.com](https://cohere.com)
...
## Query Prompt Examples {#query_examples}
